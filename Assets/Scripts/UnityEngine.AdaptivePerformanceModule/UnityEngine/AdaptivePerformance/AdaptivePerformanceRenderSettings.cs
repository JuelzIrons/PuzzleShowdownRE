namespace UnityEngine.AdaptivePerformance
{
	public static class AdaptivePerformanceRenderSettings
	{
		...
		public static float MainLightShadowmapResolutionMultiplier
		{
			...
			set
			{
				s_ShadowResolutionMultiplier = global::UnityEngine.Mathf.Clamp01(value);
			}
		}
		...
		public static float MaxShadowDistanceMultiplier
		{
			...
			set
			{
				s_MaxShadowDistanceMultiplier = global::UnityEngine.Mathf.Clamp01(value);
			}
		}
		...
		public static float RenderScaleMultiplier
		{
			...
			set
			{
				s_RenderScaleMultiplier = global::UnityEngine.Mathf.Clamp01(value);
			}
		}
