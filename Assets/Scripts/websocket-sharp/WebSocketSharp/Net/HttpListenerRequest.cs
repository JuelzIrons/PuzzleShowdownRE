namespace WebSocketSharp.Net
{
	public sealed class HttpListenerRequest
	{
		...
		private global::System.IO.Stream _inputStream;

		private global::System.Version _protocolVersion;

		private global::System.Collections.Specialized.NameValueCollection _queryString;

		private string _rawUrl;

		private global::System.Guid _requestTraceIdentifier;

		private global::System.Uri _url;

		private global::System.Uri _urlReferrer;
		...
		public global::System.IO.Stream InputStream
		{
			get
			{
				...
				{
					_inputStream = ((_contentLength > 0 || _chunked) ? _connection.GetRequestStream(_contentLength, _chunked) : global::System.IO.Stream.Null);
				}
				return _inputStream;
			}
		}
		...
		public global::System.Net.IPEndPoint LocalEndPoint => _connection.LocalEndPoint;

		public global::System.Version ProtocolVersion => _protocolVersion;
		...
		public global::System.Collections.Specialized.NameValueCollection QueryString
		{
			get
			{
				...
				{
					global::System.Uri url = Url;
					_queryString = global::WebSocketSharp.Net.QueryStringCollection.Parse((url != null) ? url.Query : null, global::System.Text.Encoding.UTF8);
				}
				return _queryString;
			}
		}
		...
		public global::System.Net.IPEndPoint RemoteEndPoint => _connection.RemoteEndPoint;

		public global::System.Guid RequestTraceIdentifier => _requestTraceIdentifier;
		...
		public global::System.Uri Url
		{
			get
			{
				if (!_urlSet)
				{
					_url = global::WebSocketSharp.Net.HttpUtility.CreateRequestUrl(_rawUrl, _userHostName ?? UserHostAddress, IsWebSocketRequest, IsSecureConnection);
					_urlSet = true;
				}
				return _url;
			}
		...
		{
			_100continue = global::System.Text.Encoding.ASCII.GetBytes("HTTP/1.1 100 Continue\r\n\r\n");
		}

		internal HttpListenerRequest(global::WebSocketSharp.Net.HttpListenerContext context)
		{
			_context = context;
			_connection = context.Connection;
			_contentLength = -1L;
			_headers = new global::WebSocketSharp.Net.WebHeaderCollection();
			_requestTraceIdentifier = global::System.Guid.NewGuid();
		}

		private global::System.Text.Encoding getContentEncoding()
		{
			...
			global::System.Text.Encoding result;
			return global::WebSocketSharp.Net.HttpUtility.TryGetEncoding(text, out result) ? result : global::System.Text.Encoding.UTF8;
		}
		...
		internal void AddHeader(string headerField)
		{
			...
			string text3 = text.ToLower(global::System.Globalization.CultureInfo.InvariantCulture);
			if (text3 == "host")
			{
		...
		internal void FinishInitialization()
		{
			...
			if (text2 != null)
			{
				global::System.StringComparison comparisonType2 = global::System.StringComparison.OrdinalIgnoreCase;
				if (!text2.Equals("100-continue", comparisonType2))
				{
					_context.ErrorMessage = "Invalid Expect header";
					return;
				}
				global::WebSocketSharp.Net.ResponseStream responseStream = _connection.GetResponseStream();
		...
		{
			global::System.IO.Stream inputStream = InputStream;
			if (inputStream == global::System.IO.Stream.Null)
			{
				return true;
			}
			int num = 2048;
			...
			while (true)
			{
				try
				{
					global::System.IAsyncResult asyncResult = inputStream.BeginRead(buffer, 0, num, null, null);
		...
		internal void SetRequestLine(string requestLine)
		{
			...
			global::System.Version result;
			if (text3.Length != 8)
			{
				_context.ErrorMessage = "Invalid request line (version)";
			}
			else if (!text3.StartsWith("HTTP/", global::System.StringComparison.Ordinal))
			{
				_context.ErrorMessage = "Invalid request line (version)";
			}
			...
			else if (result != global::WebSocketSharp.Net.HttpVersion.Version11)
			{
				_context.ErrorMessage = "Invalid request line (version)";
		...
		public global::System.IAsyncResult BeginGetClientCertificate(global::System.AsyncCallback requestCallback, object state)
		{
			throw new global::System.NotSupportedException();
		}

		public global::System.Security.Cryptography.X509Certificates.X509Certificate2 EndGetClientCertificate(global::System.IAsyncResult asyncResult)
		{
			throw new global::System.NotSupportedException();
		}
