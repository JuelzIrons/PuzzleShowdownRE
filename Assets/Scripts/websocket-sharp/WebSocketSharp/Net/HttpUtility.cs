namespace WebSocketSharp.Net
{
	...
	{
		private static global::System.Collections.Generic.Dictionary<string, char> _entities;
		...
		private static global::System.Collections.Generic.Dictionary<string, char> getEntities()
		{
			lock (_sync)
			{
				if (_entities == null)
			...
			foreach (char c in s)
			{
				...
				case 2:
					if (c == ';')
					{
						...
						global::System.Collections.Generic.Dictionary<string, char> entities = getEntities();
		...
		{
			_entities = new global::System.Collections.Generic.Dictionary<string, char>();
			_entities.Add("nbsp", '\u00a0');
			_entities.Add("iexcl", '¡');
			_entities.Add("cent", '¢');
			_entities.Add("pound", '£');
		...
		private static void urlEncode(byte b, global::System.IO.Stream output)
		{
			if (b > 31 && b < 127)
			{
				char c = (char)b;
		...
		internal static global::System.Uri CreateRequestUrl(string requestUri, string host, bool websocketRequest, bool secure)
		{
			...
			else
			{
				...
				{
					if (!global::System.Uri.TryCreate(requestUri, global::System.UriKind.Absolute, out result))
					{
						return null;
					}
					text = result.Scheme;
			...
			global::System.Uri result2;
			return global::System.Uri.TryCreate(uriString, global::System.UriKind.Absolute, out result2) ? result2 : null;
			IL_00c6:
			if (!num)
			{
				return null;
		...
		internal static global::System.Security.Principal.IPrincipal CreateUser(string response, global::WebSocketSharp.Net.AuthenticationSchemes scheme, string realm, string method, global::System.Func<global::System.Security.Principal.IIdentity, global::WebSocketSharp.Net.NetworkCredential> credentialsFinder)
		{
			...
			switch (scheme)
			{
			case global::WebSocketSharp.Net.AuthenticationSchemes.Digest:
			...
			default:
				return null;
			case global::WebSocketSharp.Net.AuthenticationSchemes.Basic:
				break;
			}
			...
			global::System.StringComparison comparisonType = global::System.StringComparison.OrdinalIgnoreCase;
			if (response.IndexOf(scheme.ToString(), comparisonType) != 0)
			{
				return null;
			}
			global::WebSocketSharp.Net.AuthenticationResponse authenticationResponse = global::WebSocketSharp.Net.AuthenticationResponse.Parse(response);
			if (authenticationResponse == null)
			{
				return null;
			}
			global::System.Security.Principal.IIdentity identity = authenticationResponse.ToIdentity();
			if (identity == null)
			{
				return null;
			}
			global::WebSocketSharp.Net.NetworkCredential networkCredential = null;
			try
			{
			...
			if (scheme == global::WebSocketSharp.Net.AuthenticationSchemes.Basic)
			{
				global::WebSocketSharp.Net.HttpBasicIdentity httpBasicIdentity = (global::WebSocketSharp.Net.HttpBasicIdentity)identity;
				return (httpBasicIdentity.Password == networkCredential.Password) ? new global::System.Security.Principal.GenericPrincipal(identity, networkCredential.Roles) : null;
			}
			global::WebSocketSharp.Net.HttpDigestIdentity httpDigestIdentity = (global::WebSocketSharp.Net.HttpDigestIdentity)identity;
			return httpDigestIdentity.IsValid(networkCredential.Password, realm, method, null) ? new global::System.Security.Principal.GenericPrincipal(identity, networkCredential.Roles) : null;
		}

		internal static global::System.Text.Encoding GetEncoding(string contentType)
		{
			...
			foreach (string item in contentType.SplitHeaderValue(';'))
			{
				...
				return global::System.Text.Encoding.GetEncoding(value2);
			}
			return null;
		}

		internal static bool TryGetEncoding(string contentType, out global::System.Text.Encoding result)
		{
			result = null;
			try
			{
		...
		public static void HtmlAttributeEncode(string s, global::System.IO.TextWriter output)
		{
			if (s == null)
			{
				throw new global::System.ArgumentNullException("s");
		...
		public static void HtmlDecode(string s, global::System.IO.TextWriter output)
		{
			if (s == null)
			{
				throw new global::System.ArgumentNullException("s");
		...
		public static void HtmlEncode(string s, global::System.IO.TextWriter output)
		{
			if (s == null)
			{
				throw new global::System.ArgumentNullException("s");
		...
		{
			return UrlDecode(s, global::System.Text.Encoding.UTF8);
		}

		public static string UrlDecode(byte[] bytes, global::System.Text.Encoding encoding)
		{
			if (bytes == null)
			{
			...
			return (num > 0) ? (encoding ?? global::System.Text.Encoding.UTF8).GetString(urlDecodeToBytes(bytes, 0, num)) : string.Empty;
		}

		public static string UrlDecode(string s, global::System.Text.Encoding encoding)
		{
			if (s == null)
			{
				throw new global::System.ArgumentNullException("s");
			...
			return (encoding ?? global::System.Text.Encoding.UTF8).GetString(urlDecodeToBytes(bytes, 0, bytes.Length));
		}

		public static string UrlDecode(byte[] bytes, int offset, int count, global::System.Text.Encoding encoding)
		{
			if (bytes == null)
			{
				throw new global::System.ArgumentNullException("bytes");
			...
			return (count > 0) ? (encoding ?? global::System.Text.Encoding.UTF8).GetString(urlDecodeToBytes(bytes, offset, count)) : string.Empty;
		}
		...
		public static string UrlEncode(byte[] bytes)
		{
			...
			int num = bytes.Length;
			return (num > 0) ? global::System.Text.Encoding.ASCII.GetString(urlEncodeToBytes(bytes, 0, num)) : string.Empty;
		}

		public static string UrlEncode(string s)
		{
			return UrlEncode(s, global::System.Text.Encoding.UTF8);
		}

		public static string UrlEncode(string s, global::System.Text.Encoding encoding)
		{
			if (s == null)
			{
				throw new global::System.ArgumentNullException("s");
			...
			return global::System.Text.Encoding.ASCII.GetString(urlEncodeToBytes(bytes, 0, bytes2));
		}
		...
		public static string UrlEncode(byte[] bytes, int offset, int count)
		{
			...
			return (count > 0) ? global::System.Text.Encoding.ASCII.GetString(urlEncodeToBytes(bytes, offset, count)) : string.Empty;
		}
		...
		{
			return UrlEncodeToBytes(s, global::System.Text.Encoding.UTF8);
		}

		public static byte[] UrlEncodeToBytes(string s, global::System.Text.Encoding encoding)
		{
			if (s == null)
			{
				throw new global::System.ArgumentNullException("s");
			...
			byte[] bytes = (encoding ?? global::System.Text.Encoding.UTF8).GetBytes(s);
