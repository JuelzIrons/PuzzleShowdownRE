namespace WebSocketSharp.Net
{
	internal sealed class HttpListenerPrefix
	{
		...
		public global::WebSocketSharp.Net.HttpListener Listener => _listener;
		...
		internal HttpListenerPrefix(string uriPrefix, global::WebSocketSharp.Net.HttpListener listener)
		{
			_original = uriPrefix;
			_listener = listener;
			parse(uriPrefix);
		...
		public static void CheckPrefix(string uriPrefix)
		{
			...
			if (length == 0)
			{
				...
				throw new global::System.ArgumentException(message, "uriPrefix");
			}
			if (!uriPrefix.StartsWith("http://") && !uriPrefix.StartsWith("https://"))
			{
				string message2 = "The scheme is not 'http' or 'https'.";
				throw new global::System.ArgumentException(message2, "uriPrefix");
			}
			int num = length - 1;
			if (uriPrefix[num] != '/')
			{
				string message3 = "It ends without '/'.";
				throw new global::System.ArgumentException(message3, "uriPrefix");
			}
			int num2 = uriPrefix.IndexOf(':') + 3;
			if (num2 >= num)
			{
				string message4 = "No host is specified.";
				throw new global::System.ArgumentException(message4, "uriPrefix");
			}
			if (uriPrefix[num2] == ':')
			{
				string message5 = "No host is specified.";
				throw new global::System.ArgumentException(message5, "uriPrefix");
			}
			int num3 = uriPrefix.IndexOf('/', num2, length - num2);
			if (num3 == num2)
			{
				string message6 = "No host is specified.";
				throw new global::System.ArgumentException(message6, "uriPrefix");
			}
			if (uriPrefix[num3 - 1] == ':')
			{
				string message7 = "No port is specified.";
				throw new global::System.ArgumentException(message7, "uriPrefix");
			}
			if (num3 == num - 1)
			{
				string message8 = "No path is specified.";
				throw new global::System.ArgumentException(message8, "uriPrefix");
			}
		}

		public override bool Equals(object obj)
		{
			return obj is global::WebSocketSharp.Net.HttpListenerPrefix httpListenerPrefix && _prefix.Equals(httpListenerPrefix._prefix);
		}
