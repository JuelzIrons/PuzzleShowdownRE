...
{
	internal class AuthenticationResponse : global::WebSocketSharp.Net.AuthenticationBase
	{
		...
		private AuthenticationResponse(global::WebSocketSharp.Net.AuthenticationSchemes scheme, global::System.Collections.Specialized.NameValueCollection parameters)
			: base(scheme, parameters)
		{
		}

		internal AuthenticationResponse(global::WebSocketSharp.Net.NetworkCredential credentials)
			: this(global::WebSocketSharp.Net.AuthenticationSchemes.Basic, new global::System.Collections.Specialized.NameValueCollection(), credentials, 0u)
		{
		}

		internal AuthenticationResponse(global::WebSocketSharp.Net.AuthenticationChallenge challenge, global::WebSocketSharp.Net.NetworkCredential credentials, uint nonceCount)
			: this(challenge.Scheme, challenge.Parameters, credentials, nonceCount)
		{
		}

		internal AuthenticationResponse(global::WebSocketSharp.Net.AuthenticationSchemes scheme, global::System.Collections.Specialized.NameValueCollection parameters, global::WebSocketSharp.Net.NetworkCredential credentials, uint nonceCount)
			: base(scheme, parameters)
		{
		...
		{
			byte[] bytes = global::System.Text.Encoding.UTF8.GetBytes(value);
		...
		private void initAsDigest()
		{
			...
			if (text != null)
			{
				...
				{
					Parameters["qop"] = "auth";
					Parameters["cnonce"] = global::WebSocketSharp.Net.AuthenticationBase.CreateNonceValue();
		...
		internal static string CreateRequestDigest(global::System.Collections.Specialized.NameValueCollection parameters)
		{
		...
		internal static global::WebSocketSharp.Net.AuthenticationResponse Parse(string value)
		{
			try
			{
				...
				return (text == "basic") ? new global::WebSocketSharp.Net.AuthenticationResponse(global::WebSocketSharp.Net.AuthenticationSchemes.Basic, ParseBasicCredentials(array[1])) : ((text == "digest") ? new global::WebSocketSharp.Net.AuthenticationResponse(global::WebSocketSharp.Net.AuthenticationSchemes.Digest, global::WebSocketSharp.Net.AuthenticationBase.ParseParameters(array[1])) : null);
			}
			catch
			{
			}
		...
		internal static global::System.Collections.Specialized.NameValueCollection ParseBasicCredentials(string value)
		{
			string text = global::System.Text.Encoding.Default.GetString(global::System.Convert.FromBase64String(value));
		...
		internal override string ToBasicString()
		{
			...
			string text = global::System.Convert.ToBase64String(global::System.Text.Encoding.UTF8.GetBytes(s));
			return "Basic " + text;
		}
		...
		public global::System.Security.Principal.IIdentity ToIdentity()
		{
			global::WebSocketSharp.Net.AuthenticationSchemes scheme = base.Scheme;
			global::System.Security.Principal.IIdentity result;
			if (scheme != global::WebSocketSharp.Net.AuthenticationSchemes.Basic)
			{
				global::System.Security.Principal.IIdentity identity = ((scheme == global::WebSocketSharp.Net.AuthenticationSchemes.Digest) ? new global::WebSocketSharp.Net.HttpDigestIdentity(Parameters) : null);
				result = identity;
			}
			else
			{
				global::System.Security.Principal.IIdentity identity = new global::WebSocketSharp.Net.HttpBasicIdentity(Parameters["username"], Parameters["password"]);
				result = identity;
			}
			return result;
		}
