namespace Unity.Services.Authentication.PlayerAccounts
{
	...
	{
		private readonly global::Unity.Services.Authentication.PlayerAccounts.WebRequestVerb m_Verb;
		...
		internal global::Unity.Services.Authentication.PlayerAccounts.INetworkConfiguration Configuration { get; }

		internal int Retries { get; private set; }

		internal WebRequest(global::Unity.Services.Authentication.PlayerAccounts.INetworkConfiguration configuration, global::Unity.Services.Authentication.PlayerAccounts.WebRequestVerb verb, string url, global::System.Collections.Generic.IDictionary<string, string> headers, string payload, string payloadContentType)
		{
		...
		internal async global::System.Threading.Tasks.Task<T> SendAsync<T>()
		{
			...
			try
			{
				return global::Newtonsoft.Json.JsonConvert.DeserializeObject<T>(value, m_JsonSerializerSettings);
			}
			catch (global::System.Exception ex)
			{
				string text = "Failed to deserialize object!";
				global::Unity.Services.Authentication.PlayerAccounts.Logger.Log(text + " " + ex.Message);
				throw new global::Unity.Services.Authentication.PlayerAccounts.WebRequestException(isNetworkError: false, isServerError: false, isDeserializationError: true, 0L, text);
			}
		}
		...
		internal global::UnityEngine.Networking.UnityWebRequest Build()
		{
			...
			switch (m_Verb)
			{
			case global::Unity.Services.Authentication.PlayerAccounts.WebRequestVerb.Post:
				...
				break;
			case global::Unity.Services.Authentication.PlayerAccounts.WebRequestVerb.Get:
				unityWebRequest = global::UnityEngine.Networking.UnityWebRequest.Get(m_Url);
				break;
			case global::Unity.Services.Authentication.PlayerAccounts.WebRequestVerb.Put:
				...
				break;
			case global::Unity.Services.Authentication.PlayerAccounts.WebRequestVerb.Delete:
		...
		internal void RequestCompleted(global::System.Threading.Tasks.TaskCompletionSource<string> tcs, long responseCode, bool isNetworkError, bool isServerError, string errorText, string bodyText, global::System.Collections.Generic.IDictionary<string, string> headers)
		{
			...
			{
				global::Unity.Services.Authentication.PlayerAccounts.Logger.LogWarning("Network error detected, retrying...");
				Retries++;
			...
			else if (isNetworkError || isServerError)
			{
				...
				global::Unity.Services.Authentication.PlayerAccounts.WebRequestException exception = new global::Unity.Services.Authentication.PlayerAccounts.WebRequestException(isNetworkError, isServerError, isDeserializationError: false, responseCode, text, headers);
				tcs.SetException(exception);
				global::Unity.Services.Authentication.PlayerAccounts.Logger.LogWarning("Request completed with error: " + text);
			}
			else
			{
