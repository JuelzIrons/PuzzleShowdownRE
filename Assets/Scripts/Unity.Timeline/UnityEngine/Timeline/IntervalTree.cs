...
{
	internal class IntervalTree<T> where T : global::UnityEngine.Timeline.IInterval
	{
		...
		private readonly global::System.Collections.Generic.List<global::UnityEngine.Timeline.IntervalTree<T>.Entry> m_Entries = new global::System.Collections.Generic.List<global::UnityEngine.Timeline.IntervalTree<T>.Entry>();

		private readonly global::System.Collections.Generic.List<global::UnityEngine.Timeline.IntervalTreeNode> m_Nodes = new global::System.Collections.Generic.List<global::UnityEngine.Timeline.IntervalTreeNode>();
		...
		public void Add(T item)
		{
			if (item != null)
			{
				m_Entries.Add(new global::UnityEngine.Timeline.IntervalTree<T>.Entry
				{
		...
		public void UpdateIntervals()
		{
			...
			{
				global::UnityEngine.Timeline.IntervalTree<T>.Entry entry = m_Entries[i];
				...
				m_Entries[i] = new global::UnityEngine.Timeline.IntervalTree<T>.Entry
				{
		...
		{
			global::UnityEngine.Timeline.IntervalTreeNode value = default(global::UnityEngine.Timeline.IntervalTreeNode);
			if (end - start + 1 < 10)
			{
				value = new global::UnityEngine.Timeline.IntervalTreeNode
				{
			...
			{
				global::UnityEngine.Timeline.IntervalTree<T>.Entry entry = m_Entries[i];
				num = global::System.Math.Min(num, entry.intervalStart);
				num2 = global::System.Math.Max(num2, entry.intervalEnd);
			}
			...
			while (true)
			{
				...
				global::UnityEngine.Timeline.IntervalTree<T>.Entry value2 = m_Entries[num4];
				global::UnityEngine.Timeline.IntervalTree<T>.Entry value3 = m_Entries[num5];
			...
			while (true)
			{
				...
				global::UnityEngine.Timeline.IntervalTree<T>.Entry value4 = m_Entries[num4];
				global::UnityEngine.Timeline.IntervalTree<T>.Entry value5 = m_Entries[num5];
				m_Entries[num5] = value4;
				m_Entries[num4] = value5;
			}
			value.last = num5;
			m_Nodes.Add(default(global::UnityEngine.Timeline.IntervalTreeNode));
