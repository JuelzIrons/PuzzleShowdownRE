namespace UnityEngine.Rendering
{
	internal struct InstanceNumInfo
	{
		...
		public unsafe InstanceNumInfo(global::UnityEngine.Rendering.InstanceType type, int instanceNum)
		{
			InitDefault();
		...
		public unsafe int GetInstanceNum(global::UnityEngine.Rendering.InstanceType type)
		{
			return InstanceNums[(int)type];
		}

		public int GetInstanceNumIncludingChildren(global::UnityEngine.Rendering.InstanceType type)
		{
			int num = GetInstanceNum(type);
			foreach (global::UnityEngine.Rendering.InstanceType childType in global::UnityEngine.Rendering.InstanceTypeInfo.GetChildTypes(type))
			{
