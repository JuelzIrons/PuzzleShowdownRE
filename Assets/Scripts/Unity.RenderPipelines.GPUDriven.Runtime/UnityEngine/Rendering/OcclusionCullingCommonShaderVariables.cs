...
{
	[global::UnityEngine.Rendering.GenerateHLSL(global::UnityEngine.Rendering.PackingRules.Exact, true, false, false, 1, false, false, false, -1, ".\\Library\\PackageCache\\com.unity.render-pipelines.core@04ab0eefa0c3\\Runtime\\GPUDriven\\OcclusionCullingCommonShaderVariables.cs", needAccessors = false, generateCBuffer = true)]
	internal struct OcclusionCullingCommonShaderVariables
	{
		...
		public global::UnityEngine.Vector4 _OccluderDepthPyramidSize;
		...
		internal unsafe OcclusionCullingCommonShaderVariables(in global::UnityEngine.Rendering.OccluderContext occluderCtx, in global::UnityEngine.Rendering.InstanceOcclusionTestSubviewSettings subviewSettings, bool occlusionOverlayCountVisible, bool overrideOcclusionTestToAlwaysPass)
		{
			...
			global::UnityEngine.Vector2Int occluderDepthPyramidSize = occluderCtx.occluderDepthPyramidSize;
			_OccluderDepthPyramidSize = new global::UnityEngine.Vector4(occluderDepthPyramidSize.x, occluderDepthPyramidSize.y, 1f / (float)occluderDepthPyramidSize.x, 1f / (float)occluderDepthPyramidSize.y);
			for (int l = 0; l < occluderCtx.occluderMipBounds.Length; l++)
			{
				global::UnityEngine.Rendering.OccluderMipBounds occluderMipBounds = occluderCtx.occluderMipBounds[l];
