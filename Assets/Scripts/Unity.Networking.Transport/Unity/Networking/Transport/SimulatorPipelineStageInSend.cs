namespace Unity.Networking.Transport
{
	...
	[global::System.Obsolete("Use SimulatorPipelineStage with an ApplyMode set for sending instead.")]
	public struct SimulatorPipelineStageInSend : global::Unity.Networking.Transport.INetworkPipelineStage
	{
		...
		public unsafe global::Unity.Networking.Transport.NetworkPipelineStage StaticInitialize(byte* staticInstanceBuffer, int staticInstanceBufferLength, global::Unity.Networking.Transport.NetworkSettings settings)
		{
			...
			global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(staticInstanceBuffer, &simulatorStageParameters, global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<global::Unity.Networking.Transport.Utilities.SimulatorUtility.Parameters>());
			return new global::Unity.Networking.Transport.NetworkPipelineStage(ReceiveFunctionPointer, SendFunctionPointer, InitializeConnectionFunctionPointer, 0, simulatorStageParameters.MaxPacketCount * (simulatorStageParameters.MaxPacketSize + global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<global::Unity.Networking.Transport.Utilities.SimulatorUtility.DelayedPacket>()), 0, global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<global::Unity.Networking.Transport.Utilities.SimulatorUtility.Context>());
		}
