namespace TMPro
{
	...
	[global::UnityEngine.AddComponentMenu("Mesh/TextMeshPro - Text")]
	...
	public class TextMeshPro : global::TMPro.TMP_Text, global::UnityEngine.UI.ILayoutElement
	{
		...
		private global::TMPro.TMP_SubMesh[] m_subTextObjects = new global::TMPro.TMP_SubMesh[8];
		...
		private static global::Unity.Profiling.ProfilerMarker k_GenerateTextMarker = new global::Unity.Profiling.ProfilerMarker("TMP Layout Text");
		...
		public override bool autoSizeTextContainer
		{
			...
			set
			{
				if (m_autoSizeTextContainer != value)
				{
					...
					{
						global::TMPro.TMP_UpdateManager.RegisterTextElementForLayoutRebuild(this);
						SetLayoutDirty();
					}
				}
			}
		...
		[global::System.Obsolete("The TextContainer is now obsolete. Use the RectTransform instead.")]
		...
		public override global::UnityEngine.Mesh mesh
		{
			get
			{
				if (m_mesh == null)
		...
		public override void SetVerticesDirty()
		{
			...
			{
				global::TMPro.TMP_UpdateManager.RegisterTextElementForGraphicRebuild(this);
				this.MarkDirty();
			}
		}
		...
		protected override void Awake()
		{
			...
			if (m_renderer == null)
			{
				m_renderer = base.gameObject.AddComponent<global::UnityEngine.Renderer>();
			}
		...
		protected override void OnDisable()
		{
			if (m_isAwake)
			{
				global::TMPro.TMP_UpdateManager.UnRegisterTextElementForRebuild(this);
		...
		protected override void LoadFontAsset()
		{
			...
			if (m_fontAsset == null)
			{
				...
				m_renderer.shadowCastingMode = global::UnityEngine.Rendering.ShadowCastingMode.Off;
			}
			else
			{
				if (m_fontAsset.characterLookupTable == null)
		...
		private void UpdateEnvMapMatrix()
		{
			if (m_hasEnvMapProperty)
			{
				...
				if (!(m_currentEnvMapRotation == vector))
				{
					...
					m_EnvMapMatrix = global::UnityEngine.Matrix4x4.TRS(global::UnityEngine.Vector3.zero, global::UnityEngine.Quaternion.Euler(vector), global::UnityEngine.Vector3.one);
		...
		private void SetMask(global::TMPro.MaskingTypes maskType)
		{
			switch (maskType)
			{
			case global::TMPro.MaskingTypes.MaskOff:
				m_sharedMaterial.DisableKeyword(global::TMPro.ShaderUtilities.Keyword_MASK_SOFT);
				...
				break;
			case global::TMPro.MaskingTypes.MaskSoft:
				m_sharedMaterial.EnableKeyword(global::TMPro.ShaderUtilities.Keyword_MASK_SOFT);
				m_sharedMaterial.DisableKeyword(global::TMPro.ShaderUtilities.Keyword_MASK_HARD);
				m_sharedMaterial.DisableKeyword(global::TMPro.ShaderUtilities.Keyword_MASK_TEX);
				break;
			case global::TMPro.MaskingTypes.MaskHard:
				m_sharedMaterial.EnableKeyword(global::TMPro.ShaderUtilities.Keyword_MASK_HARD);
				m_sharedMaterial.DisableKeyword(global::TMPro.ShaderUtilities.Keyword_MASK_SOFT);
				m_sharedMaterial.DisableKeyword(global::TMPro.ShaderUtilities.Keyword_MASK_TEX);
				break;
			}
		...
		{
			m_sharedMaterial.SetVector(global::TMPro.ShaderUtilities.ID_ClipRect, coords);
		}

		private void SetMaskCoordinates(global::UnityEngine.Vector4 coords, float softX, float softY)
		{
			m_sharedMaterial.SetVector(global::TMPro.ShaderUtilities.ID_ClipRect, coords);
			m_sharedMaterial.SetFloat(global::TMPro.ShaderUtilities.ID_MaskSoftnessX, softX);
			m_sharedMaterial.SetFloat(global::TMPro.ShaderUtilities.ID_MaskSoftnessY, softY);
		}
		...
		protected override void SetSharedMaterials(global::UnityEngine.Material[] materials)
		{
			...
			for (int i = 0; i < materialCount; i++)
			{
				global::UnityEngine.Texture texture = materials[i].GetTexture(global::TMPro.ShaderUtilities.ID_MainTex);
				if (i == 0)
				{
					if (!(texture == null) && texture.GetInstanceID() == m_sharedMaterial.GetTexture(global::TMPro.ShaderUtilities.ID_MainTex).GetInstanceID())
					{
						m_sharedMaterial = (m_fontSharedMaterials[i] = materials[i]);
						m_padding = GetPaddingForMaterial(m_sharedMaterial);
					}
				}
				else if (!(texture == null) && texture.GetInstanceID() == m_subTextObjects[i].sharedMaterial.GetTexture(global::TMPro.ShaderUtilities.ID_MainTex).GetInstanceID() && m_subTextObjects[i].isDefaultMaterial)
				{
		...
		protected override void SetOutlineThickness(float thickness)
		{
			...
			m_renderer.material.SetFloat(global::TMPro.ShaderUtilities.ID_OutlineWidth, thickness);
		...
		{
			m_renderer.material.SetColor(global::TMPro.ShaderUtilities.ID_FaceColor, color);
			if (m_fontMaterial == null)
			{
				m_fontMaterial = m_renderer.material;
			}
		...
		{
			m_renderer.material.SetColor(global::TMPro.ShaderUtilities.ID_OutlineColor, color);
			if (m_fontMaterial == null)
			{
				m_fontMaterial = m_renderer.material;
			}
		...
		{
			global::UnityEngine.Material material = new global::UnityEngine.Material(m_sharedMaterial);
		...
		protected override void SetShaderDepth()
		{
			if (m_isOverlay)
			{
				global::UnityEngine.Material sharedMaterial = m_renderer.material;
				m_sharedMaterial = sharedMaterial;
			}
			else
			{
				global::UnityEngine.Material sharedMaterial2 = m_renderer.material;
		...
		protected override void SetCulling()
		{
			if (m_isCullingEnabled)
			{
				...
				{
					global::UnityEngine.Renderer renderer = m_subTextObjects[i].renderer;
					if (renderer != null)
					{
						renderer.material.SetFloat(global::TMPro.ShaderUtilities.ShaderTag_CullMode, 2f);
					}
				}
				return;
			}
			...
			{
				global::UnityEngine.Renderer renderer2 = m_subTextObjects[j].renderer;
				if (renderer2 != null)
				{
					renderer2.material.SetFloat(global::TMPro.ShaderUtilities.ShaderTag_CullMode, 0f);
				}
			}
		}
		...
		internal override int SetArraySizes(global::TMPro.TMP_Text.TextProcessingElement[] textProcessingArray)
		{
			...
			for (int l = 0; l < num13; l++)
			{
				if (l > 0)
				{
					...
					{
						m_subTextObjects[l] = global::TMPro.TMP_SubMesh.AddSubTextObject(this, global::TMPro.TMP_Text.m_materialReferences[l]);
		...
		private void OnPreRenderObject()
		{
			...
			if (m_fontAsset == null)
			{
				global::UnityEngine.Debug.LogWarning("Please assign a Font Asset to this " + transform.name + " gameobject.", this);
			}
		...
		protected virtual void GenerateTextMesh()
		{
			...
			for (int j = 0; j < m_characterCount; j++)
			{
				...
				case global::TMPro.HorizontalAlignmentOptions.Flush:
				{
					...
					bool flag24 = (horizontalAlignmentOptions & global::TMPro.HorizontalAlignmentOptions.Flush) == global::TMPro.HorizontalAlignmentOptions.Flush;
				...
				if (characterInfo[j].isVisible)
				{
					...
					case global::TMPro.TMP_TextElementType.Character:
					{
						...
						num80 = characterInfo[j].scale * global::UnityEngine.Mathf.Abs(f) * (1f - m_charWidthAdjDelta) * m_characterHorizontalScale;
		...
		internal void UpdateSubMeshSortingLayerID(int id)
		{
			...
			{
				global::TMPro.TMP_SubMesh tMP_SubMesh = m_subTextObjects[i];
