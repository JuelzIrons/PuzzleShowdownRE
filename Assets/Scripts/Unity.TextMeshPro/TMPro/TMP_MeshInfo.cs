namespace TMPro
{
	...
	{
		private static readonly global::UnityEngine.Color32 s_DefaultColor = new global::UnityEngine.Color32(byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue);

		private static readonly global::UnityEngine.Vector3 s_DefaultNormal = new global::UnityEngine.Vector3(0f, 0f, -1f);

		private static readonly global::UnityEngine.Vector4 s_DefaultTangent = new global::UnityEngine.Vector4(-1f, 0f, 0f, 1f);

		private static readonly global::UnityEngine.Bounds s_DefaultBounds = default(global::UnityEngine.Bounds);
		...
		public TMP_MeshInfo(global::UnityEngine.Mesh mesh, int size)
		{
			...
			this.mesh = mesh;
			size = global::UnityEngine.Mathf.Min(size, 16383);
			int num = size * 4;
			int num2 = size * 6;
			vertexCount = 0;
			vertices = new global::UnityEngine.Vector3[num];
			uvs0 = new global::UnityEngine.Vector4[num];
			uvs2 = new global::UnityEngine.Vector2[num];
			colors32 = new global::UnityEngine.Color32[num];
			normals = new global::UnityEngine.Vector3[num];
			tangents = new global::UnityEngine.Vector4[num];
			...
			while (num4 / 4 < size)
			{
				for (int i = 0; i < 4; i++)
				{
					vertices[num4 + i] = global::UnityEngine.Vector3.zero;
					uvs0[num4 + i] = global::UnityEngine.Vector2.zero;
					uvs2[num4 + i] = global::UnityEngine.Vector2.zero;
		...
		public TMP_MeshInfo(global::UnityEngine.Mesh mesh, int size, bool isVolumetric)
		{
			...
			size = global::UnityEngine.Mathf.Min(size, 65532 / num);
			int num3 = size * num;
			int num4 = size * num2;
			vertexCount = 0;
			vertices = new global::UnityEngine.Vector3[num3];
			uvs0 = new global::UnityEngine.Vector4[num3];
			uvs2 = new global::UnityEngine.Vector2[num3];
			colors32 = new global::UnityEngine.Color32[num3];
			normals = new global::UnityEngine.Vector3[num3];
			tangents = new global::UnityEngine.Vector4[num3];
			...
			while (num5 / num < size)
			{
				for (int i = 0; i < num; i++)
				{
					vertices[num5 + i] = global::UnityEngine.Vector3.zero;
					uvs0[num5 + i] = global::UnityEngine.Vector2.zero;
					uvs2[num5 + i] = global::UnityEngine.Vector2.zero;
		...
		public void ResizeMeshInfo(int size)
		{
			...
			global::System.Array.Resize(ref vertices, newSize);
			global::System.Array.Resize(ref normals, newSize);
			global::System.Array.Resize(ref tangents, newSize);
			global::System.Array.Resize(ref uvs0, newSize);
			global::System.Array.Resize(ref uvs2, newSize);
			global::System.Array.Resize(ref colors32, newSize);
			global::System.Array.Resize(ref triangles, newSize2);
			if (size <= num)
			{
		...
		public void Clear()
		{
			if (vertices != null)
			{
				global::System.Array.Clear(vertices, 0, vertices.Length);
				vertexCount = 0;
				if (mesh != null)
				{
					mesh.vertices = vertices;
		...
		public void ClearUnusedVertices()
		{
			...
			if (num > 0)
			{
				global::System.Array.Clear(vertices, vertexCount, num);
			}
		}
		...
		public void ClearUnusedVertices(int startIndex)
		{
			...
			if (num > 0)
			{
				global::System.Array.Clear(vertices, startIndex, num);
			}
		}
		...
		{
			if (order == global::TMPro.VertexSortingOrder.Normal || order != global::TMPro.VertexSortingOrder.Reverse)
			{
				return;
			}
		...
		{
			global::UnityEngine.Vector3 vector = vertices[dst];
			...
			global::UnityEngine.Vector4 vector2 = uvs0[dst];
			uvs0[dst] = uvs0[src];
			uvs0[src] = vector2;
			vector2 = uvs0[dst + 1];
			...
			uvs2[src + 3] = vector2;
			global::UnityEngine.Color32 color = colors32[dst];
