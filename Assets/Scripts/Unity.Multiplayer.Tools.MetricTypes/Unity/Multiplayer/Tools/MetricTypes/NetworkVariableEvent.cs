namespace Unity.Multiplayer.Tools.MetricTypes
{
	...
	internal struct NetworkVariableEvent : global::Unity.Multiplayer.Tools.MetricTypes.INetworkMetricEvent, global::Unity.Multiplayer.Tools.MetricTypes.INetworkObjectEvent
	{
		...
		public ulong TreeViewId
		{
			get
			{
				...
				ulong num4 = (ulong)Name.GetHashCode();
				ulong num5 = (ulong)NetworkBehaviourName.GetHashCode();
				return (ulong)(num + (long)num2 + (long)num3 + (long)num4) + num5;
			}
		}

		public NetworkVariableEvent(global::Unity.Multiplayer.Tools.MetricTypes.ConnectionInfo connection, global::Unity.Multiplayer.Tools.MetricTypes.NetworkObjectIdentifier networkId, string name, string networkBehaviourName, long bytesCount)
		...
		public NetworkVariableEvent(global::Unity.Multiplayer.Tools.MetricTypes.ConnectionInfo connection, global::Unity.Multiplayer.Tools.MetricTypes.NetworkObjectIdentifier networkId, global::Unity.Collections.FixedString64Bytes name, global::Unity.Collections.FixedString64Bytes networkBehaviourName, long bytesCount)
		{
