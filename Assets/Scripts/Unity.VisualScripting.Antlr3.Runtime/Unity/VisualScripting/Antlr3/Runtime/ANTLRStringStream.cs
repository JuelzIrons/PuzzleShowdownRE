...
{
	public class ANTLRStringStream : global::Unity.VisualScripting.Antlr3.Runtime.ICharStream, global::Unity.VisualScripting.Antlr3.Runtime.IIntStream
	{
		...
		protected internal global::System.Collections.IList markers;
		...
		public virtual int Mark()
		{
			...
			markDepth++;
			global::Unity.VisualScripting.Antlr3.Runtime.CharStreamState charStreamState = null;
			if (markDepth >= markers.Count)
			{
				charStreamState = new global::Unity.VisualScripting.Antlr3.Runtime.CharStreamState();
				markers.Add(charStreamState);
			}
			else
			{
				charStreamState = (global::Unity.VisualScripting.Antlr3.Runtime.CharStreamState)markers[markDepth];
			}
			charStreamState.p = p;
		...
		{
			global::Unity.VisualScripting.Antlr3.Runtime.CharStreamState charStreamState = (global::Unity.VisualScripting.Antlr3.Runtime.CharStreamState)markers[m];
