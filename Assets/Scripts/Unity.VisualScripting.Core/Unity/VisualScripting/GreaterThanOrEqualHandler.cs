...
{
	public class GreaterThanOrEqualHandler : global::Unity.VisualScripting.BinaryOperatorHandler
	{
			...
			: base("Greater Than Or Equal", "Greater Than Or Equal", ">=", "op_GreaterThanOrEqual")
		{
			...
			Handle((float a, float b) => a >= b || global::UnityEngine.Mathf.Approximately(a, b));
