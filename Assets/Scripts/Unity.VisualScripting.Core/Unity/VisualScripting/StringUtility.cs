namespace Unity.VisualScripting
{
	...
	{
		private static readonly global::System.Text.RegularExpressions.Regex guidRegex = new global::System.Text.RegularExpressions.Regex("[a-fA-F0-9]{8}(\\-[a-fA-F0-9]{4}){3}\\-[a-fA-F0-9]{12}");
		...
		public static void AppendLineFormat(this global::System.Text.StringBuilder sb, string format, params object[] args)
		{
			sb.AppendFormat(format, args);
			sb.AppendLine();
		}

		public static string ToSeparatedString(this global::System.Collections.IEnumerable enumerable, string separator)
		{
			return string.Join(separator, global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(global::System.Linq.Enumerable.Cast<object>(enumerable), (object o) => o?.ToString() ?? "(null)")));
		}

		public static string ToCommaSeparatedString(this global::System.Collections.IEnumerable enumerable)
		{
			return enumerable.ToSeparatedString(", ");
		}

		public static string ToLineSeparatedString(this global::System.Collections.IEnumerable enumerable)
		{
			return enumerable.ToSeparatedString(global::System.Environment.NewLine);
		}

		public static bool ContainsInsensitive(this string haystack, string needle)
		{
			return haystack.IndexOf(needle, global::System.StringComparison.OrdinalIgnoreCase) >= 0;
		}

		public static global::System.Collections.Generic.IEnumerable<int> AllIndexesOf(this string haystack, string needle)
		{
			...
			while (true)
			{
				index = haystack.IndexOf(needle, index, global::System.StringComparison.OrdinalIgnoreCase);
				if (index != -1)
				{
					yield return index;
					index += needle.Length;
		...
		{
			global::Unity.VisualScripting.Ensure.That("index").IsGte(index, 0);
			global::Unity.VisualScripting.Ensure.That("index").IsLt(index, s.Length);
		...
		public static string ReplaceMultiple(this string s, global::System.Collections.Generic.HashSet<char> haystacks, char replacement)
		{
			global::Unity.VisualScripting.Ensure.That("haystacks").IsNotNull(haystacks);
			global::System.Text.StringBuilder stringBuilder = new global::System.Text.StringBuilder();
			foreach (char c in s)
			{
		...
		{
			global::Unity.VisualScripting.Ensure.That("s").IsNotNull(s);
			int num = s.IndexOf(c);
			if (num > 0)
			{
		...
		{
			return global::System.Convert.ToString(value, 2).PadLeft(8, '0');
		}

		public static string ToBinaryString(this long value)
		{
			return global::System.Convert.ToString(value, 2).PadLeft(16, '0');
		}

		public static string ToBinaryString(this global::System.Enum value)
		{
			return global::System.Convert.ToString(global::System.Convert.ToInt64(value), 2).PadLeft(16, '0');
		}
		...
		public static string PathEllipsis(string s, int maxLength)
		{
			...
			string fileName = global::System.IO.Path.GetFileName(s);
			string directoryName = global::System.IO.Path.GetDirectoryName(s);
			int num = maxLength - fileName.Length - text.Length;
			if (num > 0)
			{
				return directoryName.Substring(0, num) + text + global::System.IO.Path.DirectorySeparatorChar + fileName;
			}
			return text + global::System.IO.Path.DirectorySeparatorChar + fileName;
		}

		public static string ToHexString(this byte[] bytes)
		{
			return global::System.BitConverter.ToString(bytes).Replace("-", "");
		}
	}
}
