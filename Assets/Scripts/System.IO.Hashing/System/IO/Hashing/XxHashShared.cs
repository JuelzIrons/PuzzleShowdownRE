namespace System.IO.Hashing
{
	internal static class XxHashShared
	{
		...
		public static global::System.ReadOnlySpan<byte> DefaultSecret => new byte[192]
		{
		...
		public unsafe static void Initialize(ref global::System.IO.Hashing.XxHashShared.State state, ulong seed)
		{
			state.Seed = seed;
			fixed (byte* secret = state.Secret)
			{
				if (seed == 0L)
				{
					DefaultSecret.CopyTo(new global::System.Span<byte>(secret, 192));
				}
				else
				{
		...
		public unsafe static void Reset(ref global::System.IO.Hashing.XxHashShared.State state)
		{
		...
		{
			hash ^= global::System.Numerics.BitOperations.RotateLeft(hash, 49) ^ global::System.Numerics.BitOperations.RotateLeft(hash, 24);
		...
		public unsafe static void Append(ref global::System.IO.Hashing.XxHashShared.State state, global::System.ReadOnlySpan<byte> source)
		{
			...
			fixed (byte* buffer = state.Buffer)
			{
				...
				{
					source.CopyTo(new global::System.Span<byte>(buffer + state.BufferedCount, source.Length));
					...
					fixed (ulong* accumulators = state.Accumulators)
					{
						fixed (byte* reference = &global::System.Runtime.InteropServices.MemoryMarshal.GetReference(source))
						{
							...
							if (state.BufferedCount != 0)
							{
								...
								source.Slice(0, num2).CopyTo(new global::System.Span<byte>(buffer + state.BufferedCount, num2));
								num = num2;
							...
							if (source.Length - num > 1024)
							{
								...
								source.Slice(num - 64, 64).CopyTo(new global::System.Span<byte>(buffer + 256 - 64, 64));
							}
							...
							global::System.Span<byte> destination = new global::System.Span<byte>(buffer, source.Length - num);
		...
		public unsafe static void CopyAccumulators(ref global::System.IO.Hashing.XxHashShared.State state, ulong* accumulators)
		{
		...
		public unsafe static void DigestLong(ref global::System.IO.Hashing.XxHashShared.State state, ulong* accumulators, byte* secret)
		{
			fixed (byte* buffer = state.Buffer)
			{
				byte* source;
				...
				else
				{
					...
					new global::System.ReadOnlySpan<byte>(buffer + 256 - num2, num2).CopyTo(new global::System.Span<byte>(ptr, 64));
					new global::System.ReadOnlySpan<byte>(buffer, (int)state.BufferedCount).CopyTo(new global::System.Span<byte>(ptr + num2, (int)state.BufferedCount));
					source = ptr;
				}
		...
		{
			fixed (byte* reference = &global::System.Runtime.InteropServices.MemoryMarshal.GetReference(DefaultSecret))
			{
		...
		public unsafe static uint ReadUInt32LE(byte* data)
		{
			...
			{
				return global::System.Buffers.Binary.BinaryPrimitives.ReverseEndianness(global::System.Runtime.CompilerServices.Unsafe.ReadUnaligned<uint>(data));
			}
			return global::System.Runtime.CompilerServices.Unsafe.ReadUnaligned<uint>(data);
		}
		...
		public unsafe static ulong ReadUInt64LE(byte* data)
		{
			if (!global::System.BitConverter.IsLittleEndian)
			{
				return global::System.Buffers.Binary.BinaryPrimitives.ReverseEndianness(global::System.Runtime.CompilerServices.Unsafe.ReadUnaligned<ulong>(data));
			}
			return global::System.Runtime.CompilerServices.Unsafe.ReadUnaligned<ulong>(data);
		}
		...
		private unsafe static void WriteUInt64LE(byte* data, ulong value)
		{
			...
			global::System.Runtime.CompilerServices.Unsafe.WriteUnaligned(data, value);
		}
	}
}
