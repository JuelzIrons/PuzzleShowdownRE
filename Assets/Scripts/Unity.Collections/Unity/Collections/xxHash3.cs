	...
	public static class xxHash3
	{
		...
		public struct StreamingState
		{
			...
			private struct StreamingStateData
			{
				...
				[global::System.Runtime.InteropServices.FieldOffset(320)]
				public int IsHash64;

				[global::System.Runtime.InteropServices.FieldOffset(324)]
				public int BufferedSize;

				[global::System.Runtime.InteropServices.FieldOffset(328)]
				public int NbStripesSoFar;

				[global::System.Runtime.InteropServices.FieldOffset(336)]
				public long TotalLength;

				[global::System.Runtime.InteropServices.FieldOffset(344)]
				public ulong Seed;

				[global::System.Runtime.InteropServices.FieldOffset(352)]
				public byte SecretKey;

				[global::System.Runtime.InteropServices.FieldOffset(540)]
				public byte _PadEnd;
			}
			...
			private global::Unity.Collections.xxHash3.StreamingState.StreamingStateData State;
			...
			private unsafe ulong* Acc
			{
				...
				get
				{
					return (ulong*)global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.AddressOf(ref State.Acc);
				}
			}
			...
			private unsafe byte* Buffer
			{
				...
				get
				{
					return (byte*)global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.AddressOf(ref State.Buffer);
				}
			}
			...
			private unsafe byte* SecretKey
			{
				...
				get
				{
					return (byte*)global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.AddressOf(ref State.SecretKey);
				}
			}

			public StreamingState(bool isHash64, ulong seed = 0uL)
			{
				State = default(global::Unity.Collections.xxHash3.StreamingState.StreamingStateData);
				Reset(isHash64, seed);
			}

			public unsafe void Reset(bool isHash64, ulong seed = 0uL)
			{
				int num = global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<global::Unity.Collections.xxHash3.StreamingState.StreamingStateData>();
				global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemClear(global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.AddressOf(ref State), num);
				...
				*acc = 3266489917uL;
				...
				acc[7] = 2654435761uL;
				State.Seed = seed;
				fixed (byte* kSecret = global::Unity.Collections.xxHashDefaultKey.kSecret)
				{
					if (seed != 0L)
					{
					...
					{
						global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(SecretKey, kSecret, 192L);
					}
				}
			}
			...
			public unsafe void Update(void* input, int length)
			{
				...
				{
					global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(Buffer + State.BufferedSize, ptr, length);
				...
				if (State.BufferedSize != 0)
				{
					...
					global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(Buffer + State.BufferedSize, ptr, num);
					ptr += num;
				...
				if (ptr + INTERNAL_BUFFER_SIZE < ptr2)
				{
					...
					while (ptr < ptr3);
					global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(Buffer + INTERNAL_BUFFER_SIZE - 64, ptr - 64, 64L);
				}
				if (ptr < ptr2)
				{
					long num2 = ptr2 - ptr;
					global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(Buffer, ptr, num2);
			...
			{
				Update(global::Unity.Collections.LowLevel.Unsafe.UnsafeUtilityExtensions.AddressOf(in input), global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<T>());
			}

			public unsafe global::Unity.Mathematics.uint4 DigestHash128()
			{
				byte* secretKey = SecretKey;
				global::Unity.Mathematics.uint4 result;
			...
			public unsafe global::Unity.Mathematics.uint2 DigestHash64()
			{
				byte* secretKey = SecretKey;
				global::Unity.Mathematics.uint2 result;
				if (State.TotalLength > 240)
				{
					ulong* acc = stackalloc ulong[8];
			...
			{
				global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(acc, Acc, 64L);
				if (State.BufferedSize >= 64)
				{
					...
					if (global::Unity.Burst.Intrinsics.X86.Avx2.IsAvx2Supported)
					{
				...
				global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(ptr, Buffer + INTERNAL_BUFFER_SIZE - num2, num2);
				global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(ptr + num2, Buffer, State.BufferedSize);
				if (global::Unity.Burst.Intrinsics.X86.Avx2.IsAvx2Supported)
				{
			...
			private void CheckKeySize(int isHash64)
			{
				if (State.IsHash64 != isHash64)
				{
					...
					throw new global::System.InvalidOperationException("The streaming state was create for " + text + " bits hash key, the calling method doesn't support this key size, please use the appropriate API");
				}
			}
		}
		...
		internal static class Hash64Long_00000A6B_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref global::System.IntPtr P_0)
			{
				...
				{
					Pointer = global::Unity.Burst.BurstCompiler.CompileFunctionPointer<global::Unity.Collections.xxHash3.Hash64Long_00000A6B_0024PostfixBurstDelegate>(Hash64Long).Value;
				}
				P_0 = Pointer;
			}
		...
		[global::System.Runtime.InteropServices.UnmanagedFunctionPointer(global::System.Runtime.InteropServices.CallingConvention.Cdecl)]
		internal unsafe delegate void Hash128Long_00000A72_0024PostfixBurstDelegate(byte* input, byte* dest, long length, byte* secret, out global::Unity.Mathematics.uint4 result);
		...
		internal static class Hash128Long_00000A72_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref global::System.IntPtr P_0)
			{
				if (Pointer == (global::System.IntPtr)0)
				{
					Pointer = global::Unity.Burst.BurstCompiler.CompileFunctionPointer<global::Unity.Collections.xxHash3.Hash128Long_00000A72_0024PostfixBurstDelegate>(Hash128Long).Value;
				}
				P_0 = Pointer;
			}
			...
			public unsafe static void Invoke(byte* input, byte* dest, long length, byte* secret, out global::Unity.Mathematics.uint4 result)
			{
				if (global::Unity.Burst.BurstCompiler.IsEnabled)
				{
					global::System.IntPtr functionPointer = GetFunctionPointer();
					if (functionPointer != (global::System.IntPtr)0)
					{
						((delegate* unmanaged[Cdecl]<byte*, byte*, long, byte*, ref global::Unity.Mathematics.uint4, void>)functionPointer)(input, dest, length, secret, ref result);
						return;
					}
				}
		...
		internal unsafe static void Avx2HashLongInternalLoop(ulong* acc, byte* input, byte* dest, long length, byte* secret, int isHash64)
		{
			...
			if (dest != null)
			{
				...
				if (num2 != 0L)
				{
					global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(dest + length - num2, input + length - num2, num2);
				}
			}
		}
		...
		internal unsafe static void Avx2ScrambleAcc(ulong* acc, byte* secret)
		{
			if (global::Unity.Burst.Intrinsics.X86.Avx2.IsAvx2Supported)
			{
				global::Unity.Burst.Intrinsics.v256 b = global::Unity.Burst.Intrinsics.X86.Avx.mm256_set1_epi32(-1640531535);
				global::Unity.Burst.Intrinsics.v256 a = *(global::Unity.Burst.Intrinsics.v256*)acc;
				global::Unity.Burst.Intrinsics.v256 b2 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_srli_epi64(a, 47);
				global::Unity.Burst.Intrinsics.v256 a2 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_xor_si256(a, b2);
				global::Unity.Burst.Intrinsics.v256 b3 = global::Unity.Burst.Intrinsics.X86.Avx.mm256_loadu_si256(secret);
				global::Unity.Burst.Intrinsics.v256 a3 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_xor_si256(a2, b3);
				global::Unity.Burst.Intrinsics.v256 a4 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_shuffle_epi32(a3, global::Unity.Burst.Intrinsics.X86.Sse.SHUFFLE(0, 3, 0, 1));
				global::Unity.Burst.Intrinsics.v256 a5 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_mul_epu32(a3, b);
				global::Unity.Burst.Intrinsics.v256 a6 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_mul_epu32(a4, b);
				*(global::Unity.Burst.Intrinsics.v256*)acc = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_add_epi64(a5, global::Unity.Burst.Intrinsics.X86.Avx2.mm256_slli_epi64(a6, 32));
				global::Unity.Burst.Intrinsics.v256 a7 = ((global::Unity.Burst.Intrinsics.v256*)acc)[1];
				b2 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_srli_epi64(a7, 47);
				global::Unity.Burst.Intrinsics.v256 a8 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_xor_si256(a7, b2);
				b3 = global::Unity.Burst.Intrinsics.X86.Avx.mm256_loadu_si256(secret + sizeof(global::Unity.Burst.Intrinsics.v256));
				global::Unity.Burst.Intrinsics.v256 a9 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_xor_si256(a8, b3);
				a4 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_shuffle_epi32(a9, global::Unity.Burst.Intrinsics.X86.Sse.SHUFFLE(0, 3, 0, 1));
				a5 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_mul_epu32(a9, b);
				a6 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_mul_epu32(a4, b);
				((global::Unity.Burst.Intrinsics.v256*)acc)[1] = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_add_epi64(a5, global::Unity.Burst.Intrinsics.X86.Avx2.mm256_slli_epi64(a6, 32));
			}
		}
		...
		internal unsafe static void Avx2Accumulate512(ulong* acc, byte* input, byte* dest, byte* secret)
		{
			if (global::Unity.Burst.Intrinsics.X86.Avx2.IsAvx2Supported)
			{
				global::Unity.Burst.Intrinsics.v256 v257 = global::Unity.Burst.Intrinsics.X86.Avx.mm256_loadu_si256(input);
				global::Unity.Burst.Intrinsics.v256 b = global::Unity.Burst.Intrinsics.X86.Avx.mm256_loadu_si256(secret);
				global::Unity.Burst.Intrinsics.v256 a = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_xor_si256(v257, b);
				if (dest != null)
				{
					global::Unity.Burst.Intrinsics.X86.Avx.mm256_storeu_si256(dest, v257);
				}
				global::Unity.Burst.Intrinsics.v256 b2 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_shuffle_epi32(a, global::Unity.Burst.Intrinsics.X86.Sse.SHUFFLE(0, 3, 0, 1));
				global::Unity.Burst.Intrinsics.v256 a2 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_mul_epu32(a, b2);
				global::Unity.Burst.Intrinsics.v256 b3 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_shuffle_epi32(v257, global::Unity.Burst.Intrinsics.X86.Sse.SHUFFLE(1, 0, 3, 2));
				global::Unity.Burst.Intrinsics.v256 b4 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_add_epi64(*(global::Unity.Burst.Intrinsics.v256*)acc, b3);
				*(global::Unity.Burst.Intrinsics.v256*)acc = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_add_epi64(a2, b4);
				v257 = global::Unity.Burst.Intrinsics.X86.Avx.mm256_loadu_si256(input + sizeof(global::Unity.Burst.Intrinsics.v256));
				b = global::Unity.Burst.Intrinsics.X86.Avx.mm256_loadu_si256(secret + sizeof(global::Unity.Burst.Intrinsics.v256));
				global::Unity.Burst.Intrinsics.v256 a3 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_xor_si256(v257, b);
				if (dest != null)
				{
					global::Unity.Burst.Intrinsics.X86.Avx.mm256_storeu_si256(dest + 32, v257);
				}
				b2 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_shuffle_epi32(a3, global::Unity.Burst.Intrinsics.X86.Sse.SHUFFLE(0, 3, 0, 1));
				a2 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_mul_epu32(a3, b2);
				b3 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_shuffle_epi32(v257, global::Unity.Burst.Intrinsics.X86.Sse.SHUFFLE(1, 0, 3, 2));
				b4 = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_add_epi64(((global::Unity.Burst.Intrinsics.v256*)acc)[1], b3);
				((global::Unity.Burst.Intrinsics.v256*)acc)[1] = global::Unity.Burst.Intrinsics.X86.Avx2.mm256_add_epi64(a2, b4);
			}
		}

		public unsafe static global::Unity.Mathematics.uint2 Hash64(void* input, long length)
		{
			fixed (byte* kSecret = global::Unity.Collections.xxHashDefaultKey.kSecret)
			{
				void* secret = kSecret;
		...
		[global::Unity.Collections.GenerateTestsForBurstCompatibility(GenericTypeArguments = new global::System.Type[] { typeof(int) })]
		public unsafe static global::Unity.Mathematics.uint2 Hash64<T>(in T input) where T : unmanaged
		{
			return Hash64(global::Unity.Collections.LowLevel.Unsafe.UnsafeUtilityExtensions.AddressOf(in input), global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<T>());
		}

		public unsafe static global::Unity.Mathematics.uint2 Hash64(void* input, long length, ulong seed)
		{
			fixed (byte* kSecret = global::Unity.Collections.xxHashDefaultKey.kSecret)
			{
		...
		public unsafe static global::Unity.Mathematics.uint4 Hash128(void* input, long length)
		{
			fixed (byte* kSecret = global::Unity.Collections.xxHashDefaultKey.kSecret)
			{
				void* secret = kSecret;
		...
		[global::Unity.Collections.GenerateTestsForBurstCompatibility(GenericTypeArguments = new global::System.Type[] { typeof(int) })]
		public unsafe static global::Unity.Mathematics.uint4 Hash128<T>(in T input) where T : unmanaged
		{
			return Hash128(global::Unity.Collections.LowLevel.Unsafe.UnsafeUtilityExtensions.AddressOf(in input), global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<T>());
		}

		public unsafe static global::Unity.Mathematics.uint4 Hash128(void* input, void* destination, long length)
		{
			fixed (byte* kSecret = global::Unity.Collections.xxHashDefaultKey.kSecret)
			{
		...
		public unsafe static global::Unity.Mathematics.uint4 Hash128(void* input, long length, ulong seed)
		{
			fixed (byte* kSecret = global::Unity.Collections.xxHashDefaultKey.kSecret)
			{
		...
		public unsafe static global::Unity.Mathematics.uint4 Hash128(void* input, void* destination, long length, ulong seed)
		{
			fixed (byte* kSecret = global::Unity.Collections.xxHashDefaultKey.kSecret)
			{
		...
		internal unsafe static ulong Hash64Internal(byte* input, byte* dest, long length, byte* secret, ulong seed)
		{
			...
			{
				global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(dest, input, length);
			}
			if (length <= 16)
			{
		...
		internal unsafe static void Hash128Internal(byte* input, byte* dest, long length, byte* secret, ulong seed, out global::Unity.Mathematics.uint4 result)
		{
			if (dest != null && length < 240)
			{
				global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(dest, input, length);
		...
		[global::Unity.Burst.BurstCompile]
		[global::AOT.MonoPInvokeCallback(typeof(Unity_002ECollections_002EHash64Long_00000A6B_0024PostfixBurstDelegate))]
		private unsafe static ulong Hash64Long(byte* input, byte* dest, long length, byte* secret)
		{
			return global::Unity.Collections.xxHash3.Hash64Long_00000A6B_0024BurstDirectCall.Invoke(input, dest, length, secret);
		}

		private unsafe static void Hash128Len1To3(byte* input, long length, byte* secret, ulong seed, out global::Unity.Mathematics.uint4 result)
		{
			byte num = *input;
		...
		private unsafe static void Hash128Len4To8(byte* input, long len, byte* secret, ulong seed, out global::Unity.Mathematics.uint4 result)
		{
			seed ^= (ulong)Swap32((uint)seed) << 32;
			uint num = Read32LE(input);
			...
			ulong high;
			ulong num5 = global::Unity.Burst.Intrinsics.Common.umul128(num3 ^ num4, (ulong)(-7046029288634856825L + (len << 2)), out high);
			high += num5 << 1;
			num5 ^= high >> 3;
		...
		private unsafe static void Hash128Len9To16(byte* input, long len, byte* secret, ulong seed, out global::Unity.Mathematics.uint4 result)
		{
			...
			ulong high;
			long num5 = (long)global::Unity.Burst.Intrinsics.Common.umul128(num3 ^ num4 ^ num, 11400714785074694791uL, out high) + (len - 1 << 54);
			num4 ^= num2;
			high += num4 + Mul32To64((uint)num4, 2246822518u);
			ulong high2;
			ulong h = global::Unity.Burst.Intrinsics.Common.umul128((ulong)num5 ^ Swap64(high), 14029467366897019727uL, out high2);
			high2 += (ulong)((long)high * -4417276706812531889L);
			result = ToUint4(Avalanche(h), Avalanche(high2));
		}

		private unsafe static void Hash128Len0To16(byte* input, long length, byte* secret, ulong seed, out global::Unity.Mathematics.uint4 result)
		{
			if (length > 8)
			{
		...
		private unsafe static void Hash128Len17To128(byte* input, long length, byte* secret, ulong seed, out global::Unity.Mathematics.uint4 result)
		{
			global::Unity.Collections.xxHash3.ulong2 acc = new global::Unity.Collections.xxHash3.ulong2((ulong)(length * -7046029288634856825L), 0uL);
			if (length > 32)
			{
				if (length > 64)
				{
		...
		private unsafe static void Hash128Len129To240(byte* input, long length, byte* secret, ulong seed, out global::Unity.Mathematics.uint4 result)
		{
			global::Unity.Collections.xxHash3.ulong2 acc = new global::Unity.Collections.xxHash3.ulong2((ulong)(length * -7046029288634856825L), 0uL);
			long num = length / 32;
			for (int i = 0; i < 4; i++)
		...
		[global::Unity.Burst.BurstCompile]
		[global::AOT.MonoPInvokeCallback(typeof(Unity_002ECollections_002EHash128Long_00000A72_0024PostfixBurstDelegate))]
		private unsafe static void Hash128Long(byte* input, byte* dest, long length, byte* secret, out global::Unity.Mathematics.uint4 result)
		{
			global::Unity.Collections.xxHash3.Hash128Long_00000A72_0024BurstDirectCall.Invoke(input, dest, length, secret, out result);
		}

		internal static global::Unity.Mathematics.uint2 ToUint2(ulong u)
		{
			return new global::Unity.Mathematics.uint2((uint)(u & 0xFFFFFFFFu), (uint)(u >> 32));
		}

		internal static global::Unity.Mathematics.uint4 ToUint4(ulong ul0, ulong ul1)
		{
			return new global::Unity.Mathematics.uint4((uint)(ul0 & 0xFFFFFFFFu), (uint)(ul0 >> 32), (uint)(ul1 & 0xFFFFFFFFu), (uint)(ul1 >> 32));
		}
		...
		{
			ulong high;
			return global::Unity.Burst.Intrinsics.Common.umul128(lhs, rhs, out high) ^ high;
		}
		...
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		private unsafe static global::Unity.Collections.xxHash3.ulong2 Mix32(global::Unity.Collections.xxHash3.ulong2 acc, byte* input_1, byte* input_2, byte* secret, ulong seed)
		{
			...
			return new global::Unity.Collections.xxHash3.ulong2(x, num);
		}
		...
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		[global::Unity.Burst.BurstCompile]
		internal unsafe static void Hash128Long_0024BurstManaged(byte* input, byte* dest, long length, byte* secret, out global::Unity.Mathematics.uint4 result)
		{
			ulong* ptr = (ulong*)(((long)stackalloc byte[95] + 31L) & -32);
			*ptr = 3266489917uL;
			ptr[1] = 11400714785074694791uL;
