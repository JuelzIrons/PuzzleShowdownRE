namespace Unity.Collections
{
	...
	[global::System.Diagnostics.DebuggerTypeProxy(typeof(global::Unity.Collections.FixedList128BytesDebugView<>))]
	[global::Unity.Collections.GenerateTestsForBurstCompatibility(GenericTypeArguments = new global::System.Type[] { typeof(int) })]
	public struct FixedList128Bytes<T> : global::Unity.Collections.INativeList<T>, global::Unity.Collections.IIndexable<T>, global::System.Collections.Generic.IEnumerable<T>, global::System.Collections.IEnumerable, global::System.IEquatable<global::Unity.Collections.FixedList32Bytes<T>>, global::System.IComparable<global::Unity.Collections.FixedList32Bytes<T>>, global::System.IEquatable<global::Unity.Collections.FixedList64Bytes<T>>, global::System.IComparable<global::Unity.Collections.FixedList64Bytes<T>>, global::System.IEquatable<global::Unity.Collections.FixedList128Bytes<T>>, global::System.IComparable<global::Unity.Collections.FixedList128Bytes<T>>, global::System.IEquatable<global::Unity.Collections.FixedList512Bytes<T>>, global::System.IComparable<global::Unity.Collections.FixedList512Bytes<T>>, global::System.IEquatable<global::Unity.Collections.FixedList4096Bytes<T>>, global::System.IComparable<global::Unity.Collections.FixedList4096Bytes<T>> where T : unmanaged
	{
		public struct Enumerator : global::System.Collections.Generic.IEnumerator<T>, global::System.Collections.IEnumerator, global::System.IDisposable
		{
			...
			public Enumerator(ref global::Unity.Collections.FixedList128Bytes<T> list)
			{
				m_List = list;
				m_Index = -1;
			}
		...
		internal global::Unity.Collections.FixedBytes128Align8 data;
		...
		internal unsafe ushort length
		{
			...
			readonly get
			{
				fixed (global::Unity.Collections.FixedBytes128Align8* ptr = &data)
				{
					void* ptr2 = ptr;
					return *(ushort*)ptr2;
				}
		...
		public int Capacity
		{
			...
			readonly get
			{
				return global::Unity.Collections.FixedList.Capacity<global::Unity.Collections.FixedBytes128Align8, T>();
			}
			set
			{
			}
		...
		public unsafe static bool operator ==(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList32Bytes<T> b)
		{
		...
		public static bool operator !=(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList32Bytes<T> b)
		{
			return !(a == b);
		}
		...
		public FixedList128Bytes(in global::Unity.Collections.FixedList32Bytes<T> other)
		{
			this = default(global::Unity.Collections.FixedList128Bytes<T>);
			Initialize(in other);
		}
		...
		public static implicit operator global::Unity.Collections.FixedList128Bytes<T>(in global::Unity.Collections.FixedList32Bytes<T> other)
		{
			return new global::Unity.Collections.FixedList128Bytes<T>(in other);
		}

		public unsafe static bool operator ==(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList64Bytes<T> b)
		{
			if (a.length != b.length)
			{
				return false;
		...
		public static bool operator !=(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList64Bytes<T> b)
		{
			return !(a == b);
		}
		...
		public FixedList128Bytes(in global::Unity.Collections.FixedList64Bytes<T> other)
		{
			this = default(global::Unity.Collections.FixedList128Bytes<T>);
			Initialize(in other);
		}
		...
		public static implicit operator global::Unity.Collections.FixedList128Bytes<T>(in global::Unity.Collections.FixedList64Bytes<T> other)
		{
			return new global::Unity.Collections.FixedList128Bytes<T>(in other);
		}

		public unsafe static bool operator ==(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList128Bytes<T> b)
		{
			if (a.length != b.length)
			{
				return false;
		...
		public static bool operator !=(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList128Bytes<T> b)
		{
			return !(a == b);
		}
		...
		public unsafe static bool operator ==(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList512Bytes<T> b)
		{
			if (a.length != b.length)
			{
				return false;
		...
		public static bool operator !=(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList512Bytes<T> b)
		{
			return !(a == b);
		}
		...
		public FixedList128Bytes(in global::Unity.Collections.FixedList512Bytes<T> other)
		{
			this = default(global::Unity.Collections.FixedList128Bytes<T>);
			Initialize(in other);
		}
		...
		public static implicit operator global::Unity.Collections.FixedList128Bytes<T>(in global::Unity.Collections.FixedList512Bytes<T> other)
		{
			return new global::Unity.Collections.FixedList128Bytes<T>(in other);
		}

		public unsafe static bool operator ==(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList4096Bytes<T> b)
		{
			if (a.length != b.length)
			{
				return false;
		...
		public static bool operator !=(in global::Unity.Collections.FixedList128Bytes<T> a, in global::Unity.Collections.FixedList4096Bytes<T> b)
		{
			return !(a == b);
		}
		...
		public FixedList128Bytes(in global::Unity.Collections.FixedList4096Bytes<T> other)
		{
			this = default(global::Unity.Collections.FixedList128Bytes<T>);
			Initialize(in other);
		}
		...
		public static implicit operator global::Unity.Collections.FixedList128Bytes<T>(in global::Unity.Collections.FixedList4096Bytes<T> other)
		{
			return new global::Unity.Collections.FixedList128Bytes<T>(in other);
		}
		...
		public global::Unity.Collections.FixedList128Bytes<T>.Enumerator GetEnumerator()
		{
			return new global::Unity.Collections.FixedList128Bytes<T>.Enumerator(ref this);
		}
