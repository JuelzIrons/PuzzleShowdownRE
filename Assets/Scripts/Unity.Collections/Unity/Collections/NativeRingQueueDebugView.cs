namespace Unity.Collections
{
	...
	{
		private unsafe global::Unity.Collections.LowLevel.Unsafe.UnsafeRingQueue<T>* Data;
		...
		public unsafe NativeRingQueueDebugView(global::Unity.Collections.NativeRingQueue<T> data)
		{
