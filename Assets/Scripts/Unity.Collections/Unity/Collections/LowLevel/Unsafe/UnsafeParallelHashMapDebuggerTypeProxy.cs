...
{
	internal sealed class UnsafeParallelHashMapDebuggerTypeProxy<TKey, TValue> where TKey : unmanaged, global::System.IEquatable<TKey> where TValue : unmanaged
	{
		...
		public UnsafeParallelHashMapDebuggerTypeProxy(global::Unity.Collections.LowLevel.Unsafe.UnsafeParallelHashMap<TKey, TValue> target)
		{
			m_Target = target;
		}
	}
