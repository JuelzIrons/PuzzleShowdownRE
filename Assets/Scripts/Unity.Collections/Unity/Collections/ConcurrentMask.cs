namespace Unity.Collections
{
	internal class ConcurrentMask
	{
		...
		{
			long num = global::System.Threading.Interlocked.Read(ref destination);
			long num2;
			long num3;
			do
			{
				num2 = num | source;
				num3 = num;
				num = global::System.Threading.Interlocked.CompareExchange(ref destination, num2, num3);
			}
			while (num != num3);
			return num2;
		}
		...
		internal static void longestConsecutiveOnes(long value, out int offset, out int count)
		{
			...
			offset = global::Unity.Mathematics.math.tzcnt(value);
		}
		...
		internal static int TryAllocate(ref long l, int offset, int bits)
		{
			...
			long num2 = global::System.Threading.Interlocked.Read(ref l);
			long num3;
			do
			{
				if ((num2 & num) != 0L)
				...
				long value = num2 | num;
				num3 = num2;
				num2 = global::System.Threading.Interlocked.CompareExchange(ref l, value, num3);
			}
			while (num2 != num3);
			return global::Unity.Mathematics.math.countbits(num2);
		}
		...
		internal static int TryFree(ref long l, int offset, int bits)
		{
			...
			do
			{
				...
				num3 = num2 & ~num;
				num4 = num2;
				num2 = global::System.Threading.Interlocked.CompareExchange(ref l, num3, num4);
			}
			while (num2 != num4);
			return global::Unity.Mathematics.math.countbits(num3);
		}

		internal static int TryAllocate(ref long l, out int offset, int bits)
		{
			long num = global::System.Threading.Interlocked.Read(ref l);
			long num3;
			do
			{
				...
				long value = num | num2;
				num3 = num;
				num = global::System.Threading.Interlocked.CompareExchange(ref l, value, num3);
			}
			while (num != num3);
			return global::Unity.Mathematics.math.countbits(num);
		}

		internal static int TryAllocate<T>(ref T t, int offset, int bits) where T : global::Unity.Collections.IIndexable<long>
		{
			int index = offset >> 6;
			int num = offset & 0x3F;
			if (num + bits > 64)
		...
		internal static int TryFree<T>(ref T t, int offset, int bits) where T : global::Unity.Collections.IIndexable<long>
		{
			int index = offset >> 6;
		...
		internal static int TryAllocate<T>(ref T t, out int offset, int begin, int end, int bits) where T : global::Unity.Collections.IIndexable<long>
		{
			int i;
		...
		internal static int TryAllocate<T>(ref T t, out int offset, int begin, int bits) where T : global::Unity.Collections.IIndexable<long>
		{
		...
		internal static int TryAllocate<T>(ref T t, out int offset, int bits) where T : global::Unity.Collections.IIndexable<long>
		{
