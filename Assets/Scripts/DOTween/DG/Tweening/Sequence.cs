namespace DG.Tweening
{
	...
	{
		internal readonly global::System.Collections.Generic.List<global::DG.Tweening.Tween> sequencedTweens = new global::System.Collections.Generic.List<global::DG.Tweening.Tween>();

		private readonly global::System.Collections.Generic.List<global::DG.Tweening.Core.ABSSequentiable> _sequencedObjs = new global::System.Collections.Generic.List<global::DG.Tweening.Core.ABSSequentiable>();

		internal float lastTweenInsertTime;

		internal Sequence()
		{
			tweenType = global::DG.Tweening.TweenType.Sequence;
			Reset();
		}

		internal static global::DG.Tweening.Sequence DoPrepend(global::DG.Tweening.Sequence inSequence, global::DG.Tweening.Tween t)
		{
			if (t.loops == -1)
			{
				t.loops = int.MaxValue;
				global::DG.Tweening.Core.Debugger.LogWarning("Infinite loops aren't allowed inside a Sequence (only on the Sequence itself) and will be changed to int.MaxValue", t);
			}
			...
			{
				global::DG.Tweening.Core.ABSSequentiable aBSSequentiable = inSequence._sequencedObjs[i];
		...
		{
			global::DG.Tweening.Core.TweenManager.AddActiveTweenToSequence(t);
			atPosition += t.delay;
			...
			if (t.isSpeedBased)
			{
				...
				global::DG.Tweening.Core.Debugger.LogWarning("SpeedBased tweens are not allowed inside a Sequence: interpreting speed as duration", t);
			}
		...
		{
			inSequence.lastTweenInsertTime = atPosition;
			global::DG.Tweening.Core.SequenceCallback sequenceCallback = new global::DG.Tweening.Core.SequenceCallback(atPosition, callback);
		...
		{
			s.autoKill = global::DG.Tweening.DOTween.defaultAutoKill;
			s.isRecyclable = global::DG.Tweening.DOTween.defaultRecyclable;
			s.isPlaying = global::DG.Tweening.DOTween.defaultAutoPlay == global::DG.Tweening.AutoPlay.All || global::DG.Tweening.DOTween.defaultAutoPlay == global::DG.Tweening.AutoPlay.AutoPlaySequences;
			s.loopType = global::DG.Tweening.DOTween.defaultLoopType;
			s.easeType = global::DG.Tweening.Ease.Linear;
			s.easeOvershootOrAmplitude = global::DG.Tweening.DOTween.defaultEaseOvershootOrAmplitude;
			s.easePeriod = global::DG.Tweening.DOTween.defaultEasePeriod;
		}
		...
		internal static bool DoStartup(global::DG.Tweening.Sequence s)
		{
			...
			if (s.isInverted)
			{
				...
				{
					global::DG.Tweening.Core.ABSSequentiable aBSSequentiable = s._sequencedObjs[j];
					if (aBSSequentiable.tweenType == global::DG.Tweening.TweenType.Tweener)
					{
						global::DG.Tweening.Tween tween = (global::DG.Tweening.Tween)aBSSequentiable;
						global::DG.Tweening.Core.TweenManager.Goto(tween, tween.duration * (float)tween.loops, andPlay: false, global::DG.Tweening.Core.Enums.UpdateMode.IgnoreOnComplete);
		...
		internal static bool DoApplyTween(global::DG.Tweening.Sequence s, float prevPosition, int prevCompletedLoops, int newCompletedSteps, bool useInversePosition, global::DG.Tweening.Core.Enums.UpdateMode updateMode)
		{
			...
			if (s.easeType != global::DG.Tweening.Ease.Linear)
			{
				num = s.duration * global::DG.Tweening.Core.Easing.EaseManager.Evaluate(s.easeType, s.customEase, num, s.duration, s.easeOvershootOrAmplitude, s.easePeriod);
				num2 = s.duration * global::DG.Tweening.Core.Easing.EaseManager.Evaluate(s.easeType, s.customEase, num2, s.duration, s.easeOvershootOrAmplitude, s.easePeriod);
			}
			float num3 = 0f;
			bool flag = (s.loops == -1 || s.loops > 1) && s.loopType == global::DG.Tweening.LoopType.Yoyo && ((num < s.duration) ? (prevCompletedLoops % 2 != 0) : (prevCompletedLoops % 2 == 0));
			if (s.isBackwards)
			{
				flag = !flag;
			}
			...
			if (newCompletedSteps > 0)
			{
				...
				if (updateMode == global::DG.Tweening.Core.Enums.UpdateMode.Update)
				{
					while (num7 < num6)
					{
						...
						num7++;
						if (s.hasLoops && s.loopType == global::DG.Tweening.LoopType.Yoyo)
						{
							flag = !flag;
						}
					}
					if (num4 != s.completedLoops || global::System.Math.Abs(num5 - s.position) > float.Epsilon)
					{
						return !s.active;
					}
				}
				...
				{
					if (s.hasLoops && s.loopType == global::DG.Tweening.LoopType.Yoyo && newCompletedSteps % 2 != 0)
					{
						flag = !flag;
						num = s.duration - num;
					}
			...
			if (newCompletedSteps > 0 && !s.isComplete)
			{
				...
				if (s.loopType == global::DG.Tweening.LoopType.Restart && num3 > 0f)
				{
					ApplyInternalCycle(s, s.duration, 0f, global::DG.Tweening.Core.Enums.UpdateMode.Goto, useInverse: false, prevPosIsInverse: false);
				}
			}
			else
			{
		...
		private static bool ApplyInternalCycle(global::DG.Tweening.Sequence s, float fromPos, float toPos, global::DG.Tweening.Core.Enums.UpdateMode updateMode, bool useInverse, bool prevPosIsInverse, bool multiCycleStep = false)
		{
			...
			if (toPos < fromPos)
			{
				...
				for (int num2 = num; num2 > -1; num2--)
				{
					...
					global::DG.Tweening.Core.ABSSequentiable aBSSequentiable = s._sequencedObjs[num2];
					if (!(aBSSequentiable.sequencedEndPosition < toPos) && !(aBSSequentiable.sequencedPosition > fromPos))
					{
						if (aBSSequentiable.tweenType == global::DG.Tweening.TweenType.Callback)
						{
							if (updateMode == global::DG.Tweening.Core.Enums.UpdateMode.Update && prevPosIsInverse)
							{
								global::DG.Tweening.Tween.OnTweenCallback(aBSSequentiable.onStart, s);
							}
						}
						else
						{
							...
							if (tween.startupDone)
							{
								...
								if (global::DG.Tweening.Core.TweenManager.Goto(tween, num3, andPlay: false, updateMode))
								{
									if (global::DG.Tweening.DOTween.nestedTweenFailureBehaviour == global::DG.Tweening.Core.Enums.NestedTweenFailureBehaviour.KillWholeSequence)
									{
										return true;
									}
									...
									global::DG.Tweening.Core.TweenManager.Despawn(tween, modifyActiveLists: false);
									s._sequencedObjs.RemoveAt(num2);
									s.sequencedTweens.Remove(tween);
									num2--;
									num--;
								}
								else if (multiCycleStep && tween.tweenType == global::DG.Tweening.TweenType.Sequence)
								{
			...
			else
			{
				...
				for (int i = 0; i < num4; i++)
				{
					...
					global::DG.Tweening.Core.ABSSequentiable aBSSequentiable2 = s._sequencedObjs[i];
					...
					if (aBSSequentiable2.tweenType == global::DG.Tweening.TweenType.Callback)
					{
						if (updateMode == global::DG.Tweening.Core.Enums.UpdateMode.Update && ((!s.isBackwards && !useInverse && !prevPosIsInverse) || (s.isBackwards && useInverse && !prevPosIsInverse)))
						{
							global::DG.Tweening.Tween.OnTweenCallback(aBSSequentiable2.onStart, s);
						}
						continue;
					}
					...
					global::DG.Tweening.Tween tween2 = (global::DG.Tweening.Tween)aBSSequentiable2;
					if (toPos >= aBSSequentiable2.sequencedEndPosition)
					{
						if (!tween2.startupDone)
						{
							global::DG.Tweening.Core.TweenManager.ForceInit(tween2, isSequenced: true);
						}
					...
					if (global::DG.Tweening.Core.TweenManager.Goto(tween2, num5, andPlay: false, updateMode))
					{
						if (global::DG.Tweening.DOTween.nestedTweenFailureBehaviour == global::DG.Tweening.Core.Enums.NestedTweenFailureBehaviour.KillWholeSequence)
						{
							return true;
						...
						global::DG.Tweening.Core.TweenManager.Despawn(tween2, modifyActiveLists: false);
					...
					{
						if (!multiCycleStep || tween2.tweenType != global::DG.Tweening.TweenType.Sequence)
						{
							continue;
						}
						if (s.position <= 0f && s.completedLoops == 0)
		...
		private static void StableSortSequencedObjs(global::System.Collections.Generic.List<global::DG.Tweening.Core.ABSSequentiable> list)
		{
			...
			{
				int num = i;
				global::DG.Tweening.Core.ABSSequentiable aBSSequentiable = list[i];
