namespace Newtonsoft.Json.Schema
{
	...
	internal class JsonSchemaWriter
	{
		...
		private void WriteType(string propertyName, global::Newtonsoft.Json.JsonWriter writer, global::Newtonsoft.Json.Schema.JsonSchemaType type)
		{
			...
			{
				writer.WritePropertyName(propertyName);
				writer.WriteValue(global::Newtonsoft.Json.Schema.JsonSchemaBuilder.MapType(type));
				return;
			}
			global::System.Collections.Generic.IEnumerator<global::Newtonsoft.Json.Schema.JsonSchemaType> enumerator = global::System.Linq.Enumerable.Where(global::Newtonsoft.Json.Utilities.EnumUtils.GetFlagsValues(type), (global::Newtonsoft.Json.Schema.JsonSchemaType v) => v != global::Newtonsoft.Json.Schema.JsonSchemaType.None).GetEnumerator();
			if (!enumerator.MoveNext())
			{
				return;
			}
			writer.WritePropertyName(propertyName);
			global::Newtonsoft.Json.Schema.JsonSchemaType current = enumerator.Current;
			if (enumerator.MoveNext())
			{
				writer.WriteStartArray();
				writer.WriteValue(global::Newtonsoft.Json.Schema.JsonSchemaBuilder.MapType(current));
				do
				{
					writer.WriteValue(global::Newtonsoft.Json.Schema.JsonSchemaBuilder.MapType(enumerator.Current));
				}
