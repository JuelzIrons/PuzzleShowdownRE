namespace Newtonsoft.Json.Schema
{
	...
	internal class JsonSchemaModel
	{
		...
		public global::Newtonsoft.Json.Schema.JsonSchemaModel AdditionalItems { get; set; }
		...
		private static void Combine(global::Newtonsoft.Json.Schema.JsonSchemaModel model, global::Newtonsoft.Json.Schema.JsonSchema schema)
		{
			...
			if (schema.Enum != null)
			{
				...
				global::Newtonsoft.Json.Utilities.CollectionUtils.AddRangeDistinct(model.Enum, schema.Enum, global::Newtonsoft.Json.Linq.JToken.EqualityComparer);
			}
