namespace Newtonsoft.Json.Converters
{
	public class IsoDateTimeConverter : global::Newtonsoft.Json.Converters.DateTimeConverterBase
	{
		...
		public string? DateTimeFormat
		{
			...
			set
			{
				_dateTimeFormat = (global::Newtonsoft.Json.Utilities.StringUtils.IsNullOrEmpty(value) ? null : value);
			}
		}
		...
		public override object? ReadJson(global::Newtonsoft.Json.JsonReader reader, global::System.Type objectType, object? existingValue, global::Newtonsoft.Json.JsonSerializer serializer)
		{
			...
			if (reader.TokenType == global::Newtonsoft.Json.JsonToken.Date)
			{
				if (type == typeof(global::System.DateTimeOffset))
				{
					if (!(reader.Value is global::System.DateTimeOffset))
					{
						return new global::System.DateTimeOffset((global::System.DateTime)reader.Value);
					}
					return reader.Value;
				}
			...
			{
				throw global::Newtonsoft.Json.JsonSerializationException.Create(reader, global::Newtonsoft.Json.Utilities.StringUtils.FormatWith("Unexpected token parsing date. Expected String, got {0}.", global::System.Globalization.CultureInfo.InvariantCulture, reader.TokenType));
			}
			string text = reader.Value?.ToString();
			if (global::Newtonsoft.Json.Utilities.StringUtils.IsNullOrEmpty(text) && flag)
			{
				return null;
			}
			if (type == typeof(global::System.DateTimeOffset))
			{
				if (!global::Newtonsoft.Json.Utilities.StringUtils.IsNullOrEmpty(_dateTimeFormat))
				{
