namespace Newtonsoft.Json.Utilities
{
	internal class LateBoundReflectionDelegateFactory : global::Newtonsoft.Json.Utilities.ReflectionDelegateFactory
	{
		...
		internal static global::Newtonsoft.Json.Utilities.ReflectionDelegateFactory Instance => _instance;

		public override global::Newtonsoft.Json.Serialization.ObjectConstructor<object> CreateParameterizedConstructor(global::System.Reflection.MethodBase method)
		{
		...
		public override global::System.Func<T> CreateDefaultConstructor<T>(global::System.Type type)
		{
			...
			global::System.Reflection.ConstructorInfo constructorInfo = global::Newtonsoft.Json.Utilities.ReflectionUtils.GetDefaultConstructor(type, nonPublic: true);
			if (constructorInfo == null)
			{
				throw new global::System.InvalidOperationException("Unable to find default constructor for " + type.FullName);
			}
