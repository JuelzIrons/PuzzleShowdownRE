...
{
	internal class CollectionWrapper<T> : global::System.Collections.Generic.ICollection<T>, global::System.Collections.Generic.IEnumerable<T>, global::System.Collections.IEnumerable, global::Newtonsoft.Json.Utilities.IWrappedCollection, global::System.Collections.IList, global::System.Collections.ICollection
	{
		...
		object? global::System.Collections.IList.this[int index]
		{
			get
			{
				if (_genericCollection != null)
				{
					throw new global::System.InvalidOperationException("Wrapped ICollection<T> does not support indexer.");
				}
				return _list[index];
			}
			set
		...
		public CollectionWrapper(global::System.Collections.IList list)
		{
			...
			if (list is global::System.Collections.Generic.ICollection<T> genericCollection)
			{
		...
		{
			global::System.Collections.Generic.IEnumerable<T> genericCollection = _genericCollection;
			return (genericCollection ?? global::System.Linq.Enumerable.Cast<T>(_list)).GetEnumerator();
		}

		global::System.Collections.IEnumerator global::System.Collections.IEnumerable.GetEnumerator()
		{
			global::System.Collections.IEnumerable genericCollection = _genericCollection;
		...
		int global::System.Collections.IList.IndexOf(object? value)
		{
			if (_genericCollection != null)
			{
				throw new global::System.InvalidOperationException("Wrapped ICollection<T> does not support IndexOf.");
			}
			if (IsCompatibleObject(value))
			{
		...
		void global::System.Collections.IList.RemoveAt(int index)
		{
			if (_genericCollection != null)
			{
				throw new global::System.InvalidOperationException("Wrapped ICollection<T> does not support RemoveAt.");
			}
		...
		void global::System.Collections.IList.Insert(int index, object? value)
		{
			if (_genericCollection != null)
			{
				throw new global::System.InvalidOperationException("Wrapped ICollection<T> does not support Insert.");
			}
			VerifyValueType(value);
