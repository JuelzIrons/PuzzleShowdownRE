namespace Newtonsoft.Json.Utilities
{
	internal struct DateTimeParser
	{
		...
		public global::Newtonsoft.Json.Utilities.ParserTimeZone Zone;
		...
		private bool ParseDate(int start)
		{
			...
			{
				return Day <= global::System.DateTime.DaysInMonth(Year, Month);
			}
			return false;
		}
		...
		private bool ParseZone(int start)
		{
			if (start < _end)
			{
				...
				if (c == 'Z' || c == 'z')
				{
					Zone = global::Newtonsoft.Json.Utilities.ParserTimeZone.Utc;
					start++;
				}
				else
				{
					if (start + 2 < _end && Parse2Digit(start + Lz_, out ZoneHour) && ZoneHour <= 99)
					{
						...
						{
						case '-':
							Zone = global::Newtonsoft.Json.Utilities.ParserTimeZone.LocalWestOfUtc;
							start += Lz_zz;
							break;
						case '+':
							Zone = global::Newtonsoft.Json.Utilities.ParserTimeZone.LocalEastOfUtc;
							start += Lz_zz;
							break;
						}
					}
