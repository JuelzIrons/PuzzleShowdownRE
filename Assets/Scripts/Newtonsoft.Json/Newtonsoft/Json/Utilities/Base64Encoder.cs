namespace Newtonsoft.Json.Utilities
{
	internal class Base64Encoder
	{
		...
		public async global::System.Threading.Tasks.Task EncodeAsync(byte[] buffer, int index, int count, global::System.Threading.CancellationToken cancellationToken)
		{
			ValidateEncode(buffer, index, count);
			if (_leftOverBytesCount > 0)
			{
			...
			while (index < num4)
			{
				...
				int count3 = global::System.Convert.ToBase64CharArray(buffer, index, length, _charsLine, 0);
				await WriteCharsAsync(_charsLine, 0, count3, cancellationToken).ConfigureAwait(continueOnCapturedContext: false);
				index += length;
			}
		}

		private global::System.Threading.Tasks.Task WriteCharsAsync(char[] chars, int index, int count, global::System.Threading.CancellationToken cancellationToken)
		{
			return _writer.WriteAsync(chars, index, count, cancellationToken);
		}

		public global::System.Threading.Tasks.Task FlushAsync(global::System.Threading.CancellationToken cancellationToken)
		{
