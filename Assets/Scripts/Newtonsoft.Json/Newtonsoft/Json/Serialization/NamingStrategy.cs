namespace Newtonsoft.Json.Serialization
{
	public abstract class NamingStrategy
	{
		...
		{
			return Equals(obj as global::Newtonsoft.Json.Serialization.NamingStrategy);
		}

		protected bool Equals(global::Newtonsoft.Json.Serialization.NamingStrategy? other)
		{
			if (other == null)
			{
				return false;
