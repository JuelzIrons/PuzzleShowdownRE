namespace Newtonsoft.Json.Serialization
{
	public class ReflectionValueProvider : global::Newtonsoft.Json.Serialization.IValueProvider
	{
		...
		public object? GetValue(object target)
		{
			try
			{
				if (_memberInfo is global::System.Reflection.PropertyInfo propertyInfo && propertyInfo.PropertyType.IsByRef)
				{
					throw new global::System.InvalidOperationException(global::Newtonsoft.Json.Utilities.StringUtils.FormatWith("Could not create getter for {0}. ByRef return values are not supported.", global::System.Globalization.CultureInfo.InvariantCulture, propertyInfo));
				}
