namespace Newtonsoft.Json.Bson
{
	...
	public class BsonReader : global::Newtonsoft.Json.JsonReader
	{
		...
		[global::System.Obsolete("JsonNet35BinaryCompatibility will be removed in a future version of Json.NET.")]
		...
		public BsonReader(global::System.IO.Stream stream)
			: this(stream, readRootValueAsArray: false, global::System.DateTimeKind.Local)
		{
		}

		public BsonReader(global::System.IO.BinaryReader reader)
			: this(reader, readRootValueAsArray: false, global::System.DateTimeKind.Local)
		{
		}
		...
		public BsonReader(global::System.IO.BinaryReader reader, bool readRootValueAsArray, global::System.DateTimeKind dateTimeKindHandling)
		{
		...
		public override bool Read()
		{
			try
			{
				...
				case global::Newtonsoft.Json.Bson.BsonReader.BsonReaderState.CodeWScopeScopeEnd:
					...
					break;
				default:
					throw global::Newtonsoft.Json.JsonReaderException.Create(this, global::Newtonsoft.Json.Utilities.StringUtils.FormatWith("Unexpected state: {0}", global::System.Globalization.CultureInfo.InvariantCulture, _bsonReaderState));
				}
				if (!flag)
				{
		...
		private bool ReadCodeWScope()
		{
			...
			{
				bool num = ReadNormal();
				if (num && TokenType == global::Newtonsoft.Json.JsonToken.EndObject)
				{
		...
		private bool ReadReference()
		{
			...
			case global::Newtonsoft.Json.JsonReader.State.Property:
				...
				throw global::Newtonsoft.Json.JsonReaderException.Create(this, "Unexpected state when reading BSON reference: " + _bsonReaderState);
			case global::Newtonsoft.Json.JsonReader.State.PostValue:
				...
				throw global::Newtonsoft.Json.JsonReaderException.Create(this, "Unexpected state when reading BSON reference: " + _bsonReaderState);
			default:
				throw global::Newtonsoft.Json.JsonReaderException.Create(this, "Unexpected state when reading BSON reference: " + base.CurrentState);
			}
		}
		...
		private bool ReadNormal()
		{
			...
			case global::Newtonsoft.Json.JsonReader.State.Start:
			{
				...
				SetToken(token2);
				global::Newtonsoft.Json.Bson.BsonReader.ContainerContext containerContext = new global::Newtonsoft.Json.Bson.BsonReader.ContainerContext((global::Newtonsoft.Json.Bson.BsonType)type);
				PushContext(containerContext);
				containerContext.Length = ReadInt32();
				return true;
			}
			...
			case global::Newtonsoft.Json.JsonReader.State.PostValue:
			{
				...
				if (currentContext.Position == num)
				{
					if (ReadByte() != 0)
					{
						throw global::Newtonsoft.Json.JsonReaderException.Create(this, "Unexpected end of object byte value.");
					}
					PopContext();
				...
				throw global::Newtonsoft.Json.JsonReaderException.Create(this, "Read past end of current container context.");
			}
			default:
				throw new global::System.ArgumentOutOfRangeException();
		...
		private void ReadType(global::Newtonsoft.Json.Bson.BsonType type)
		{
			...
			case global::Newtonsoft.Json.Bson.BsonType.Number:
			{
				...
				{
					SetToken(global::Newtonsoft.Json.JsonToken.Float, global::System.Convert.ToDecimal(num, global::System.Globalization.CultureInfo.InvariantCulture));
				}
				else
				{
					SetToken(global::Newtonsoft.Json.JsonToken.Float, num);
				}
				break;
			}
			...
			{
				global::Newtonsoft.Json.Bson.BsonBinaryType binaryType;
				byte[] array = ReadBinary(out binaryType);
				object value3 = ((binaryType != global::Newtonsoft.Json.Bson.BsonBinaryType.Uuid) ? array : ((object)new global::System.Guid(array)));
				SetToken(global::Newtonsoft.Json.JsonToken.Bytes, value3);
				break;
			}
			...
			{
				global::System.DateTime dateTime = global::Newtonsoft.Json.Utilities.DateTimeUtils.ConvertJavaScriptTicksToDateTime(ReadInt64());
				SetToken(global::Newtonsoft.Json.JsonToken.Date, DateTimeKindHandling switch
				{
					global::System.DateTimeKind.Unspecified => global::System.DateTime.SpecifyKind(dateTime, global::System.DateTimeKind.Unspecified), 
					global::System.DateTimeKind.Local => dateTime.ToLocalTime(), 
					_ => dateTime, 
				});
				break;
			}
		...
		private byte[] ReadBinary(out global::Newtonsoft.Json.Bson.BsonBinaryType binaryType)
		{
			int count = ReadInt32();
			binaryType = (global::Newtonsoft.Json.Bson.BsonBinaryType)ReadByte();
			if (binaryType == global::Newtonsoft.Json.Bson.BsonBinaryType.BinaryOld && !_jsonNet35BinaryCompatibility)
			{
				count = ReadInt32();
			}
