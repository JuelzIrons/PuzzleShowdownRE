namespace Unity.SpriteShape.External.LibTessDotNet
{
	internal class PriorityHeap<TValue> where TValue : class
	{
		...
		private global::Unity.SpriteShape.External.LibTessDotNet.PriorityHeap<TValue>.HandleElem[] _handles;
		...
		public PriorityHeap(int initialSize, global::Unity.SpriteShape.External.LibTessDotNet.PriorityHeap<TValue>.LessOrEqual leq)
		{
			_leq = leq;
			_nodes = new int[initialSize + 1];
			_handles = new global::Unity.SpriteShape.External.LibTessDotNet.PriorityHeap<TValue>.HandleElem[initialSize + 1];
			_size = 0;
			_max = initialSize;
			_freeList = 0;
			_initialized = false;
			_nodes[1] = 1;
			_handles[1] = new global::Unity.SpriteShape.External.LibTessDotNet.PriorityHeap<TValue>.HandleElem
			{
				_key = null
			};
		}
		...
		public global::Unity.SpriteShape.External.LibTessDotNet.PQHandle Insert(TValue value)
		{
			...
			{
				_max <<= 1;
				global::System.Array.Resize(ref _nodes, _max + 1);
				global::System.Array.Resize(ref _handles, _max + 1);
			}
			int num2;
			if (_freeList == 0)
			{
			...
			{
				_handles[num2] = new global::Unity.SpriteShape.External.LibTessDotNet.PriorityHeap<TValue>.HandleElem
				{
					_key = value,
					_node = num
				};
