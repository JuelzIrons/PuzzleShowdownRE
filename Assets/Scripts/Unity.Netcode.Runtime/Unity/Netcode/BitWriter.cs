namespace Unity.Netcode
{
	public ref struct BitWriter
	{
		...
		internal unsafe BitWriter(global::Unity.Netcode.FastBufferWriter writer)
		{
			m_Writer = writer;
		...
		private unsafe void WritePartialValue<T>(T value, int bytesToWrite, int offsetBytes = 0) where T : unmanaged
		{
			...
			global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(m_BufferPointer + BytePosition, source, bytesToWrite);
