...
{
	internal struct ClientRpcMessage : global::Unity.Netcode.INetworkMessage
	{
		...
		{
			return global::Unity.Netcode.RpcMessageHelpers.Deserialize(ref reader, ref context, ref Metadata, ref ReadBuffer, "ClientRpcMessage");
		}
		...
		public void Handle(ref global::Unity.Netcode.NetworkContext context)
		{
			...
			{
				SenderId = 0uL,
				Client = new global::Unity.Netcode.ClientRpcParams
				{
					Receive = default(global::Unity.Netcode.ClientRpcReceiveParams)
				}
			};
