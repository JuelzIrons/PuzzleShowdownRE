namespace Unity.Netcode
{
	internal static class XXHash
	{
		...
		public unsafe static uint Hash32(byte* input, int length, uint seed = 0u)
		{
			...
			if (length >= 16)
			{
				...
				for (int i = 0; i < num6; i++)
				{
					...
					uint num8 = ((uint*)input)[1];
					uint num9 = ((uint*)input)[2];
					uint num10 = ((uint*)input)[3];
		...
		public unsafe static ulong Hash64(byte* input, int length, uint seed = 0u)
		{
			...
			if (length >= 32)
			{
				...
				for (int i = 0; i < num6; i++)
				{
					...
					ulong num8 = ((ulong*)input)[1];
					ulong num9 = ((ulong*)input)[2];
					ulong num10 = ((ulong*)input)[3];
		...
		{
			return global::System.Text.Encoding.UTF8.GetBytes(text).Hash32();
		}

		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public static uint Hash32(this global::System.Type type)
		{
		...
		{
			return global::System.Text.Encoding.UTF8.GetBytes(text).Hash64();
		}

		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public static ulong Hash64(this global::System.Type type)
		{
