namespace UnityEngine.InputSystem.Interactions
{
	public class MultiTapInteraction : global::UnityEngine.InputSystem.IInputInteraction<float>, global::UnityEngine.InputSystem.IInputInteraction
	{
		...
		[global::UnityEngine.Tooltip("The maximum time (in seconds) allowed to elapse between pressing and releasing a control for it to register as a tap.")]
		public float tapTime;

		[global::UnityEngine.Tooltip("The maximum delay (in seconds) allowed between each tap. If this time is exceeded, the multi-tap is canceled.")]
		public float tapDelay;

		[global::UnityEngine.Tooltip("How many taps need to be performed in succession. Two means double-tap, three means triple-tap, and so on.")]
		...
		private float tapTimeOrDefault
		{
			get
			{
				...
				{
					return global::UnityEngine.InputSystem.InputSystem.settings.defaultTapTime;
				}
				return tapTime;
			}
		}
		...
		internal float tapDelayOrDefault
		{
			get
			{
				...
				{
					return global::UnityEngine.InputSystem.InputSystem.settings.multiTapDelayTime;
				}
				return tapDelay;
			}
		}
		...
		public void Process(ref global::UnityEngine.InputSystem.InputInteractionContext context)
		{
			...
			{
			case global::UnityEngine.InputSystem.Interactions.MultiTapInteraction.TapPhase.None:
				if (context.ControlIsActuated(pressPointOrDefault))
				{
					m_CurrentTapPhase = global::UnityEngine.InputSystem.Interactions.MultiTapInteraction.TapPhase.WaitingForNextRelease;
				...
				break;
			case global::UnityEngine.InputSystem.Interactions.MultiTapInteraction.TapPhase.WaitingForNextRelease:
				...
				if (context.time - m_CurrentTapStartTime <= (double)tapTimeOrDefault)
				{
					...
					m_CurrentTapPhase = global::UnityEngine.InputSystem.Interactions.MultiTapInteraction.TapPhase.WaitingForNextPress;
				...
				break;
			case global::UnityEngine.InputSystem.Interactions.MultiTapInteraction.TapPhase.WaitingForNextPress:
				if (context.ControlIsActuated(pressPointOrDefault))
				{
		...
		public void Reset()
		{
			m_CurrentTapPhase = global::UnityEngine.InputSystem.Interactions.MultiTapInteraction.TapPhase.None;
			m_CurrentTapCount = 0;
