namespace UnityEngine.InputSystem
{
	public static class InputControlPath
	{
		...
		public struct ParsedPathComponent
		{
			...
			public global::System.Collections.Generic.IEnumerable<string> usages => global::System.Linq.Enumerable.Select(m_Usages, (global::UnityEngine.InputSystem.Utilities.Substring x) => x.ToString());
			...
			internal string ToHumanReadableString(string parentLayoutName, string parentControlPath, out string referencedLayoutName, out string controlPath, global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions options)
			{
				...
				if (!m_Layout.isEmpty)
				{
					...
					global::UnityEngine.InputSystem.Layouts.InputControlLayout inputControlLayout = global::UnityEngine.InputSystem.Layouts.InputControlLayout.cache.FindOrLoadLayout(referencedLayoutName, throwIfNotFound: false);
				...
				if (!m_Name.isEmpty && !isWildcard)
				{
					...
					{
						global::UnityEngine.InputSystem.Layouts.InputControlLayout inputControlLayout2 = global::UnityEngine.InputSystem.Layouts.InputControlLayout.cache.FindOrLoadLayout(new global::UnityEngine.InputSystem.Utilities.InternedString(parentLayoutName), throwIfNotFound: false);
						if (inputControlLayout2 != null)
						{
							global::UnityEngine.InputSystem.Utilities.InternedString internedString = new global::UnityEngine.InputSystem.Utilities.InternedString(m_Name.ToString());
							int arrayIndex;
							global::UnityEngine.InputSystem.Layouts.InputControlLayout.ControlItem? controlItem = inputControlLayout2.FindControlIncludingArrayElements(internedString, out arrayIndex);
							if (controlItem.HasValue)
							{
								...
								string text5 = (((options & global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions.UseShortNames) != global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions.None) ? controlItem.Value.shortDisplayName : null);
			...
			{
				return global::UnityEngine.InputSystem.Utilities.StringHelpers.Unescape(substring.ToString(), "/*{<", "/*{<");
			}
			...
			public bool Matches(global::UnityEngine.InputSystem.InputControl control)
			{
				if (!m_Layout.isEmpty)
				{
					...
					if (!flag)
					{
						...
						while (global::UnityEngine.InputSystem.Layouts.InputControlLayout.s_Layouts.baseLayoutTable.TryGetValue(value, out value) && !flag)
						{
				...
				if (m_Usages.length > 0)
				{
					for (int i = 0; i < m_Usages.length; i++)
					{
						...
						global::UnityEngine.InputSystem.Utilities.ReadOnlyArray<global::UnityEngine.InputSystem.Utilities.InternedString> readOnlyArray = control.usages;
						bool flag2 = false;
		...
		private struct PathParser
		{
			...
			public PathParser(string path)
			{
				...
				leftIndexInPath = 0;
				rightIndexInPath = 0;
				current = default(global::UnityEngine.InputSystem.InputControlPath.ParsedPathComponent);
			}
			...
			public bool MoveToNextComponent()
			{
				...
				global::UnityEngine.InputSystem.Utilities.Substring layout = default(global::UnityEngine.InputSystem.Utilities.Substring);
				if (rightIndexInPath < length && path[rightIndexInPath] == '<')
				{
					layout = ParseComponentPart('>');
				}
				global::UnityEngine.InputSystem.Utilities.InlinedArray<global::UnityEngine.InputSystem.Utilities.Substring> usages = default(global::UnityEngine.InputSystem.Utilities.InlinedArray<global::UnityEngine.InputSystem.Utilities.Substring>);
				while (rightIndexInPath < length && path[rightIndexInPath] == '{')
				{
					usages.AppendWithCapacity(ParseComponentPart('}'));
				}
				global::UnityEngine.InputSystem.Utilities.Substring displayName = default(global::UnityEngine.InputSystem.Utilities.Substring);
				if (rightIndexInPath < length - 1 && path[rightIndexInPath] == '#' && path[rightIndexInPath + 1] == '(')
				{
					rightIndexInPath++;
					displayName = ParseComponentPart(')');
				}
				global::UnityEngine.InputSystem.Utilities.Substring name = default(global::UnityEngine.InputSystem.Utilities.Substring);
				if (rightIndexInPath < length && path[rightIndexInPath] != '/')
				{
					name = ParseComponentPart('/');
				}
				current = new global::UnityEngine.InputSystem.InputControlPath.ParsedPathComponent
				{
					m_Layout = layout,
					m_Usages = usages,
					m_Name = name,
			...
			private global::UnityEngine.InputSystem.Utilities.Substring ParseComponentPart(char terminator)
			{
				...
				return new global::UnityEngine.InputSystem.Utilities.Substring(path, num, num2);
			}
		}
		...
		public static string ToHumanReadableString(string path, out string deviceLayoutName, out string controlPath, global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions options = global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions.None, global::UnityEngine.InputSystem.InputControl control = null)
		{
			...
			if (control != null)
			{
				global::UnityEngine.InputSystem.InputControl inputControl = TryFindControl(control, path) ?? (Matches(path, control) ? control : null);
				if (inputControl != null)
				{
					string text = (((options & global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions.UseShortNames) != global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions.None && !string.IsNullOrEmpty(inputControl.shortDisplayName)) ? inputControl.shortDisplayName : inputControl.displayName);
					if ((options & global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions.OmitDevice) == 0)
					{
			...
			global::UnityEngine.InputSystem.InputControlPath.PathParser pathParser = new global::UnityEngine.InputSystem.InputControlPath.PathParser(path);
			using (global::UnityEngine.InputSystem.Layouts.InputControlLayout.CacheRef())
			{
				if (pathParser.MoveToNextComponent())
				{
					...
					if ((options & global::UnityEngine.InputSystem.InputControlPath.HumanReadableStringOptions.OmitDevice) == 0 && !string.IsNullOrEmpty(value))
					{
						stringBuilder.Append(" [");
		...
		public static string[] TryGetDeviceUsages(string path)
		{
			...
			{
				return pathParser.current.m_Usages.ToArray((global::UnityEngine.InputSystem.Utilities.Substring x) => x.ToString());
			}
			return null;
		}
		...
		public static string TryGetDeviceLayout(string path)
		{
			...
			{
				return global::UnityEngine.InputSystem.Utilities.StringHelpers.Unescape(pathParser.current.m_Layout.ToString());
			}
		...
		public static string TryGetControlLayout(string path)
		{
			...
			global::UnityEngine.InputSystem.InputControlPath.PathParser parser = new global::UnityEngine.InputSystem.InputControlPath.PathParser(path);
			...
			return FindControlLayoutRecursive(ref parser, global::UnityEngine.InputSystem.Utilities.StringHelpers.Unescape(str));
		}
		...
		private static string FindControlLayoutRecursive(ref global::UnityEngine.InputSystem.InputControlPath.PathParser parser, string layoutName)
		{
			using (global::UnityEngine.InputSystem.Layouts.InputControlLayout.CacheRef())
			{
				global::UnityEngine.InputSystem.Layouts.InputControlLayout inputControlLayout = global::UnityEngine.InputSystem.Layouts.InputControlLayout.cache.FindOrLoadLayout(new global::UnityEngine.InputSystem.Utilities.InternedString(layoutName), throwIfNotFound: false);
		...
		private static string FindControlLayoutRecursive(ref global::UnityEngine.InputSystem.InputControlPath.PathParser parser, global::UnityEngine.InputSystem.Layouts.InputControlLayout layout)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				global::UnityEngine.InputSystem.Utilities.InternedString layout2 = layout.m_Controls[i].layout;
				if (!parser.isAtEnd)
				{
					global::UnityEngine.InputSystem.InputControlPath.PathParser parser2 = parser;
		...
		{
			global::UnityEngine.InputSystem.Utilities.Substring layout = parser.current.m_Layout;
			...
			if (parser.current.m_Usages.length > 0)
			{
				...
				{
					global::UnityEngine.InputSystem.Utilities.Substring str = parser.current.m_Usages[i];
					if (str.length <= 0)
					{
						continue;
					}
			...
			global::UnityEngine.InputSystem.Utilities.Substring name = parser.current.m_Name;
		...
		{
			return TryFindControl<global::UnityEngine.InputSystem.InputControl>(control, path, indexInPath);
		}
		...
		public static TControl TryFindControl<TControl>(global::UnityEngine.InputSystem.InputControl control, string path, int indexInPath = 0) where TControl : global::UnityEngine.InputSystem.InputControl
		{
			...
			global::UnityEngine.InputSystem.InputControlList<TControl> matches = default(global::UnityEngine.InputSystem.InputControlList<TControl>);
		...
		{
			return TryFindChild<global::UnityEngine.InputSystem.InputControl>(control, path, indexInPath);
		}
		...
		public static bool Matches(string expected, global::UnityEngine.InputSystem.InputControl control)
		{
			...
			global::UnityEngine.InputSystem.InputControlPath.PathParser parser = new global::UnityEngine.InputSystem.InputControlPath.PathParser(expected);
		...
		internal static bool MatchControlComponent(ref global::UnityEngine.InputSystem.InputControlPath.ParsedPathComponent expectedControlComponent, ref global::UnityEngine.InputSystem.Layouts.InputControlLayout.ControlItem controlItem, bool matchAlias = false)
		{
			...
			foreach (global::UnityEngine.InputSystem.Utilities.Substring usage in expectedControlComponent.m_Usages)
			{
				if (usage.isEmpty)
				{
					continue;
		...
		{
			global::UnityEngine.InputSystem.InputControl parent = currentControl.parent;
		...
		private static TControl MatchControlsRecursive<TControl>(global::UnityEngine.InputSystem.InputControl control, string path, int indexInPath, ref global::UnityEngine.InputSystem.InputControlList<TControl> matches, bool matchMultiple) where TControl : global::UnityEngine.InputSystem.InputControl
		{
			...
			{
				indexInPath++;
				flag = MatchPathComponent(control.layout, path, ref indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Layout);
				if (!flag)
				{
					global::UnityEngine.InputSystem.Utilities.InternedString value = control.m_Layout;
					while (global::UnityEngine.InputSystem.Layouts.InputControlLayout.s_Layouts.baseLayoutTable.TryGetValue(value, out value))
					{
						flag = MatchPathComponent(value, path, ref indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Layout);
						if (flag)
						{
							break;
						}
			...
			while (indexInPath < length && path[indexInPath] == '{' && flag)
			{
				...
				{
					flag = MatchPathComponent(control.usages[i], path, ref indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Usage);
					if (flag)
					{
						break;
					}
			...
			{
				indexInPath += 2;
				flag = MatchPathComponent(control.displayName, path, ref indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType.DisplayName);
			}
			if (indexInPath < length && flag && path[indexInPath] != '/')
			{
				flag = MatchPathComponent(control.name, path, ref indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Name);
				if (!flag)
				{
					for (int j = 0; j < control.aliases.Count; j++)
					{
						...
						flag = MatchPathComponent(control.aliases[j], path, ref indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Name);
					}
				}
			}
			if (flag)
		...
		{
			global::UnityEngine.InputSystem.Utilities.InternedString[] usagesForEachControl = device.m_UsagesForEachControl;
			if (usagesForEachControl == null)
			{
				return null;
			}
			int num = global::UnityEngine.InputSystem.Utilities.ArrayHelpers.LengthSafe(device.m_UsageToControl);
			...
			if (indexInPath == length)
			{
				throw new global::System.ArgumentException("Invalid path spec '" + path + "'; trailing '{'", "path");
			}
			TControl val = null;
			for (int i = 0; i < num; i++)
			{
				if (!MatchPathComponent(usagesForEachControl[i], path, ref indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Usage))
				{
					indexInPath = num2;
					continue;
				}
				global::UnityEngine.InputSystem.InputControl inputControl = device.m_UsageToControl[i];
				if (indexInPath < length && path[indexInPath] == '/')
				{
		...
		private static bool MatchPathComponent(string component, string path, ref int indexInPath, global::UnityEngine.InputSystem.InputControlPath.PathComponentType componentType, int startIndexInComponent = 0)
		{
			...
			while (indexInPath < length2)
			{
				...
				{
					if (c == '/' && componentType == global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Name)
					{
						break;
					}
					if ((c == '>' && componentType == global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Layout) || (c == '}' && componentType == global::UnityEngine.InputSystem.InputControlPath.PathComponentType.Usage) || (c == ')' && componentType == global::UnityEngine.InputSystem.InputControlPath.PathComponentType.DisplayName))
					{
						indexInPath++;
						break;
					}
