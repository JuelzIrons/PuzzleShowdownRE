namespace UnityEngine.InputSystem.Editor
{
	internal struct SampleFrequencyCalculator
	{
		...
		public void ProcessSample(global::UnityEngine.InputSystem.LowLevel.InputEventPtr eventPtr)
		{
			if (eventPtr != null)
			{
				m_SampleCount++;
		...
		public bool Update()
		{
			return Update(global::UnityEngine.Time.realtimeSinceStartupAsDouble);
		}
