namespace UnityEngine.InputSystem
{
	public class InputSettings : global::UnityEngine.ScriptableObject
	{
		...
		[global::UnityEngine.Tooltip("Determine which type of devices are used by the application. By default, this is empty meaning that all devices recognized by Unity will be used. Restricting the set of supported devices will make only those devices appear in the input system.")]
		[global::UnityEngine.SerializeField]
		private string[] m_SupportedDevices;

		[global::UnityEngine.Tooltip("Determine when Unity processes events. By default, accumulated input events are flushed out before each fixed update and before each dynamic update. This setting can be used to restrict event processing to only where the application needs it.")]
		[global::UnityEngine.SerializeField]
		private global::UnityEngine.InputSystem.InputSettings.UpdateMode m_UpdateMode = global::UnityEngine.InputSystem.InputSettings.UpdateMode.ProcessEventsInDynamicUpdate;
		...
		[global::UnityEngine.Min(0.0001f)]
		[global::UnityEngine.SerializeField]
		...
		[global::System.Obsolete("filterNoiseOnCurrent is deprecated, filtering of noise is always enabled now.", false)]
		...
		public float defaultButtonPressPoint
		{
			...
			set
			{
				...
				{
					m_DefaultButtonPressPoint = global::UnityEngine.Mathf.Clamp(value, 0.0001f, float.MaxValue);
					OnChange();
				}
			}
		}
		...
		public global::UnityEngine.InputSystem.Utilities.ReadOnlyArray<string> supportedDevices
		{
			get
			{
				return new global::UnityEngine.InputSystem.Utilities.ReadOnlyArray<string>(m_SupportedDevices);
			}
			set
			{
		...
		public void SetInternalFeatureFlag(string featureName, bool enabled)
		{
			...
			{
				throw new global::System.ArgumentException("The USE_IMGUI_EDITOR_FOR_ASSETS feature flag is no longer supported.");
			}
			if (m_FeatureFlags == null)
			{
				m_FeatureFlags = new global::System.Collections.Generic.HashSet<string>();
			}
			if (enabled)
			{
		...
		{
			if (global::UnityEngine.InputSystem.InputSystem.settings == this)
			{
				global::UnityEngine.InputSystem.InputSystem.s_Manager.ApplySettings();
			}
		}
		...
		private static bool CompareSets<T>(global::UnityEngine.InputSystem.Utilities.ReadOnlyArray<T> a, global::UnityEngine.InputSystem.Utilities.ReadOnlyArray<T> b)
		{
			if ((object)a == null)
			{
		...
		private static bool CompareFeatureFlag(global::UnityEngine.InputSystem.InputSettings a, global::UnityEngine.InputSystem.InputSettings b, string featureName)
		{
			return a.IsFeatureEnabled(featureName) == b.IsFeatureEnabled(featureName);
		}

		internal static bool AreEqual(global::UnityEngine.InputSystem.InputSettings a, global::UnityEngine.InputSystem.InputSettings b)
		{
			if ((object)a == null)
			{
				return (object)b == null;
