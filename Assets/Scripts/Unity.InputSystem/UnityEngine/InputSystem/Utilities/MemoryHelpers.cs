	...
	internal static class MemoryHelpers
	{
		public struct BitRegion
		{
			...
			public global::UnityEngine.InputSystem.Utilities.MemoryHelpers.BitRegion Overlap(global::UnityEngine.InputSystem.Utilities.MemoryHelpers.BitRegion other)
			{
				...
				{
					return default(global::UnityEngine.InputSystem.Utilities.MemoryHelpers.BitRegion);
				}
				uint num3 = global::System.Math.Min(num, num2);
				uint num4 = global::System.Math.Max(bitOffset, other.bitOffset);
				return new global::UnityEngine.InputSystem.Utilities.MemoryHelpers.BitRegion(num4, num3 - num4);
			}
		}
		...
		public unsafe static void MemCpyBitRegion(void* destination, void* source, uint bitOffset, uint bitCount)
		{
			...
			if (num3 >= 1)
			{
				global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(ptr, ptr2, num3);
			}
		...
		public unsafe static bool MemCmpBitRegion(void* ptr1, void* ptr2, uint bitOffset, uint bitCount, void* mask = null)
		{
			...
			if (num5 >= 1)
			{
				...
				else if (global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCmp(ptr3, ptr4, num5) != 0)
				{
					return false;
				}
			}
		...
		public unsafe static uint ReadMultipleBitsAsUInt(void* ptr, uint bitOffset, uint bitCount)
		{
			...
			if (bitCount > 32)
			{
				throw new global::System.ArgumentException("Trying to read more than 32 bits as int", "bitCount");
			}
			if (bitOffset > 32)
			{
			...
			throw new global::System.NotImplementedException("Reading int straddling int boundary");
		}
		...
		public unsafe static void WriteUIntAsMultipleBits(void* ptr, uint bitOffset, uint bitCount, uint value)
		{
			...
			if (bitCount > 32)
			{
				throw new global::System.ArgumentException("Trying to write more than 32 bits as int", "bitCount");
			}
			if (bitOffset > 32)
			{
				int num = (int)bitOffset % 32;
			...
			throw new global::System.NotImplementedException("Writing int straddling int boundary");
		}
		...
		public unsafe static float ReadMultipleBitsAsNormalizedUInt(void* ptr, uint bitOffset, uint bitCount)
		{
			...
			return global::UnityEngine.InputSystem.Utilities.NumberHelpers.UIntToNormalizedFloat(value, 0u, maxValue);
		}
		...
		public unsafe static void WriteNormalizedUIntAsMultipleBits(void* ptr, uint bitOffset, uint bitCount, float value)
		{
			...
			uint value2 = global::UnityEngine.InputSystem.Utilities.NumberHelpers.NormalizedFloatToUInt(value, 0u, uintMaxValue);
		...
		public unsafe static void SetBitsInBuffer(void* buffer, int byteOffset, int bitOffset, int sizeInBits, bool value)
		{
			if (buffer == null)
			{
				throw new global::System.ArgumentException("A buffer must be provided to apply the bitmask on", "buffer");
			}
			if (sizeInBits < 0)
			{
				throw new global::System.ArgumentException("Negative sizeInBits", "sizeInBits");
			}
			if (bitOffset < 0)
			{
				throw new global::System.ArgumentException("Negative bitOffset", "bitOffset");
			}
			if (byteOffset < 0)
			{
				throw new global::System.ArgumentException("Negative byteOffset", "byteOffset");
			}
			if (bitOffset >= 8)
			{
				int num = bitOffset / 8;
		...
		{
			uint alignment = global::System.Math.Min(8u, sizeInBytes);
