namespace UnityEngine.InputSystem.Utilities
{
	internal struct InlinedArray<TValue> : global::System.Collections.Generic.IEnumerable<TValue>, global::System.Collections.IEnumerable
	{
		...
		{
			this = default(global::UnityEngine.InputSystem.Utilities.InlinedArray<TValue>);
			length = global::System.Linq.Enumerable.Count(values);
			if (length > 1)
			{
		...
		{
			return new global::UnityEngine.InputSystem.Utilities.InlinedArray<TValue>
			{
				length = length,
				firstValue = firstValue,
				additionalValues = ((additionalValues != null) ? global::UnityEngine.InputSystem.Utilities.ArrayHelpers.Copy(additionalValues) : null)
			};
		}
		...
		public void SetLength(int size)
		{
			...
			{
				global::System.Array.Resize(ref additionalValues, size - 1);
			}
		}

		public TValue[] ToArray()
		{
			return global::UnityEngine.InputSystem.Utilities.ArrayHelpers.Join(firstValue, additionalValues);
		}
		...
		public int Append(TValue value)
		{
			...
			{
				global::System.Array.Resize(ref additionalValues, length);
		...
		public int AppendWithCapacity(TValue value, int capacityIncrement = 10)
		{
			...
			{
				int count = length - 1;
				global::UnityEngine.InputSystem.Utilities.ArrayHelpers.AppendWithCapacity(ref additionalValues, ref count, value, capacityIncrement);
			}
			int result = length;
			length++;
			return result;
		...
		public void AssignWithCapacity(global::UnityEngine.InputSystem.Utilities.InlinedArray<TValue> values)
		{
			...
			if (length > 1)
			{
				global::System.Array.Copy(values.additionalValues, additionalValues, length - 1);
			}
		}
		...
		public void Remove(TValue value)
		{
			...
			if (global::System.Collections.Generic.EqualityComparer<TValue>.Default.Equals(firstValue, value))
			{
				RemoveAt(0);
			}
			else
			{
				...
				for (int i = 0; i < length - 1; i++)
				{
					if (global::System.Collections.Generic.EqualityComparer<TValue>.Default.Equals(additionalValues[i], value))
					{
						RemoveAt(i + 1);
						break;
					}
		...
		public void RemoveAt(int index)
		{
			...
			if (index == 0)
			{
				if (additionalValues != null)
				{
					...
					{
						global::System.Array.Copy(additionalValues, 1, additionalValues, 0, additionalValues.Length - 1);
						global::System.Array.Resize(ref additionalValues, additionalValues.Length - 1);
					}
				}
				else
				{
			...
			else
			{
				...
				{
					global::System.Array.Resize(ref additionalValues, num - 1);
				}
				else
				{
					...
					if (index >= 2)
					{
						global::System.Array.Copy(additionalValues, 0, destinationArray, 0, index - 1);
					}
					global::System.Array.Copy(additionalValues, index + 1 - 1, destinationArray, index - 1, length - index - 1);
		...
		public void RemoveAtByMovingTailWithCapacity(int index)
		{
			...
			{
				global::UnityEngine.InputSystem.Utilities.ArrayHelpers.EraseAtByMovingTail(additionalValues, ref count, index - 1);
			}
			length--;
		}
		...
		{
			global::System.Collections.Generic.EqualityComparer<TValue> comparer = global::System.Collections.Generic.EqualityComparer<TValue>.Default;
		...
		{
			return new global::UnityEngine.InputSystem.Utilities.InlinedArray<TValue>.Enumerator
			{
				array = this,
				index = -1
			};
