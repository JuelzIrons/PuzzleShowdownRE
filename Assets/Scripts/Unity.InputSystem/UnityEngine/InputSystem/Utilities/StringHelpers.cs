namespace UnityEngine.InputSystem.Utilities
{
	internal static class StringHelpers
	{
		...
		public static bool FromNicifiedMemorySize(string text, out long result, long defaultMultiplier = 1L)
		{
			...
			if (text.EndsWith("MB", global::System.StringComparison.InvariantCultureIgnoreCase))
			{
				num = 1048576L;
				text = text.Substring(0, text.Length - 2);
			}
			else if (text.EndsWith("GB", global::System.StringComparison.InvariantCultureIgnoreCase))
			{
				num = 1073741824L;
				text = text.Substring(0, text.Length - 2);
			}
			else if (text.EndsWith("KB", global::System.StringComparison.InvariantCultureIgnoreCase))
			{
				num = 1024L;
				text = text.Substring(0, text.Length - 2);
			}
			else if (text.EndsWith("Bytes", global::System.StringComparison.InvariantCultureIgnoreCase))
			{
				num = 1L;
		...
		public static global::System.Collections.Generic.IEnumerable<global::UnityEngine.InputSystem.Utilities.Substring> Tokenize(this string str)
		{
			...
			while (i < length)
			{
				...
				if (str[i] == '"')
				{
					...
					yield return new global::UnityEngine.InputSystem.Utilities.Substring(str, i, endPos - i);
					i = endPos + 1;
				}
				else
				{
		...
		public static string MakeUniqueName<TExisting>(string baseName, global::System.Collections.Generic.IEnumerable<TExisting> existingSet, global::System.Func<TExisting, string> getNameFunc)
		{
			if (getNameFunc == null)
			{
				throw new global::System.ArgumentNullException("getNameFunc");
			}
			if (existingSet == null)
			{
				return baseName;
			...
			while (!flag)
			{
				...
				{
					if (getNameFunc(item).Equals(text, global::System.StringComparison.InvariantCultureIgnoreCase))
					{
						text = $"{baseName}{num}";
						flag = false;
						num++;
		...
		public static bool CharacterSeparatedListsHaveAtLeastOneCommonElement(string firstList, string secondList, char separator)
		{
			if (firstList == null)
			{
				throw new global::System.ArgumentNullException("firstList");
			}
			if (secondList == null)
			{
				throw new global::System.ArgumentNullException("secondList");
			}
			int num = 0;
		...
		public unsafe static bool WriteStringToBuffer(string text, global::System.IntPtr buffer, int bufferSizeInCharacters, ref uint offset)
		{
			if (buffer == global::System.IntPtr.Zero)
			{
			...
			if (num > 65535)
			{
				throw new global::System.ArgumentException($"String exceeds max size of {ushort.MaxValue} characters", "text");
			}
		...
		public unsafe static string ReadStringFromBuffer(global::System.IntPtr buffer, int bufferSize, ref uint offset)
		{
			if (buffer == global::System.IntPtr.Zero)
			{
				throw new global::System.ArgumentNullException("buffer");
			...
			string result = global::System.Runtime.InteropServices.Marshal.PtrToStringUni(new global::System.IntPtr(ptr), num);
			offset = (uint)num2;
			return result;
		}
		...
		public static bool InvariantEqualsIgnoreCase(this string left, string right)
		{
			...
			return string.Equals(left, right, global::System.StringComparison.InvariantCultureIgnoreCase);
		}
		...
		public static string ExpandTemplateString(string template, global::System.Func<string, string> mapFunc)
		{
			...
			if (mapFunc == null)
			{
				throw new global::System.ArgumentNullException("mapFunc");
			}
			global::System.Text.StringBuilder stringBuilder = new global::System.Text.StringBuilder();
