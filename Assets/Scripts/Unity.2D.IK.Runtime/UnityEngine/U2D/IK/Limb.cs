namespace UnityEngine.U2D.IK
{
	...
	{
		public static bool Solve(global::UnityEngine.Vector3 targetPosition, float[] lengths, global::UnityEngine.Vector3[] positions, ref float[] outAngles)
		{
			outAngles[0] = 0f;
			outAngles[1] = 0f;
			...
			global::UnityEngine.Vector3 vector = targetPosition - positions[0];
			...
			{
				outAngles[0] = global::UnityEngine.Mathf.Acos(num3) * 57.29578f;
				outAngles[1] = global::UnityEngine.Mathf.Acos(num4) * 57.29578f;
			}
			return true;
		}
	}
