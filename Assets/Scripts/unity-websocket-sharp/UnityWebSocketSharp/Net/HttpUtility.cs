namespace UnityWebSocketSharp.Net
{
	internal static class HttpUtility
	{
		...
		internal static global::System.Uri CreateRequestUrl(string requestUri, string host, bool websocketRequest, bool secure)
		{
			...
			if (!global::System.Uri.TryCreate($"{text}://{host}{arg}", global::System.UriKind.Absolute, out var result2))
			{
				return null;
			}
			return result2;
		...
		internal static global::System.Security.Principal.IPrincipal CreateUser(string response, global::UnityWebSocketSharp.Net.AuthenticationSchemes scheme, string realm, string method, global::System.Func<global::System.Security.Principal.IIdentity, global::UnityWebSocketSharp.Net.NetworkCredential> credentialsFinder)
		{
			...
			switch (scheme)
			{
			case global::UnityWebSocketSharp.Net.AuthenticationSchemes.Digest:
			...
			default:
				return null;
			case global::UnityWebSocketSharp.Net.AuthenticationSchemes.Basic:
				break;
			}
			...
			global::UnityWebSocketSharp.Net.AuthenticationResponse authenticationResponse = global::UnityWebSocketSharp.Net.AuthenticationResponse.Parse(response);
			...
			global::UnityWebSocketSharp.Net.NetworkCredential networkCredential = null;
			try
			{
			...
			if (scheme == global::UnityWebSocketSharp.Net.AuthenticationSchemes.Basic)
			{
				if (!(((global::UnityWebSocketSharp.Net.HttpBasicIdentity)identity).Password == networkCredential.Password))
				{
					return null;
				}
				return new global::System.Security.Principal.GenericPrincipal(identity, networkCredential.Roles);
			}
			if (!((global::UnityWebSocketSharp.Net.HttpDigestIdentity)identity).IsValid(networkCredential.Password, realm, method, null))
			{
				return null;
			}
			return new global::System.Security.Principal.GenericPrincipal(identity, networkCredential.Roles);
		...
		public static string UrlDecode(byte[] bytes, global::System.Text.Encoding encoding)
		{
			...
			return (encoding ?? global::System.Text.Encoding.UTF8).GetString(urlDecodeToBytes(bytes, 0, num));
		}
		...
		public static string UrlDecode(byte[] bytes, int offset, int count, global::System.Text.Encoding encoding)
		{
			...
			return (encoding ?? global::System.Text.Encoding.UTF8).GetString(urlDecodeToBytes(bytes, offset, count));
		}
		...
		public static string UrlEncode(byte[] bytes)
		{
			...
			return global::System.Text.Encoding.ASCII.GetString(urlEncodeToBytes(bytes, 0, num));
		}
		...
		public static string UrlEncode(byte[] bytes, int offset, int count)
		{
			...
			return global::System.Text.Encoding.ASCII.GetString(urlEncodeToBytes(bytes, offset, count));
		}
