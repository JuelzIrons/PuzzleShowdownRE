namespace UnityWebSocketSharp.Net
{
	...
	{
		private static readonly global::System.Collections.Generic.Dictionary<global::System.Net.IPEndPoint, global::UnityWebSocketSharp.Net.EndPointListener> _endpoints;

		static EndPointManager()
		{
			_endpoints = new global::System.Collections.Generic.Dictionary<global::System.Net.IPEndPoint, global::UnityWebSocketSharp.Net.EndPointListener>();
		}
		...
		private static void addPrefix(string uriPrefix, global::UnityWebSocketSharp.Net.HttpListener listener)
		{
			global::UnityWebSocketSharp.Net.HttpListenerPrefix httpListenerPrefix = new global::UnityWebSocketSharp.Net.HttpListenerPrefix(uriPrefix, listener);
			...
			if (_endpoints.TryGetValue(iPEndPoint, out var value))
			{
				if (value.IsSecure ^ httpListenerPrefix.IsSecure)
				{
					...
					throw new global::UnityWebSocketSharp.Net.HttpListenerException(87, message7);
				}
			}
			else
			{
				value = new global::UnityWebSocketSharp.Net.EndPointListener(iPEndPoint, httpListenerPrefix.IsSecure, listener.CertificateFolderPath, listener.SslConfiguration, listener.ReuseAddress);
		...
		private static void removePrefix(string uriPrefix, global::UnityWebSocketSharp.Net.HttpListener listener)
		{
			global::UnityWebSocketSharp.Net.HttpListenerPrefix httpListenerPrefix = new global::UnityWebSocketSharp.Net.HttpListenerPrefix(uriPrefix, listener);
			global::System.Net.IPAddress iPAddress = convertToIPAddress(httpListenerPrefix.Host);
		...
		public static void AddListener(global::UnityWebSocketSharp.Net.HttpListener listener)
		{
		...
		public static void AddPrefix(string uriPrefix, global::UnityWebSocketSharp.Net.HttpListener listener)
		{
			lock (((global::System.Collections.ICollection)_endpoints).SyncRoot)
			{
		...
		public static void RemoveListener(global::UnityWebSocketSharp.Net.HttpListener listener)
		{
			lock (((global::System.Collections.ICollection)_endpoints).SyncRoot)
			{
				foreach (string prefix in listener.Prefixes)
		...
		public static void RemovePrefix(string uriPrefix, global::UnityWebSocketSharp.Net.HttpListener listener)
		{
			lock (((global::System.Collections.ICollection)_endpoints).SyncRoot)
			{
