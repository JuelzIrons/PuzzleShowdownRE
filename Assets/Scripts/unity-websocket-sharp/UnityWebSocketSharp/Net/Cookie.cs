	...
	internal sealed class Cookie
	{
		...
		internal int MaxAge
		{
			get
			{
				...
				global::System.TimeSpan timeSpan = ((_expires.Kind != global::System.DateTimeKind.Local) ? _expires.ToLocalTime() : _expires) - global::System.DateTime.Now;
				if (!(timeSpan > global::System.TimeSpan.Zero))
				{
					return 0;
				}
		...
		public bool Expired
		{
			get
			{
				if (_expires != global::System.DateTime.MinValue)
				{
					return _expires <= global::System.DateTime.Now;
				}
				return false;
			}
			set
		...
		public string Name
		{
			...
			set
			{
				...
				if (value[0] == '$')
				{
					throw new global::System.ArgumentException("It starts with a dollar sign.", "value");
				}
				if (!value.IsToken())
				{
		...
		public string Value
		{
			...
			set
			{
				...
				{
					throw new global::System.ArgumentException("A string not enclosed in double quotes.", "value");
				}
				_value = value;
			}
		}
		...
		public Cookie(string name, string value, string path, string domain)
		{
			...
			if (name[0] == '$')
			{
				throw new global::System.ArgumentException("It starts with a dollar sign.", "name");
			}
			if (!name.IsToken())
			{
				throw new global::System.ArgumentException("It contains an invalid character.", "name");
			}
			if (value == null)
			{
				value = string.Empty;
		...
		private string toResponseStringVersion0()
		{
			...
			if (_expires != global::System.DateTime.MinValue)
			{
				string arg = _expires.ToUniversalTime().ToString("ddd, dd'-'MMM'-'yyyy HH':'mm':'ss 'GMT'", global::System.Globalization.CultureInfo.CreateSpecificCulture("en-US"));
		...
		private string toResponseStringVersion1()
		{
			...
			if (_comment != null)
			{
				string arg = global::UnityWebSocketSharp.Net.HttpUtility.UrlEncode(_comment);
		...
		internal bool EqualsWithoutValue(global::UnityWebSocketSharp.Net.Cookie cookie)
		{
		...
		internal bool EqualsWithoutValueAndVersion(global::UnityWebSocketSharp.Net.Cookie cookie)
		{
			global::System.StringComparison comparisonType = global::System.StringComparison.InvariantCulture;
			global::System.StringComparison comparisonType2 = global::System.StringComparison.InvariantCultureIgnoreCase;
		...
		internal static bool TryCreate(string name, string value, out global::UnityWebSocketSharp.Net.Cookie result)
		{
			result = null;
			try
			{
				result = new global::UnityWebSocketSharp.Net.Cookie(name, value);
			}
			catch
			{
				return false;
		...
		{
			if (!(comparand is global::UnityWebSocketSharp.Net.Cookie cookie))
			{
				return false;
			}
			global::System.StringComparison comparisonType = global::System.StringComparison.InvariantCulture;
		...
		{
			int hashCode = global::System.StringComparer.InvariantCultureIgnoreCase.GetHashCode(_name);
			int hashCode2 = _value.GetHashCode();
			int hashCode3 = _path.GetHashCode();
			int hashCode4 = global::System.StringComparer.InvariantCultureIgnoreCase.GetHashCode(_domain);
