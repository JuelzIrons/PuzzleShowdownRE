	...
	internal struct ColorTween : global::UnityEngine.UI.CoroutineTween.ITweenValue
	{
		...
		public void TweenValue(float floatPercentage)
		{
			if (ValidTarget())
			{
				...
				if (m_TweenMode == global::UnityEngine.UI.CoroutineTween.ColorTween.ColorTweenMode.Alpha)
				{
					arg.r = m_StartColor.r;
					arg.g = m_StartColor.g;
					arg.b = m_StartColor.b;
				}
				else if (m_TweenMode == global::UnityEngine.UI.CoroutineTween.ColorTween.ColorTweenMode.RGB)
				{
		...
		public void AddOnChangedCallback(global::UnityEngine.Events.UnityAction<global::UnityEngine.Color> callback)
		{
			if (m_Target == null)
			{
				m_Target = new global::UnityEngine.UI.CoroutineTween.ColorTween.ColorTweenCallback();
			}
