namespace Unity.Services.Core.Scheduler.Internal
{
	...
	internal class MinimumBinaryHeap<T> : global::Unity.Services.Core.Scheduler.Internal.MinimumBinaryHeap
	{
		private readonly object m_Lock = new object();

		private readonly global::System.Collections.Generic.IComparer<T> m_Comparer;

		private readonly int m_MinimumCapacity;

		private T[] m_HeapArray;

		internal global::System.Collections.Generic.IReadOnlyList<T> HeapArray => m_HeapArray;
		...
		public MinimumBinaryHeap(int minimumCapacity = 10)
			: this((global::System.Collections.Generic.IComparer<T>)global::System.Collections.Generic.Comparer<T>.Default, minimumCapacity)
		{
		}

		public MinimumBinaryHeap(global::System.Collections.Generic.IComparer<T> comparer, int minimumCapacity = 10)
			: this((global::System.Collections.Generic.ICollection<T>)null, comparer, minimumCapacity)
		{
		}

		internal MinimumBinaryHeap(global::System.Collections.Generic.ICollection<T> collection, global::System.Collections.Generic.IComparer<T> comparer, int minimumCapacity = 10)
		{
			if (minimumCapacity <= 0)
			{
				throw new global::System.ArgumentException("capacity must be more than 0");
			}
			...
			lock (m_Lock)
			{
				...
				int num = global::System.Math.Max(Count, minimumCapacity);
		...
		private void IncreaseHeapCapacityWhenFull()
		{
			...
			{
				T[] array = new T[(int)global::System.Math.Ceiling((float)Count * 1.5f)];
				global::System.Array.Copy(m_HeapArray, array, Count);
				m_HeapArray = array;
			}
		}
		...
		public T ExtractMin()
		{
			lock (m_Lock)
			{
				if (Count <= 0)
				{
					throw new global::System.InvalidOperationException("Can not ExtractMin: BinaryHeap is empty.");
				}
		...
		{
			int num = (int)global::System.Math.Ceiling((float)m_HeapArray.Length / 2f);
