namespace UnityEngine.U2D.Common.UTess
{
	...
	[global::System.Diagnostics.DebuggerTypeProxy(typeof(global::UnityEngine.U2D.Common.UTess.ArraySliceDebugView<>))]
	internal struct ArraySlice<T> : global::System.IEquatable<global::UnityEngine.U2D.Common.UTess.ArraySlice<T>> where T : struct
	{
		...
		public unsafe ArraySlice(global::UnityEngine.U2D.Common.UTess.Array<T> array, int start, int length)
		{
			m_Stride = global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<T>();
		...
		public unsafe bool Equals(global::UnityEngine.U2D.Common.UTess.ArraySlice<T> other)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if (obj is global::UnityEngine.U2D.Common.UTess.ArraySlice<T>)
			{
				return Equals((global::UnityEngine.U2D.Common.UTess.ArraySlice<T>)obj);
			}
			return false;
		}
		...
		public static bool operator ==(global::UnityEngine.U2D.Common.UTess.ArraySlice<T> left, global::UnityEngine.U2D.Common.UTess.ArraySlice<T> right)
		{
		...
		public unsafe static global::UnityEngine.U2D.Common.UTess.ArraySlice<T> ConvertExistingDataToArraySlice(void* dataPointer, int stride, int length)
		{
			if (length < 0)
			{
			...
			return new global::UnityEngine.U2D.Common.UTess.ArraySlice<T>
			{
				m_Stride = stride,
