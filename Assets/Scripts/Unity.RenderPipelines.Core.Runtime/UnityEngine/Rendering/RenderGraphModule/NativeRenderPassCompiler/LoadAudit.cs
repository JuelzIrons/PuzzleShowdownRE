...
{
	[global::System.Diagnostics.DebuggerDisplay("{reason} : {passId}")]
	internal readonly struct LoadAudit
	{
		...
		public readonly global::UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler.LoadReason reason;

		public readonly int passId;

		public LoadAudit(global::UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler.LoadReason setReason, int setPassId = -1)
		{
			reason = setReason;
			passId = setPassId;
		}
