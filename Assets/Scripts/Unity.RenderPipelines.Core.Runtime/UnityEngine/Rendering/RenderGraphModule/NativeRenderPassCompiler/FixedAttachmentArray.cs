namespace UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler
{
	...
	{
		public static global::UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler.FixedAttachmentArray<DataType> Empty = new global::UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler.FixedAttachmentArray<DataType>(0);
		...
		public unsafe ref DataType this[int index]
		{
			get
			{
				fixed (global::UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler.FixedAttachmentArray<DataType>* ptr = &this)
				{
		...
		public FixedAttachmentArray(global::Unity.Collections.NativeArray<DataType> attachments)
			: this(attachments.Length)
		{
			for (int i = 0; i < activeAttachments; i++)
			{
