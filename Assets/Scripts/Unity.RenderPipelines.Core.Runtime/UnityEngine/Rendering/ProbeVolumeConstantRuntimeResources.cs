namespace UnityEngine.Rendering
{
	...
	{
		private static global::UnityEngine.ComputeBuffer m_SkySamplingDirectionsBuffer = null;

		private static global::UnityEngine.ComputeBuffer m_AntiLeakDataBuffer = null;

		private const int NB_SKY_PRECOMPUTED_DIRECTIONS = 255;

		private static global::UnityEngine.Vector3[] k_SkyDirections = new global::UnityEngine.Vector3[255];
		...
		internal static void GetRuntimeResources(ref global::UnityEngine.Rendering.ProbeReferenceVolume.RuntimeResources rr)
		{
		...
		internal static void Initialize()
		{
			if (m_SkySamplingDirectionsBuffer == null)
			{
				...
				m_SkySamplingDirectionsBuffer = new global::UnityEngine.ComputeBuffer(k_SkyDirections.Length, 12);
				m_SkySamplingDirectionsBuffer.SetData(k_SkyDirections);
			}
			if (m_AntiLeakDataBuffer == null)
			{
				m_AntiLeakDataBuffer = new global::UnityEngine.ComputeBuffer(k_AntiLeakData.Length, 4);
				m_AntiLeakDataBuffer.SetData(k_AntiLeakData);
			}
		}

		public static global::UnityEngine.Vector3[] GetSkySamplingDirections()
		{
		...
		{
			global::UnityEngine.Rendering.CoreUtils.SafeRelease(m_SkySamplingDirectionsBuffer);
			m_SkySamplingDirectionsBuffer = null;
			global::UnityEngine.Rendering.CoreUtils.SafeRelease(m_AntiLeakDataBuffer);
			m_AntiLeakDataBuffer = null;
		}

		private static global::UnityEngine.Vector3[] GenerateSkyDirections()
		{
			global::UnityEngine.Vector3[] array = new global::UnityEngine.Vector3[255];
			float num = global::UnityEngine.Mathf.Sqrt(255f);
			float num2 = 0f;
			float a = 0f;
			float a2 = 0f;
			for (int i = 0; i < 255; i++)
			{
				...
				float num4 = global::UnityEngine.Mathf.Acos(num3);
				num2 = ((i != 254 && i != 0) ? (num2 + 3.6f / num * 1f / global::UnityEngine.Mathf.Sqrt(1f - num3 * num3)) : 0f);
				global::UnityEngine.Vector3 vector = new global::UnityEngine.Vector3(global::UnityEngine.Mathf.Sin(num4) * global::UnityEngine.Mathf.Cos(num2), global::UnityEngine.Mathf.Sin(num4) * global::UnityEngine.Mathf.Sin(num2), global::UnityEngine.Mathf.Cos(num4));
				vector.Normalize();
				array[i] = vector;
				a = global::UnityEngine.Mathf.Max(a, num2);
				a2 = global::UnityEngine.Mathf.Max(a2, num4);
			}
			return array;
		}
	}
