namespace Unity.Multiplayer.Tools.NetStats
{
	internal ref struct BitReader
	{
		...
		internal unsafe BitReader(global::Unity.Multiplayer.Tools.NetStats.FastBufferReader reader)
		{
			m_Reader = reader;
		...
		private byte ReadByteBits(int bitCount)
		{
			if (bitCount > 8)
			{
				throw new global::System.ArgumentOutOfRangeException("bitCount", "Cannot read more than 8 bits into an 8-bit value!");
			}
			if (bitCount < 0)
			{
				throw new global::System.ArgumentOutOfRangeException("bitCount", "Cannot read fewer than 0 bits!");
			}
			int num = 0;
			global::Unity.Multiplayer.Tools.NetStats.ByteBool byteBool = default(global::Unity.Multiplayer.Tools.NetStats.ByteBool);
