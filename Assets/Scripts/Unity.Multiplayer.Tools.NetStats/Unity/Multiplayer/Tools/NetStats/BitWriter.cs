namespace Unity.Multiplayer.Tools.NetStats
{
	...
	{
		private global::Unity.Multiplayer.Tools.NetStats.FastBufferWriter m_Writer;
		...
		internal unsafe BitWriter(global::Unity.Multiplayer.Tools.NetStats.FastBufferWriter writer)
		{
			m_Writer = writer;
		...
		private unsafe void WritePartialValue<T>(T value, int bytesToWrite, int offsetBytes = 0) where T : unmanaged
		{
			...
			global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(m_BufferPointer + m_Position, source, bytesToWrite);
