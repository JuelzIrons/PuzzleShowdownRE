namespace Unity.Multiplayer.Tools.Common
{
	internal class ExponentialMovingAverage
	{
		...
		public static global::Unity.Multiplayer.Tools.Common.ExponentialMovingAverage ApproximatingSimpleMovingAverage(int sampleCount)
		{
			return new global::Unity.Multiplayer.Tools.Common.ExponentialMovingAverage(GetParameterApproximatingSimpleMovingAverage(sampleCount));
		}
		...
		public ExponentialMovingAverage(float parameter, float value = 0f)
		{
			...
			{
				throw new global::System.ArgumentException($"ExponentialMovingAverage parameter {parameter} should be in range [0, 1]");
			}
			Parameter = parameter;
			Value = value;
		}
