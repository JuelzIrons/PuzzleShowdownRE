...
{
	internal class RingBuffer<T> : global::System.Collections.Generic.IEnumerable<T>, global::System.Collections.IEnumerable
	{
		...
		public T this[global::System.Index index]
		{
			get
			{
				ThrowIfIndexOutOfRange(index);
		...
		private void UpdateCapacity(int newCapacity)
		{
			...
			m_Begin = 0;
			Length = global::System.Math.Min(length, newCapacity);
		...
		private bool ContainsIndex(global::System.Index index)
		{
		...
		private void ThrowIfIndexOutOfRange(int index)
		{
			...
			{
				throw new global::System.IndexOutOfRangeException($"Index {index} is out of range [0, {Length})");
			}
		}
		...
		private void ThrowIfCapacityLessThanZero(int capacity)
		{
			if (capacity < 0)
			{
				throw new global::System.ArgumentException($"RingBuffer capacity argument {capacity} is < 0");
			}
		}

		private void ThrowIfIndexOutOfRange(global::System.Index index)
		{
			if (!ContainsIndex(index))
			{
				throw new global::System.IndexOutOfRangeException($"Index {index} is out of range [0, {Length})");
		...
		private int GetBufferIndex(global::System.Index index)
		{
			if (index.IsFromEnd)
			{
		...
		public T GetValueOrDefault(global::System.Index index)
		{
			if (ContainsIndex(index))
			{
				return this[index];
