namespace LibTessDotNet
{
	internal class PriorityHeap<TValue> where TValue : class
	{
		...
		private global::LibTessDotNet.PriorityHeap<TValue>.HandleElem[] _handles;
		...
		public PriorityHeap(int initialSize, global::LibTessDotNet.PriorityHeap<TValue>.LessOrEqual leq)
		{
			_leq = leq;
			_nodes = new int[initialSize + 1];
			_handles = new global::LibTessDotNet.PriorityHeap<TValue>.HandleElem[initialSize + 1];
			_size = 0;
			_max = initialSize;
			_freeList = 0;
			_initialized = false;
			_nodes[1] = 1;
			_handles[1] = new global::LibTessDotNet.PriorityHeap<TValue>.HandleElem
			{
				_key = null
			};
		}
		...
		public global::LibTessDotNet.PQHandle Insert(TValue value)
		{
			...
			{
				_handles[num2] = new global::LibTessDotNet.PriorityHeap<TValue>.HandleElem
				{
					_key = value,
					_node = num
				};
