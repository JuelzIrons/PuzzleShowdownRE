namespace Unity.Services.Qos.ErrorMitigation
{
	internal class RetryPolicyConfig
	{
		...
		private global::System.Collections.Generic.List<global::Unity.Services.Qos.ErrorMitigation.ExceptionPredicate> _exceptionsToHandle = new global::System.Collections.Generic.List<global::Unity.Services.Qos.ErrorMitigation.ExceptionPredicate>();
		...
		public bool IsHandledException(global::System.Exception e)
		{
			...
			{
				foreach (global::Unity.Services.Qos.ErrorMitigation.ExceptionPredicate item in _exceptionsToHandle)
				{
					if (item(e) == e)
					{
						return true;
