...
{
	internal class RetryPolicy<T> : global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T>
	{
		private global::Unity.Services.Qos.ErrorMitigation.RetryPolicyConfig _retryPolicyConfig = new global::Unity.Services.Qos.ErrorMitigation.RetryPolicyConfig();
		...
		public global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T> WithJitterMagnitude(float magnitude)
		{
			_retryPolicyConfig.JitterMagnitude = magnitude;
			return this;
		}

		public global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T> WithDelayScale(float scale)
		{
			_retryPolicyConfig.DelayScale = scale;
			return this;
		}

		public global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T> WithMaxDelayTime(float time)
		{
			_retryPolicyConfig.MaxDelayTime = time;
			return this;
		}

		public static global::Unity.Services.Qos.ErrorMitigation.RetryPolicy<T> ForOperation(global::System.Func<int, global::System.Threading.Tasks.Task<T>> operation)
		{
			return new global::Unity.Services.Qos.ErrorMitigation.RetryPolicy<T>(operation);
		}

		public static global::Unity.Services.Qos.ErrorMitigation.RetryPolicy<T> ForOperation(global::System.Func<global::System.Threading.Tasks.Task<T>> operation)
		{
			return new global::Unity.Services.Qos.ErrorMitigation.RetryPolicy<T>(operation);
		}

		public global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T> WithRetryCondition(global::System.Func<T, global::System.Threading.Tasks.Task<bool>> shouldRetry)
		{
			RetryCondition = shouldRetry;
			return this;
		}

		public global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T> UptoMaximumRetries(uint amount)
		{
			_retryPolicyConfig.MaxRetries = amount;
			return this;
		}

		public global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T> HandleException<TException>() where TException : global::System.Exception
		{
			_retryPolicyConfig.HandleException<TException>();
			return this;
		}

		public global::Unity.Services.Qos.ErrorMitigation.IRetryPolicy<T> HandleException<TException>(global::System.Func<TException, bool> condition) where TException : global::System.Exception
		{
			_retryPolicyConfig.HandleException(condition);
			return this;
		}

		public async global::System.Threading.Tasks.Task<T> RunAsync(global::Unity.Services.Qos.ErrorMitigation.RetryPolicyConfig retryPolicyConfig = null)
		{
