namespace Unity.Services.Qos.Http
{
	...
	internal class ResponseDeserializationException : global::System.Exception
	{
		...
		public ResponseDeserializationException(global::Unity.Services.Qos.Http.HttpClientResponse httpClientResponse)
			: base("Unable to Deserialize Http Client Response")
		{
			response = httpClientResponse;
		}

		public ResponseDeserializationException(global::Unity.Services.Qos.Http.HttpClientResponse httpClientResponse, string message)
			: base(message)
		{
			response = httpClientResponse;
		}

		public ResponseDeserializationException(global::Unity.Services.Qos.Http.HttpClientResponse httpClientResponse, global::System.Exception inner, string message)
			: base(message, inner)
		{
			response = httpClientResponse;
		}
