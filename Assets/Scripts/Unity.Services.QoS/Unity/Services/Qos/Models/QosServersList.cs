namespace Unity.Services.Qos.Models
{
	...
	internal class QosServersList
	{
		...
		public global::System.Collections.Generic.List<global::Unity.Services.Qos.Models.QosServer> Servers { get; }

		[global::UnityEngine.Scripting.Preserve]
		public QosServersList(global::System.Collections.Generic.List<global::Unity.Services.Qos.Models.QosServer> servers)
		{
			Servers = servers;
		}
