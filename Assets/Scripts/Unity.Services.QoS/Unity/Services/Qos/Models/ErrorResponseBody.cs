namespace Unity.Services.Qos.Models
{
	...
	internal class ErrorResponseBody
	{
		...
		public global::System.Collections.Generic.List<global::Unity.Services.Qos.Http.IDeserializable> Details { get; }
		...
		public ErrorResponseBody(string type, string title, int status, int code, string detail, string instance = null, global::System.Collections.Generic.List<object> details = null)
		{
			...
			Detail = detail;
			Instance = instance;
			Details = global::Unity.Services.Qos.Http.JsonObject.GetNewJsonObjectResponse(details);
		}
