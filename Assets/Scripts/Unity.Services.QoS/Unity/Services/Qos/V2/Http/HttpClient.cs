...
{
	internal class HttpClient : global::Unity.Services.Qos.V2.Http.IHttpClient
	{
		public async global::System.Threading.Tasks.Task<global::Unity.Services.Qos.V2.Http.HttpClientResponse> MakeRequestAsync(string method, string url, byte[] body, global::System.Collections.Generic.Dictionary<string, string> headers, int requestTimeout)
		{
			return await CreateWebRequestAsync(method.ToUpper(), url, body, headers, requestTimeout);
		}

		public async global::System.Threading.Tasks.Task<global::Unity.Services.Qos.V2.Http.HttpClientResponse> MakeRequestAsync(string method, string url, global::System.Collections.Generic.List<global::UnityEngine.Networking.IMultipartFormSection> body, global::System.Collections.Generic.Dictionary<string, string> headers, int requestTimeout, string boundary = null)
		{
			return await CreateWebRequestAsync(method.ToUpper(), url, body, headers, requestTimeout, boundary);
		}

		private async global::System.Threading.Tasks.Task<global::Unity.Services.Qos.V2.Http.HttpClientResponse> CreateWebRequestAsync(string method, string url, byte[] body, global::System.Collections.Generic.IDictionary<string, string> headers, int requestTimeout)
		{
			return await CreateHttpClientResponse(method, url, body, headers, requestTimeout);
		}

		private async global::System.Threading.Tasks.Task<global::Unity.Services.Qos.V2.Http.HttpClientResponse> CreateHttpClientResponse(string method, string url, byte[] body, global::System.Collections.Generic.IDictionary<string, string> headers, int requestTimeout)
		{
			...
			}, global::System.Threading.CancellationToken.None, global::System.Threading.Tasks.TaskCreationOptions.None, global::Unity.Services.Qos.V2.Scheduler.ThreadHelper.TaskScheduler));
		}

		private async global::System.Threading.Tasks.Task<global::Unity.Services.Qos.V2.Http.HttpClientResponse> CreateWebRequestAsync(string method, string url, global::System.Collections.Generic.List<global::UnityEngine.Networking.IMultipartFormSection> body, global::System.Collections.Generic.IDictionary<string, string> headers, int requestTimeout, string boundary = null)
		{
			return await (await global::System.Threading.Tasks.Task.Factory.StartNew(async delegate
			{
