namespace Unity.Services.Qos.V2.Http
{
	internal static class JsonHelpers
	{
		...
		internal static void RegisterTypesForAOT()
		{
			...
			global::Newtonsoft.Json.Utilities.AotHelper.EnsureType<global::Unity.Services.Qos.V2.Http.JsonObjectConverter>();
		}
		...
		internal static bool TryParseJson<T>(this string @this, out T result)
		{
			...
			result = global::Unity.Services.Qos.V2.Http.IsolatedJsonConvert.DeserializeObject<T>(@this, settings);
			return success;
		}
	}
}
