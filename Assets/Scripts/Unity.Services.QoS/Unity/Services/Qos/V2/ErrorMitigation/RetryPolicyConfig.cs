namespace Unity.Services.Qos.V2.ErrorMitigation
{
	internal class RetryPolicyConfig
	{
		...
		private global::System.Collections.Generic.List<global::Unity.Services.Qos.V2.ErrorMitigation.ExceptionPredicate> _exceptionsToHandle = new global::System.Collections.Generic.List<global::Unity.Services.Qos.V2.ErrorMitigation.ExceptionPredicate>();
		...
		public bool IsHandledException(global::System.Exception e)
		{
			...
			{
				foreach (global::Unity.Services.Qos.V2.ErrorMitigation.ExceptionPredicate item in _exceptionsToHandle)
				{
					if (item(e) == e)
					{
						return true;
