namespace Unity.Services.Qos.V2.Helpers
{
	...
	{
		public static global::Unity.Services.Qos.V2.Helpers.AsyncOpRetry<T> FromCreateAsync<T>(global::System.Func<int, T> op)
		{
			return global::Unity.Services.Qos.V2.Helpers.AsyncOpRetry<T>.FromCreateAsync(op);
		}
	}
	internal class AsyncOpRetry<T>
	{
		...
		public static global::Unity.Services.Qos.V2.Helpers.AsyncOpRetry<T> FromCreateAsync(global::System.Func<int, T> op)
		{
			return new global::Unity.Services.Qos.V2.Helpers.AsyncOpRetry<T>(op);
		}

		public global::Unity.Services.Qos.V2.Helpers.AsyncOpRetry<T> WithRetryCondition(global::System.Func<T, bool> shouldRetry)
		{
			RetryCondition = shouldRetry;
			return this;
		}

		public global::Unity.Services.Qos.V2.Helpers.AsyncOpRetry<T> WhenComplete(global::System.Action<T> onComplete)
		{
