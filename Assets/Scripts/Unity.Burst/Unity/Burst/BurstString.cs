namespace Unity.Burst
{
	internal static class BurstString
	{
		...
		private struct NumberBuffer
		{
			...
			public global::Unity.Burst.BurstString.NumberBufferKind Kind;
			...
			public unsafe NumberBuffer(global::Unity.Burst.BurstString.NumberBufferKind kind, byte* buffer, int digitsCount, int scale, bool isNegative)
			{
				Kind = kind;
				_buffer = buffer;
		...
		{
			public global::Unity.Burst.BurstString.NumberFormatKind Kind;
			...
			public FormatOptions(global::Unity.Burst.BurstString.NumberFormatKind kind, sbyte alignAndSize, byte specifier, bool lowercase)
			{
				this = default(global::Unity.Burst.BurstString.FormatOptions);
				Kind = kind;
			...
			{
				global::Unity.Burst.BurstString.FormatOptions formatOptions = this;
				return *(int*)(&formatOptions);
			}

			public int GetBase()
			{
				if (Kind == global::Unity.Burst.BurstString.NumberFormatKind.Hexadecimal)
				{
					return 16;
				}
				return 10;
		...
		[global::Unity.Burst.BurstString.Preserve]
		public unsafe static void CopyFixedString(byte* dest, int destLength, byte* src, int srcLength)
		{
			...
			*((short*)dest - 1) = (short)(ushort)num;
			dest[num] = 0;
			global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(dest, src, num);
		}

		[global::Unity.Burst.BurstString.Preserve]
		public unsafe static void Format(byte* dest, ref int destIndex, int destLength, byte* src, int srcLength, int formatOptionsRaw)
		{
			global::Unity.Burst.BurstString.FormatOptions formatOptions = *(global::Unity.Burst.BurstString.FormatOptions*)(&formatOptionsRaw);
			if (!AlignLeft(dest, ref destIndex, destLength, formatOptions.AlignAndSize, srcLength))
			{
				...
				if (num2 > 0)
				{
					global::Unity.Collections.LowLevel.Unsafe.UnsafeUtility.MemCpy(dest + destIndex, src, num2);
					destIndex += num2;
		...
		{
			global::Unity.Burst.BurstString.FormatOptions options = *(global::Unity.Burst.BurstString.FormatOptions*)(&formatOptionsRaw);
		...
		{
			global::Unity.Burst.BurstString.FormatOptions options = *(global::Unity.Burst.BurstString.FormatOptions*)(&formatOptionsRaw);
			if (options.Kind == global::Unity.Burst.BurstString.NumberFormatKind.Hexadecimal)
			{
		...
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
		private unsafe static void ConvertUnsignedIntegerToString(byte* dest, ref int destIndex, int destLength, ulong value, global::Unity.Burst.BurstString.FormatOptions options)
		{
			...
			if (num >= 2 && num <= 36)
			{
				...
				while (num3 != 0L);
				ptr[num2] = 0;
				global::Unity.Burst.BurstString.NumberBuffer number = new global::Unity.Burst.BurstString.NumberBuffer(global::Unity.Burst.BurstString.NumberBufferKind.Integer, ptr, num2, num2, isNegative: false);
		...
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
		private unsafe static void ConvertIntegerToString(byte* dest, ref int destIndex, int destLength, long value, global::Unity.Burst.BurstString.FormatOptions options)
		{
			...
			if (num >= 2 && num <= 36)
			{
				...
				while (num3 != 0L);
				ptr[num2] = 0;
				global::Unity.Burst.BurstString.NumberBuffer number = new global::Unity.Burst.BurstString.NumberBuffer(global::Unity.Burst.BurstString.NumberBufferKind.Integer, ptr, num2, num2, value < 0);
				FormatNumber(dest, ref destIndex, destLength, ref number, options.Specifier, options);
			}
		}

		private unsafe static void FormatNumber(byte* dest, ref int destIndex, int destLength, ref global::Unity.Burst.BurstString.NumberBuffer number, int nMaxDigits, global::Unity.Burst.BurstString.FormatOptions options)
		{
			bool isCorrectlyRounded = number.Kind == global::Unity.Burst.BurstString.NumberBufferKind.Float;
			if (number.Kind == global::Unity.Burst.BurstString.NumberBufferKind.Integer && options.Kind == global::Unity.Burst.BurstString.NumberFormatKind.General && options.Specifier == 0)
			{
				options.Kind = global::Unity.Burst.BurstString.NumberFormatKind.Decimal;
			}
			global::Unity.Burst.BurstString.NumberFormatKind kind = options.Kind;
			if (kind != global::Unity.Burst.BurstString.NumberFormatKind.General && kind - 1 <= global::Unity.Burst.BurstString.NumberFormatKind.DecimalForceSigned)
			{
				...
				bool flag = options.Kind == global::Unity.Burst.BurstString.NumberFormatKind.DecimalForceSigned;
		...
		private unsafe static void FormatDecimalOrHexadecimal(byte* dest, ref int destIndex, int destLength, ref global::Unity.Burst.BurstString.NumberBuffer number, int zeroPadding, bool outputPositiveSign)
		{
		...
		{
			string[] array = fullFormat.Split(SplitByColon, global::System.StringSplitOptions.RemoveEmptyEntries);
			format = array[0];
			padding = null;
			if (array.Length == 2)
			{
			...
			throw new global::System.ArgumentException($"Format `{format}` not supported. Invalid number {array.Length} of :. Expecting no more than one.");
		}

		public static global::Unity.Burst.BurstString.FormatOptions ParseFormatToFormatOptions(string fullFormat)
		{
			if (string.IsNullOrWhiteSpace(fullFormat))
			{
				return default(global::Unity.Burst.BurstString.FormatOptions);
			}
			OptsSplit(fullFormat, out var padding, out var format);
			format = format?.Trim();
			padding = padding?.Trim();
			int result = 0;
			global::Unity.Burst.BurstString.NumberFormatKind kind = global::Unity.Burst.BurstString.NumberFormatKind.General;
			...
			if (!string.IsNullOrEmpty(format))
			{
				...
				{
				case 'G':
					kind = global::Unity.Burst.BurstString.NumberFormatKind.General;
					break;
				case 'g':
					kind = global::Unity.Burst.BurstString.NumberFormatKind.General;
					lowercase = true;
					break;
				case 'D':
					kind = global::Unity.Burst.BurstString.NumberFormatKind.Decimal;
					break;
				case 'd':
					kind = global::Unity.Burst.BurstString.NumberFormatKind.Decimal;
					lowercase = true;
					break;
				case 'X':
					kind = global::Unity.Burst.BurstString.NumberFormatKind.Hexadecimal;
					break;
				case 'x':
					kind = global::Unity.Burst.BurstString.NumberFormatKind.Hexadecimal;
					lowercase = true;
					break;
				default:
					throw new global::System.ArgumentException("Format `" + format + "` not supported. Only G, g, D, d, X, x are supported.");
				}
				if (format.Length > 1)
				{
					...
					{
						throw new global::System.ArgumentException("Expecting an unsigned integer for specifier `" + format + "` instead of " + text + ".");
					}
					num = (int)result2;
				}
			}
			if (!string.IsNullOrEmpty(padding))
			{
				if (padding[0] != ',')
				{
					throw new global::System.ArgumentException("Invalid padding `" + padding + "`, expecting to start with a leading `,` comma.");
				}
				string text2 = padding.Substring(1);
				if (!int.TryParse(text2, out result))
				{
					throw new global::System.ArgumentException("Expecting an integer for align/size padding `" + text2 + "`.");
				}
			}
			return new global::Unity.Burst.BurstString.FormatOptions(kind, (sbyte)result, (byte)num, lowercase);
		}
		...
		private unsafe static int GetLengthForFormatGeneral(ref global::Unity.Burst.BurstString.NumberBuffer number, int nMaxDigits)
		{
			int num = 0;
			int i = number.Scale;
			bool flag = false;
		...
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
		private unsafe static void FormatGeneral(byte* dest, ref int destIndex, int destLength, ref global::Unity.Burst.BurstString.NumberBuffer number, int nMaxDigits, byte expChar)
		{
			int i = number.Scale;
			bool flag = false;
			if (i > nMaxDigits || i < -3)
			...
			if (flag && destIndex < destLength)
			{
				...
				global::Unity.Burst.BurstString.FormatOptions options = new global::Unity.Burst.BurstString.FormatOptions(global::Unity.Burst.BurstString.NumberFormatKind.DecimalForceSigned, 0, 2, lowercase: false);
				ConvertIntegerToString(dest, ref destIndex, destLength, num, options);
			}
		}

		private unsafe static void RoundNumber(ref global::Unity.Burst.BurstString.NumberBuffer number, int pos, bool isCorrectlyRounded)
		{
			byte* digitsPointer = number.GetDigitsPointer();
			int i;
		...
		private unsafe static int BigInt_Compare(in global::Unity.Burst.BurstString.tBigInt lhs, in global::Unity.Burst.BurstString.tBigInt rhs)
		{
		...
		private static void BigInt_Add(out global::Unity.Burst.BurstString.tBigInt pResult, in global::Unity.Burst.BurstString.tBigInt lhs, in global::Unity.Burst.BurstString.tBigInt rhs)
		{
		...
		private unsafe static void BigInt_Add_internal(out global::Unity.Burst.BurstString.tBigInt pResult, in global::Unity.Burst.BurstString.tBigInt pLarge, in global::Unity.Burst.BurstString.tBigInt pSmall)
		{
		...
		private static void BigInt_Multiply(out global::Unity.Burst.BurstString.tBigInt pResult, in global::Unity.Burst.BurstString.tBigInt lhs, in global::Unity.Burst.BurstString.tBigInt rhs)
		{
			if (lhs.m_length < rhs.m_length)
			{
		...
		private unsafe static void BigInt_Multiply_internal(out global::Unity.Burst.BurstString.tBigInt pResult, in global::Unity.Burst.BurstString.tBigInt pLarge, in global::Unity.Burst.BurstString.tBigInt pSmall)
		{
		...
		private unsafe static void BigInt_Multiply(out global::Unity.Burst.BurstString.tBigInt pResult, in global::Unity.Burst.BurstString.tBigInt lhs, uint rhs)
		{
			uint num = 0u;
		...
		private unsafe static void BigInt_Multiply2(out global::Unity.Burst.BurstString.tBigInt pResult, in global::Unity.Burst.BurstString.tBigInt input)
		{
			uint num = 0u;
			fixed (uint* blocks = pResult.m_blocks)
			{
		...
		private unsafe static void BigInt_Multiply2(ref global::Unity.Burst.BurstString.tBigInt pResult)
		{
			uint num = 0u;
			fixed (uint* blocks = pResult.m_blocks)
			{
		...
		private unsafe static void BigInt_Multiply10(ref global::Unity.Burst.BurstString.tBigInt pResult)
		{
			ulong num = 0uL;
			fixed (uint* blocks = pResult.m_blocks)
			{
		...
		private unsafe static global::Unity.Burst.BurstString.tBigInt g_PowerOf10_Big(int i)
		{
			global::Unity.Burst.BurstString.tBigInt result = default(global::Unity.Burst.BurstString.tBigInt);
			switch (i)
			{
			case 0:
				result.m_length = 1;
		...
		private static void BigInt_Pow10(out global::Unity.Burst.BurstString.tBigInt pResult, uint exponent)
		{
			global::Unity.Burst.BurstString.tBigInt lhs = default(global::Unity.Burst.BurstString.tBigInt);
			global::Unity.Burst.BurstString.tBigInt pResult2 = default(global::Unity.Burst.BurstString.tBigInt);
			uint num = exponent & 7;
		...
		private static void BigInt_MultiplyPow10(out global::Unity.Burst.BurstString.tBigInt pResult, in global::Unity.Burst.BurstString.tBigInt input, uint exponent)
		{
			global::Unity.Burst.BurstString.tBigInt pResult2 = default(global::Unity.Burst.BurstString.tBigInt);
			global::Unity.Burst.BurstString.tBigInt pResult3 = default(global::Unity.Burst.BurstString.tBigInt);
			uint num = exponent & 7;
			if (num != 0)
			{
		...
		private unsafe static void BigInt_Pow2(out global::Unity.Burst.BurstString.tBigInt pResult, uint exponent)
		{
		...
		private unsafe static uint BigInt_DivideWithRemainder_MaxQuotient9(ref global::Unity.Burst.BurstString.tBigInt pDividend, in global::Unity.Burst.BurstString.tBigInt divisor)
		{
		...
		private unsafe static void BigInt_ShiftLeft(ref global::Unity.Burst.BurstString.tBigInt pResult, uint shift)
		{
		...
		private unsafe static uint Dragon4(ulong mantissa, int exponent, uint mantissaHighBitIdx, bool hasUnequalMargins, global::Unity.Burst.BurstString.CutoffMode cutoffMode, uint cutoffNumber, byte* pOutBuffer, uint bufferSize, out int pOutExponent)
		{
			byte* ptr = pOutBuffer;
			if (mantissa == 0L)
			{
			...
			global::Unity.Burst.BurstString.tBigInt pResult = default(global::Unity.Burst.BurstString.tBigInt);
			global::Unity.Burst.BurstString.tBigInt pResult2 = default(global::Unity.Burst.BurstString.tBigInt);
			global::Unity.Burst.BurstString.tBigInt input = default(global::Unity.Burst.BurstString.tBigInt);
			global::Unity.Burst.BurstString.tBigInt pResult3 = default(global::Unity.Burst.BurstString.tBigInt);
			global::Unity.Burst.BurstString.tBigInt* ptr2;
			...
			int num = (int)global::System.Math.Ceiling((double)((int)mantissaHighBitIdx + exponent) * 0.3010299956639812 - 0.69);
			if (cutoffMode == global::Unity.Burst.BurstString.CutoffMode.FractionLength && num <= (int)(0 - cutoffNumber))
			{
			...
			switch (cutoffMode)
			{
			case global::Unity.Burst.BurstString.CutoffMode.TotalLength:
			{
			...
			case global::Unity.Burst.BurstString.CutoffMode.FractionLength:
			{
			...
			bool flag;
			bool flag2;
			if (cutoffMode == global::Unity.Burst.BurstString.CutoffMode.Unique)
			{
				while (true)
				{
					num--;
		...
		private unsafe static int FormatPositional(byte* pOutBuffer, uint bufferSize, ulong mantissa, int exponent, uint mantissaHighBitIdx, bool hasUnequalMargins, int precision)
		{
			...
			int pOutExponent;
			uint num2 = ((precision >= 0) ? Dragon4(mantissa, exponent, mantissaHighBitIdx, hasUnequalMargins, global::Unity.Burst.BurstString.CutoffMode.FractionLength, (uint)precision, pOutBuffer, num, out pOutExponent) : Dragon4(mantissa, exponent, mantissaHighBitIdx, hasUnequalMargins, global::Unity.Burst.BurstString.CutoffMode.Unique, 0u, pOutBuffer, num, out pOutExponent));
			uint num3 = 0u;
			if (pOutExponent >= 0)
			{
				...
				else if (num2 > num4)
				{
					...
					global::Unity.Burst.Unsafe.CopyBlock(pOutBuffer + num4 + 1, pOutBuffer + num4, num3);
					pOutBuffer[num4] = 46;
					num2 = num4 + 1 + num3;
				}
			}
			else
			{
				if (num > 2)
				{
					...
					global::Unity.Burst.Unsafe.CopyBlock(pOutBuffer + num8, pOutBuffer, num3);
		...
		{
			int pOutExponent;
			uint num = ((precision >= 0) ? Dragon4(mantissa, exponent, mantissaHighBitIdx, hasUnequalMargins, global::Unity.Burst.BurstString.CutoffMode.TotalLength, (uint)(precision + 1), pOutBuffer, bufferSize, out pOutExponent) : Dragon4(mantissa, exponent, mantissaHighBitIdx, hasUnequalMargins, global::Unity.Burst.BurstString.CutoffMode.Unique, 0u, pOutBuffer, bufferSize, out pOutExponent));
			byte* ptr = pOutBuffer;
			if (bufferSize > 1)
			{
				ptr++;
			...
			if (num2 != 0 && bufferSize > 1)
			{
				...
				global::Unity.Burst.Unsafe.CopyBlock(ptr + 1, ptr, num2);
				*ptr = 46;
				ptr += 1 + num2;
				bufferSize -= 1 + num2;
			}
			...
			if (bufferSize > 1)
			{
				...
				*ptr3 = 101;
				...
				global::Unity.Burst.Unsafe.CopyBlock(ptr, ptr3, num9);
				ptr += num9;
				bufferSize -= num9;
			}
		...
		private unsafe static void FormatInfinityNaN(byte* dest, ref int destIndex, int destLength, ulong mantissa, bool isNegative, global::Unity.Burst.BurstString.FormatOptions formatOptions)
		{
		...
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
		private unsafe static void ConvertFloatToString(byte* dest, ref int destIndex, int destLength, float value, global::Unity.Burst.BurstString.FormatOptions formatOptions)
		{
			global::Unity.Burst.BurstString.tFloatUnion32 tFloatUnion65 = new global::Unity.Burst.BurstString.tFloatUnion32
			{
			...
			int num3 = global::System.Math.Max(10, num2 + 1);
			...
			int pOutExponent;
			uint num4 = Dragon4(num, exponent2, mantissaHighBitIdx, hasUnequalMargins, global::Unity.Burst.BurstString.CutoffMode.TotalLength, (uint)num2, ptr, (uint)(num3 - 1), out pOutExponent);
			ptr[num4] = 0;
			...
			global::Unity.Burst.BurstString.NumberBuffer number = new global::Unity.Burst.BurstString.NumberBuffer(global::Unity.Burst.BurstString.NumberBufferKind.Float, ptr, (int)num4, pOutExponent + 1, isNegative);
			FormatNumber(dest, ref destIndex, destLength, ref number, num2, formatOptions);
		}

		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
		private unsafe static void ConvertDoubleToString(byte* dest, ref int destIndex, int destLength, double value, global::Unity.Burst.BurstString.FormatOptions formatOptions)
		{
			global::Unity.Burst.BurstString.tFloatUnion64 tFloatUnion65 = new global::Unity.Burst.BurstString.tFloatUnion64
			{
				m_floatingPoint = value
			};
			uint exponent = tFloatUnion65.GetExponent();
			...
			int num2 = ((formatOptions.Specifier == 0) ? (-1) : formatOptions.Specifier);
			int num3 = global::System.Math.Max(18, num2 + 1);
			byte* ptr = stackalloc byte[(int)(uint)num3];
			if (num2 < 0)
			{
				num2 = 15;
