	...
	public sealed class BurstCompilerOptions
	{
		...
		public bool EnableBurstCompilation
		{
			...
			set
			{
				...
				if (IsGlobal)
				{
					global::Unity.Jobs.LowLevel.Unsafe.JobsUtility.JobCompilerEnabled = value;
					global::Unity.Burst.BurstCompiler._IsEnabled = value;
				}
				if (num)
				{
					OnOptionsChanged();
		...
		[global::System.Obsolete("This property is no longer used and will be removed in a future major release")]
		...
		[global::System.Obsolete("This property is no longer used and will be removed in a future major release. Use the [BurstCompile(FloatMode = FloatMode.Fast)] on the method directly to enable this feature")]
		...
		internal global::System.Action OptionsChanged { get; set; }

		internal static string SerialiseCompilationOptionsSafe(string[] roots, string[] folders, string options)
		{
			return global::Unity.Burst.SafeStringArrayHelper.SerialiseStringArraySafe(new string[3]
			{
				global::Unity.Burst.SafeStringArrayHelper.SerialiseStringArraySafe(roots),
				global::Unity.Burst.SafeStringArrayHelper.SerialiseStringArraySafe(folders),
				options
			});
		}
		...
		{
			string[] array = global::Unity.Burst.SafeStringArrayHelper.DeserialiseStringArraySafe(from);
			return (roots: global::Unity.Burst.SafeStringArrayHelper.DeserialiseStringArraySafe(array[0]), folders: global::Unity.Burst.SafeStringArrayHelper.DeserialiseStringArraySafe(array[1]), options: array[2]);
		}
		...
		internal global::Unity.Burst.BurstCompilerOptions Clone()
		{
			return new global::Unity.Burst.BurstCompilerOptions
			{
		...
		private static bool TryGetAttribute(global::System.Reflection.MemberInfo member, out global::Unity.Burst.BurstCompileAttribute attribute)
		{
			attribute = null;
			if (member == null)
			{
		...
		private static bool TryGetAttribute(global::System.Reflection.Assembly assembly, out global::Unity.Burst.BurstCompileAttribute attribute)
		{
			if (assembly == null)
			{
				attribute = null;
			...
			attribute = global::System.Reflection.CustomAttributeExtensions.GetCustomAttribute<global::Unity.Burst.BurstCompileAttribute>(assembly);
			return attribute != null;
		}

		private static global::Unity.Burst.BurstCompileAttribute GetBurstCompileAttribute(global::System.Reflection.MemberInfo memberInfo)
		{
			global::Unity.Burst.BurstCompileAttribute customAttribute = global::System.Reflection.CustomAttributeExtensions.GetCustomAttribute<global::Unity.Burst.BurstCompileAttribute>(memberInfo);
			if (customAttribute != null)
			{
				return customAttribute;
			}
			foreach (global::System.Attribute customAttribute2 in global::System.Reflection.CustomAttributeExtensions.GetCustomAttributes(memberInfo))
			{
				if (customAttribute2.GetType().FullName == "Burst.Compiler.IL.Tests.TestCompilerAttribute")
				{
					global::System.Collections.Generic.List<string> list = new global::System.Collections.Generic.List<string>();
					return new global::Unity.Burst.BurstCompileAttribute(global::Unity.Burst.FloatPrecision.Standard, global::Unity.Burst.FloatMode.Default)
					{
		...
		internal static bool HasBurstCompileAttribute(global::System.Reflection.MemberInfo member)
		{
			if (member == null)
			{
				throw new global::System.ArgumentNullException("member");
			}
			global::Unity.Burst.BurstCompileAttribute attribute;
			return TryGetAttribute(member, out attribute);
		}

		internal static void MergeAttributes(ref global::Unity.Burst.BurstCompileAttribute memberAttribute, in global::Unity.Burst.BurstCompileAttribute assemblyAttribute)
		{
			if (memberAttribute.FloatMode == global::Unity.Burst.FloatMode.Default)
			{
				memberAttribute.FloatMode = assemblyAttribute.FloatMode;
			}
			if (memberAttribute.FloatPrecision == global::Unity.Burst.FloatPrecision.Standard)
			{
				memberAttribute.FloatPrecision = assemblyAttribute.FloatPrecision;
			}
			if (memberAttribute.OptimizeFor == global::Unity.Burst.OptimizeFor.Default)
			{
		...
		internal bool TryGetOptions(global::System.Reflection.MemberInfo member, out string flagsOut, bool isForILPostProcessing = false, bool isForCompilerClient = false, bool deterministicCompilation = false)
		{
			flagsOut = null;
		...
		internal string GetOptions(global::Unity.Burst.BurstCompileAttribute attr = null, bool isForILPostProcessing = false, bool isForCompilerClient = false, bool deterministicCompilation = false)
		{
			...
			if (!global::Unity.Burst.BurstCompiler.IsApiAvailable("RegisterFrameInfo"))
			{
			...
			{
				AddOption(stringBuilder, GetOption("compilation-priority=", global::Unity.Burst.CompilationPriority.ILPP));
			}
			global::Unity.Burst.FloatMode floatMode = global::Unity.Burst.FloatMode.Default;
			if (deterministicCompilation)
			{
				floatMode = global::Unity.Burst.FloatMode.Deterministic;
			}
			if (attr != null)
			{
				if (attr.FloatMode != global::Unity.Burst.FloatMode.Default)
				{
					floatMode = attr.FloatMode;
				}
				if (attr.FloatPrecision != global::Unity.Burst.FloatPrecision.Standard)
				{
				...
				{
				case global::Unity.Burst.OptimizeFor.Default:
				case global::Unity.Burst.OptimizeFor.Balanced:
					AddOption(stringBuilder, GetOption("opt-level=", 2));
					break;
				case global::Unity.Burst.OptimizeFor.Performance:
					AddOption(stringBuilder, GetOption("opt-level=", 3));
					break;
				case global::Unity.Burst.OptimizeFor.Size:
					AddOption(stringBuilder, GetOption("opt-for-size"));
					AddOption(stringBuilder, GetOption("opt-level=", 3));
					break;
				case global::Unity.Burst.OptimizeFor.FastCompilation:
					AddOption(stringBuilder, GetOption("opt-level=", 1));
					break;
				}
			}
			if (floatMode != global::Unity.Burst.FloatMode.Default)
			{
				AddOption(stringBuilder, GetOption("float-mode=", floatMode));
			}
			if (ForceEnableBurstSafetyChecks)
			{
				AddOption(stringBuilder, GetOption("global-safety-checks-setting=", global::Unity.Burst.GlobalSafetyChecksSettingKind.ForceOn));
			}
			else if (EnableBurstSafetyChecks)
			{
				AddOption(stringBuilder, GetOption("global-safety-checks-setting=", global::Unity.Burst.GlobalSafetyChecksSettingKind.On));
			}
			else
			{
				AddOption(stringBuilder, GetOption("global-safety-checks-setting=", global::Unity.Burst.GlobalSafetyChecksSettingKind.Off));
			}
			...
			AddOption(stringBuilder, GetOption("temp-folder=", global::System.IO.Path.Combine(global::System.Environment.CurrentDirectory, "Temp", "Burst")));
			return stringBuilder.ToString();
		}

		private static void AddOption(global::System.Text.StringBuilder builder, string option)
		{
			if (builder.Length != 0)
			{
				builder.Append('\n');
		...
		static BurstCompilerOptions()
		{
			...
			string environmentVariable = global::System.Environment.GetEnvironmentVariable("UNITY_BURST_DISABLE_COMPILATION");
