namespace Steamworks
{
	public static class SteamInventory
	{
		public static global::Steamworks.EResult GetResultStatus(global::Steamworks.SteamInventoryResult_t resultHandle)
		{
			...
			return global::Steamworks.NativeMethods.ISteamInventory_GetResultStatus(global::Steamworks.CSteamAPIContext.GetSteamInventory(), resultHandle);
		}
		...
		public static bool GetResultItems(global::Steamworks.SteamInventoryResult_t resultHandle, global::Steamworks.SteamItemDetails_t[] pOutItemsArray, ref uint punOutItemsArraySize)
		{
			...
			return global::Steamworks.NativeMethods.ISteamInventory_GetResultItems(global::Steamworks.CSteamAPIContext.GetSteamInventory(), resultHandle, pOutItemsArray, ref punOutItemsArraySize);
		}
		...
		public static bool GetResultItemProperty(global::Steamworks.SteamInventoryResult_t resultHandle, uint unItemIndex, string pchPropertyName, out string pchValueBuffer, ref uint punValueBufferSizeOut)
		{
			...
			bool flag = global::Steamworks.NativeMethods.ISteamInventory_GetResultItemProperty(global::Steamworks.CSteamAPIContext.GetSteamInventory(), resultHandle, unItemIndex, pchPropertyName2, intPtr, ref punValueBufferSizeOut);
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_GetResultTimestamp(global::Steamworks.CSteamAPIContext.GetSteamInventory(), resultHandle);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_CheckResultSteamID(global::Steamworks.CSteamAPIContext.GetSteamInventory(), resultHandle, steamIDExpected);
		}

		public static void DestroyResult(global::Steamworks.SteamInventoryResult_t resultHandle)
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			global::Steamworks.NativeMethods.ISteamInventory_DestroyResult(global::Steamworks.CSteamAPIContext.GetSteamInventory(), resultHandle);
		}

		public static bool GetAllItems(out global::Steamworks.SteamInventoryResult_t pResultHandle)
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_GetAllItems(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_GetItemsByID(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, pInstanceIDs, unCountInstanceIDs);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_SerializeResult(global::Steamworks.CSteamAPIContext.GetSteamInventory(), resultHandle, pOutBuffer, out punOutBufferSize);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_DeserializeResult(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pOutResultHandle, pBuffer, unBufferSize, bRESERVED_MUST_BE_FALSE);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_GenerateItems(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, pArrayItemDefs, punArrayQuantity, unArrayLength);
		}

		public static bool GrantPromoItems(out global::Steamworks.SteamInventoryResult_t pResultHandle)
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_GrantPromoItems(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_AddPromoItem(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, itemDef);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_AddPromoItems(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, pArrayItemDefs, unArrayLength);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_ConsumeItem(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, itemConsume, unQuantity);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_ExchangeItems(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, pArrayGenerate, punArrayGenerateQuantity, unArrayGenerateLength, pArrayDestroy, punArrayDestroyQuantity, unArrayDestroyLength);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_TransferItemQuantity(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, itemIdSource, unQuantity, itemIdDest);
		}

		public static void SendItemDropHeartbeat()
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			global::Steamworks.NativeMethods.ISteamInventory_SendItemDropHeartbeat(global::Steamworks.CSteamAPIContext.GetSteamInventory());
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_TriggerItemDrop(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, dropListDefinition);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_TradeItems(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, steamIDTradePartner, pArrayGive, pArrayGiveQuantity, nArrayGiveLength, pArrayGet, pArrayGetQuantity, nArrayGetLength);
		}

		public static bool LoadItemDefinitions()
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_LoadItemDefinitions(global::Steamworks.CSteamAPIContext.GetSteamInventory());
		}
		...
		public static bool GetItemDefinitionIDs(global::Steamworks.SteamItemDef_t[] pItemDefIDs, ref uint punItemDefIDsArraySize)
		{
			...
			return global::Steamworks.NativeMethods.ISteamInventory_GetItemDefinitionIDs(global::Steamworks.CSteamAPIContext.GetSteamInventory(), pItemDefIDs, ref punItemDefIDsArraySize);
		}
		...
		public static bool GetItemDefinitionProperty(global::Steamworks.SteamItemDef_t iDefinition, string pchPropertyName, out string pchValueBuffer, ref uint punValueBufferSizeOut)
		{
			...
			global::System.IntPtr intPtr = global::System.Runtime.InteropServices.Marshal.AllocHGlobal((int)punValueBufferSizeOut);
			using global::Steamworks.InteropHelp.UTF8StringHandle pchPropertyName2 = new global::Steamworks.InteropHelp.UTF8StringHandle(pchPropertyName);
			bool flag = global::Steamworks.NativeMethods.ISteamInventory_GetItemDefinitionProperty(global::Steamworks.CSteamAPIContext.GetSteamInventory(), iDefinition, pchPropertyName2, intPtr, ref punValueBufferSizeOut);
			pchValueBuffer = (flag ? global::Steamworks.InteropHelp.PtrToStringUTF8(intPtr) : null);
			global::System.Runtime.InteropServices.Marshal.FreeHGlobal(intPtr);
			return flag;
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return (global::Steamworks.SteamAPICall_t)global::Steamworks.NativeMethods.ISteamInventory_RequestEligiblePromoItemDefinitionsIDs(global::Steamworks.CSteamAPIContext.GetSteamInventory(), steamID);
		}
		...
		public static bool GetEligiblePromoItemDefinitionIDs(global::Steamworks.CSteamID steamID, global::Steamworks.SteamItemDef_t[] pItemDefIDs, ref uint punItemDefIDsArraySize)
		{
			...
			return global::Steamworks.NativeMethods.ISteamInventory_GetEligiblePromoItemDefinitionIDs(global::Steamworks.CSteamAPIContext.GetSteamInventory(), steamID, pItemDefIDs, ref punItemDefIDsArraySize);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return (global::Steamworks.SteamAPICall_t)global::Steamworks.NativeMethods.ISteamInventory_StartPurchase(global::Steamworks.CSteamAPIContext.GetSteamInventory(), pArrayItemDefs, punArrayQuantity, unArrayLength);
		}

		public static global::Steamworks.SteamAPICall_t RequestPrices()
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return (global::Steamworks.SteamAPICall_t)global::Steamworks.NativeMethods.ISteamInventory_RequestPrices(global::Steamworks.CSteamAPIContext.GetSteamInventory());
		}

		public static uint GetNumItemsWithPrices()
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_GetNumItemsWithPrices(global::Steamworks.CSteamAPIContext.GetSteamInventory());
		}
		...
		public static bool GetItemsWithPrices(global::Steamworks.SteamItemDef_t[] pArrayItemDefs, ulong[] pCurrentPrices, ulong[] pBasePrices, uint unArrayLength)
		{
			...
			return global::Steamworks.NativeMethods.ISteamInventory_GetItemsWithPrices(global::Steamworks.CSteamAPIContext.GetSteamInventory(), pArrayItemDefs, pCurrentPrices, pBasePrices, unArrayLength);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_GetItemPrice(global::Steamworks.CSteamAPIContext.GetSteamInventory(), iDefinition, out pCurrentPrice, out pBasePrice);
		}

		public static global::Steamworks.SteamInventoryUpdateHandle_t StartUpdateProperties()
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return (global::Steamworks.SteamInventoryUpdateHandle_t)global::Steamworks.NativeMethods.ISteamInventory_StartUpdateProperties(global::Steamworks.CSteamAPIContext.GetSteamInventory());
		}
		...
		public static bool RemoveProperty(global::Steamworks.SteamInventoryUpdateHandle_t handle, global::Steamworks.SteamItemInstanceID_t nItemID, string pchPropertyName)
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			using global::Steamworks.InteropHelp.UTF8StringHandle pchPropertyName2 = new global::Steamworks.InteropHelp.UTF8StringHandle(pchPropertyName);
			return global::Steamworks.NativeMethods.ISteamInventory_RemoveProperty(global::Steamworks.CSteamAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName2);
		}
		...
		public static bool SetProperty(global::Steamworks.SteamInventoryUpdateHandle_t handle, global::Steamworks.SteamItemInstanceID_t nItemID, string pchPropertyName, string pchPropertyValue)
		{
			...
			return global::Steamworks.NativeMethods.ISteamInventory_SetPropertyString(global::Steamworks.CSteamAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName2, pchPropertyValue2);
		}
		...
		public static bool SetProperty(global::Steamworks.SteamInventoryUpdateHandle_t handle, global::Steamworks.SteamItemInstanceID_t nItemID, string pchPropertyName, bool bValue)
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			using global::Steamworks.InteropHelp.UTF8StringHandle pchPropertyName2 = new global::Steamworks.InteropHelp.UTF8StringHandle(pchPropertyName);
			return global::Steamworks.NativeMethods.ISteamInventory_SetPropertyBool(global::Steamworks.CSteamAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName2, bValue);
		}
		...
		public static bool SetProperty(global::Steamworks.SteamInventoryUpdateHandle_t handle, global::Steamworks.SteamItemInstanceID_t nItemID, string pchPropertyName, long nValue)
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			using global::Steamworks.InteropHelp.UTF8StringHandle pchPropertyName2 = new global::Steamworks.InteropHelp.UTF8StringHandle(pchPropertyName);
			return global::Steamworks.NativeMethods.ISteamInventory_SetPropertyInt64(global::Steamworks.CSteamAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName2, nValue);
		}
		...
		public static bool SetProperty(global::Steamworks.SteamInventoryUpdateHandle_t handle, global::Steamworks.SteamItemInstanceID_t nItemID, string pchPropertyName, float flValue)
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			using global::Steamworks.InteropHelp.UTF8StringHandle pchPropertyName2 = new global::Steamworks.InteropHelp.UTF8StringHandle(pchPropertyName);
			return global::Steamworks.NativeMethods.ISteamInventory_SetPropertyFloat(global::Steamworks.CSteamAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName2, flValue);
		}
		...
		{
			global::Steamworks.InteropHelp.TestIfAvailableClient();
			return global::Steamworks.NativeMethods.ISteamInventory_SubmitUpdateProperties(global::Steamworks.CSteamAPIContext.GetSteamInventory(), handle, out pResultHandle);
		}
		...
		public static bool InspectItem(out global::Steamworks.SteamInventoryResult_t pResultHandle, string pchItemToken)
		{
			...
			return global::Steamworks.NativeMethods.ISteamInventory_InspectItem(global::Steamworks.CSteamAPIContext.GetSteamInventory(), out pResultHandle, pchItemToken2);
		}
	}
}
