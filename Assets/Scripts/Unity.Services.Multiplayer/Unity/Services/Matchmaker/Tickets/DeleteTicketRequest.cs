namespace Unity.Services.Matchmaker.Tickets
{
	...
	internal class DeleteTicketRequest : global::Unity.Services.Matchmaker.Tickets.TicketsApiBaseRequest
	{
		...
		[global::UnityEngine.Scripting.Preserve]
		public DeleteTicketRequest(string id, string impersonatedUserId = null)
		{
			Id = id;
