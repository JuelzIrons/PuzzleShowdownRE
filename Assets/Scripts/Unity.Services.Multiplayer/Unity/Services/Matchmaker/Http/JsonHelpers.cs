namespace Unity.Services.Matchmaker.Http
{
	internal static class JsonHelpers
	{
		...
		internal static void RegisterTypesForAOT()
		{
			...
			global::Newtonsoft.Json.Utilities.AotHelper.EnsureType<global::Unity.Services.Matchmaker.Http.JsonObjectConverter>();
		}
		...
		internal static bool TryParseJson<T>(this string @this, out T result)
		{
			...
			result = global::Unity.Services.Matchmaker.Http.IsolatedJsonConvert.DeserializeObject<T>(@this, settings);
			return success;
		}
	}
}
