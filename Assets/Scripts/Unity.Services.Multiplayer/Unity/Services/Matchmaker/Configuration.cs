namespace Unity.Services.Matchmaker
{
	internal class Configuration
	{
		...
		public static global::Unity.Services.Matchmaker.Configuration MergeConfigurations(global::Unity.Services.Matchmaker.Configuration a, global::Unity.Services.Matchmaker.Configuration b)
		{
			if (a == null || b == null)
			{
				return a ?? b;
			}
			global::Unity.Services.Matchmaker.Configuration configuration = new global::Unity.Services.Matchmaker.Configuration(a.BasePath, a.RequestTimeout, a.NumberOfRetries, a.Headers);
