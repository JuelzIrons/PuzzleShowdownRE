namespace Unity.Services.Matchmaker.ErrorMitigation
{
	internal class RetryPolicyConfig
	{
		...
		private global::System.Collections.Generic.List<global::Unity.Services.Matchmaker.ErrorMitigation.ExceptionPredicate> _exceptionsToHandle = new global::System.Collections.Generic.List<global::Unity.Services.Matchmaker.ErrorMitigation.ExceptionPredicate>();
		...
		public bool IsHandledException(global::System.Exception e)
		{
			...
			{
				foreach (global::Unity.Services.Matchmaker.ErrorMitigation.ExceptionPredicate item in _exceptionsToHandle)
				{
					if (item(e) == e)
					{
						return true;
