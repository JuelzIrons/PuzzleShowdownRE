namespace Unity.Services.Matchmaker.Backfill
{
	...
	internal class CreateBackfillTicketRequest : global::Unity.Services.Matchmaker.Backfill.BackfillApiBaseRequest
	{
		private string PathAndQueryParams;

		[global::UnityEngine.Scripting.Preserve]
		public global::Unity.Services.Matchmaker.Models.CreateBackfillTicketRequest CreateBackfillTicketRequestParameter { get; }

		[global::UnityEngine.Scripting.Preserve]
		public CreateBackfillTicketRequest(global::Unity.Services.Matchmaker.Models.CreateBackfillTicketRequest createBackfillTicketRequestParameter = null)
		{
