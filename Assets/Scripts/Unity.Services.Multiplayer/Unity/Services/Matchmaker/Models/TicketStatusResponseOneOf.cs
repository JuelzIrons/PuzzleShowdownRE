namespace Unity.Services.Matchmaker.Models
{
	...
	[global::Newtonsoft.Json.JsonConverter(typeof(global::Unity.Services.Matchmaker.Models.TicketStatusResponseOneOfJsonConverter))]
	[global::System.Runtime.Serialization.DataContract(Name = "TicketStatusResponseOneOf")]
	internal class TicketStatusResponseOneOf : global::Unity.Services.Matchmaker.Models.IOneOf
	{
		...
		public TicketStatusResponseOneOf(object value, global::System.Type type)
		{
			Value = value;
			Type = type;
		}
		...
		public static global::Unity.Services.Matchmaker.Models.TicketStatusResponseOneOf FromJson(string jsonString)
		{
			if (jsonString == null)
			{
				return null;
			...
			{
				throw new global::System.MissingFieldException("TicketStatusResponseOneOf", "assignmentType");
			}
			return DeserializeIntoActualObject(jObject["assignmentType"].ToString(), jsonString);
		}

		private static global::Unity.Services.Matchmaker.Models.TicketStatusResponseOneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
		{
			...
			return new global::Unity.Services.Matchmaker.Models.TicketStatusResponseOneOf(global::Unity.Services.Matchmaker.Http.IsolatedJsonConvert.DeserializeObject(jsonString, concreteType), concreteType);
		}

		private static global::Unity.Services.Matchmaker.Models.TicketStatusResponseOneOf DeserializeIntoActualObject(string jsonString)
		{
			...
			return new global::Unity.Services.Matchmaker.Models.TicketStatusResponseOneOf(global::System.Linq.Enumerable.First(list).Item1, global::System.Linq.Enumerable.First(list).Item2);
		}
	}
}
