namespace Unity.Services.DistributedAuthority
{
	internal class Configuration
	{
		...
		public static global::Unity.Services.DistributedAuthority.Configuration MergeConfigurations(global::Unity.Services.DistributedAuthority.Configuration a, global::Unity.Services.DistributedAuthority.Configuration b)
		{
			if (a == null || b == null)
			{
				return a ?? b;
			}
			global::Unity.Services.DistributedAuthority.Configuration configuration = new global::Unity.Services.DistributedAuthority.Configuration(a.BasePath, a.RequestTimeout, a.NumberOfRetries, a.Headers);
