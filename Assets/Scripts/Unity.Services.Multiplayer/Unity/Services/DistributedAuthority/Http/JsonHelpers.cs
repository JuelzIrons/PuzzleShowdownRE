namespace Unity.Services.DistributedAuthority.Http
{
	internal static class JsonHelpers
	{
		...
		internal static void RegisterTypesForAOT()
		{
			...
			global::Newtonsoft.Json.Utilities.AotHelper.EnsureType<global::Unity.Services.DistributedAuthority.Http.JsonObjectConverter>();
		}
		...
		internal static bool TryParseJson<T>(this string @this, out T result)
		{
			...
			result = global::Unity.Services.DistributedAuthority.Http.IsolatedJsonConvert.DeserializeObject<T>(@this, settings);
			return success;
		}
	}
}
