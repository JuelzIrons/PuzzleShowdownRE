namespace Unity.Services.Lobbies.ErrorMitigation
{
	internal class RetryPolicyConfig
	{
		...
		private global::System.Collections.Generic.List<global::Unity.Services.Lobbies.ErrorMitigation.ExceptionPredicate> _exceptionsToHandle = new global::System.Collections.Generic.List<global::Unity.Services.Lobbies.ErrorMitigation.ExceptionPredicate>();
		...
		public bool IsHandledException(global::System.Exception e)
		{
			...
			{
				foreach (global::Unity.Services.Lobbies.ErrorMitigation.ExceptionPredicate item in _exceptionsToHandle)
				{
					if (item(e) == e)
					{
						return true;
