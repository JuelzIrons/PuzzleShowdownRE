namespace Unity.Services.Lobbies.Http
{
	internal static class JsonHelpers
	{
		...
		internal static void RegisterTypesForAOT()
		{
			...
			global::Newtonsoft.Json.Utilities.AotHelper.EnsureType<global::Unity.Services.Lobbies.Http.JsonObjectConverter>();
		}
		...
		internal static bool TryParseJson<T>(this string @this, out T result)
		{
			...
			result = global::Unity.Services.Lobbies.Http.IsolatedJsonConvert.DeserializeObject<T>(@this, settings);
			return success;
		}
	}
}
