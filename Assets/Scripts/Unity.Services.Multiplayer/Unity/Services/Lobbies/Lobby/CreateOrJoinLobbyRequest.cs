namespace Unity.Services.Lobbies.Lobby
{
	...
	internal class CreateOrJoinLobbyRequest : global::Unity.Services.Lobbies.Lobby.LobbyApiBaseRequest
	{
		...
		[global::UnityEngine.Scripting.Preserve]
		public global::Unity.Services.Lobbies.Models.CreateRequest CreateRequest { get; }

		[global::UnityEngine.Scripting.Preserve]
		public CreateOrJoinLobbyRequest(string lobbyId, string serviceId = null, string impersonatedUserId = null, global::Unity.Services.Lobbies.Models.CreateRequest createRequest = null)
		{
			LobbyId = lobbyId;
			ServiceId = serviceId;
