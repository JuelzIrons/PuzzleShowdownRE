namespace Unity.Services.Lobbies.Lobby
{
	...
	internal class UpdatePlayerRequest : global::Unity.Services.Lobbies.Lobby.LobbyApiBaseRequest
	{
		...
		[global::UnityEngine.Scripting.Preserve]
		public global::Unity.Services.Lobbies.Models.PlayerUpdateRequest PlayerUpdateRequest { get; }

		[global::UnityEngine.Scripting.Preserve]
		public UpdatePlayerRequest(string lobbyId, string playerId, string serviceId = null, string impersonatedUserId = null, string ifMatch = null, global::Unity.Services.Lobbies.Models.PlayerUpdateRequest playerUpdateRequest = null)
		{
			LobbyId = lobbyId;
			PlayerId = playerId;
			ServiceId = serviceId;
