namespace Unity.Services.Lobbies.Lobby
{
	...
	internal class GetMigrationDataInfoRequest : global::Unity.Services.Lobbies.Lobby.LobbyApiBaseRequest
	{
		...
		[global::UnityEngine.Scripting.Preserve]
		public GetMigrationDataInfoRequest(string lobbyId, string serviceId = null, string impersonatedUserId = null)
		{
			LobbyId = lobbyId;
			ServiceId = serviceId;
			ImpersonatedUserId = impersonatedUserId;
			PathAndQueryParams = "/" + lobbyId + "/migrationdatainfo";
		}
