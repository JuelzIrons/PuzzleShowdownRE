namespace Unity.Services.Lobbies.Lobby
{
	...
	internal class UpdateLobbyRequest : global::Unity.Services.Lobbies.Lobby.LobbyApiBaseRequest
	{
		...
		[global::UnityEngine.Scripting.Preserve]
		public global::Unity.Services.Lobbies.Models.UpdateRequest UpdateRequest { get; }

		[global::UnityEngine.Scripting.Preserve]
		public UpdateLobbyRequest(string lobbyId, string serviceId = null, string impersonatedUserId = null, string ifMatch = null, global::Unity.Services.Lobbies.Models.UpdateRequest updateRequest = null)
		{
			LobbyId = lobbyId;
			ServiceId = serviceId;
