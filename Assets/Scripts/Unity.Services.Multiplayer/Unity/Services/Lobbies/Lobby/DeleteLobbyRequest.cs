namespace Unity.Services.Lobbies.Lobby
{
	...
	internal class DeleteLobbyRequest : global::Unity.Services.Lobbies.Lobby.LobbyApiBaseRequest
	{
		...
		[global::UnityEngine.Scripting.Preserve]
		public DeleteLobbyRequest(string lobbyId, string serviceId = null, string impersonatedUserId = null, string ifMatch = null)
		{
			LobbyId = lobbyId;
			ServiceId = serviceId;
