namespace Unity.Services.Relay.RelayAllocations
{
	...
	internal class CreateJoincodeRequest : global::Unity.Services.Relay.RelayAllocations.RelayAllocationsApiBaseRequest
	{
		private string PathAndQueryParams;

		[global::UnityEngine.Scripting.Preserve]
		public global::Unity.Services.Relay.Models.JoinCodeRequest JoinCodeRequest { get; }

		[global::UnityEngine.Scripting.Preserve]
		public CreateJoincodeRequest(global::Unity.Services.Relay.Models.JoinCodeRequest joinCodeRequest)
		{
