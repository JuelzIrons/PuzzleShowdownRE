namespace Unity.Services.Relay.ErrorMitigation
{
	internal class RetryPolicyConfig
	{
		...
		private global::System.Collections.Generic.List<global::Unity.Services.Relay.ErrorMitigation.ExceptionPredicate> _exceptionsToHandle = new global::System.Collections.Generic.List<global::Unity.Services.Relay.ErrorMitigation.ExceptionPredicate>();
		...
		public bool IsHandledException(global::System.Exception e)
		{
			...
			{
				foreach (global::Unity.Services.Relay.ErrorMitigation.ExceptionPredicate item in _exceptionsToHandle)
				{
					if (item(e) == e)
					{
						return true;
